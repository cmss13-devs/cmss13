...
#define PASS_MOB_IS_XENO			256		// For if a xeno can pass through something
#define PASS_MOB_IS_HUMAN			512		// For if a human can pass through something
#define PASS_MOB_IS_OTHER			1024	// For if every other mob can pass through something
#define PASS_MOB_THRU_XENO			2048	// For if something can pass through a xeno
#define PASS_MOB_THRU_HUMAN			4096	// For if something can pass through a human
#define PASS_MOB_THRU_OTHER			8192	// For if something can pass through every other mob	
#define PASS_TYPE_CRAWLER			16384	// For mobs that crawl/climb over stuff (runners/larva), more for "whitelisting" crawlers to pass
#define PASS_HIGH_OVER_ONLY			32768 	// For atoms that require a high toss to go over it, should only really be using this for flags_can_pass_x vars
#define PASS_BUILDING_ONLY			65536 	// For throwing stuff over walls (that lead to open ceilings)
...
#define PASS_ALL					(PASS_THROUGH|PASS_AROUND|PASS_OVER|PASS_UNDER|PASS_GLASS|PASS_MOB_IS|PASS_MOB_THRU|PASS_HIGH_OVER_ONLY|PASS_BUILDING_ONLY|PASS_TYPE_CRAWLER)

// Short-hand pass flags for very specific things
#define PASS_FLAGS_ACID_SPRAY		(PASS_UNDER|PASS_MOB_IS|PASS_OVER_ACID_SPRAY)
#define PASS_FLAGS_FLAME			(PASS_AROUND|PASS_UNDER|PASS_MOB_IS|PASS_THROUGH|PASS_OVER_FIRE)
#define PASS_FLAGS_SMOKE			(PASS_HIGH_OVER|PASS_AROUND|PASS_UNDER|PASS_MOB_IS|PASS_THROUGH)
