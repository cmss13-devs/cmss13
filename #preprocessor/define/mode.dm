...
#define WHITELIST_ALL				(WHITELIST_YAUTJA|WHITELIST_COMMANDER|WHITELIST_SYNTHETIC|WHITELIST_MENTOR)
#define WHITELIST_EVERYTHING		(\
	WHITELIST_YAUTJA|WHITELIST_YAUTJA_COUNCIL|WHITELIST_YAUTJA_LEADER|WHITELIST_YAUTJA_ELDER|\
	WHITELIST_COMMANDER|WHITELIST_COMMANDER_COUNCIL|WHITELIST_COMMANDER_LEADER|\
	WHITELIST_SYNTHETIC|WHITELIST_SYNTHETIC_COUNCIL|WHITELIST_SYNTHETIC_LEADER|\
	WHITELIST_MENTOR)
//=================================================
...
#define FACTION_LIST_MARINE list(FACTION_MARINE, FACTION_WY, FACTION_PMC, FACTION_SURVIVOR)
