...
#define XENO_ROUNDSTART_PROGRESS_TIME_2 			HOURS_1
//=================================================
...
var/global/list/ROLES_COMMAND 		= list(JOB_CO, JOB_XO, JOB_SO, JOB_INTEL, JOB_PILOT, JOB_TANKER, JOB_POLICE, JOB_CORPORATE_LIAISON, JOB_CHIEF_REQUISITION, JOB_CHIEF_ENGINEER, JOB_CMO, JOB_CHIEF_POLICE, JOB_SEA)
var/global/list/ROLES_OFFICERS		= list(JOB_CO, JOB_XO, JOB_SO, JOB_INTEL, JOB_PILOT, JOB_TANKER, JOB_SEA, JOB_SYNTH, JOB_CHIEF_POLICE, JOB_POLICE, JOB_CORPORATE_LIAISON)
