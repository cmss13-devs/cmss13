...
#define XENO_ROUNDSTART_PROGRESS_AMOUNT 			1.5
...
#define WHITELIST_YAUTJA_ELDER		2
#define WHITELIST_YAUTJA_COUNCIL	4
#define WHITELIST_PREDATOR			(WHITELIST_YAUTJA_UNBLOODED|WHITELIST_YAUTJA_ELDER|WHITELIST_YAUTJA_COUNCIL)
#define WHITELIST_COMMANDER			8
#define WHITELIST_COMMANDER_COUNCIL	16
#define WHITELIST_COMMANDER_HAS		(WHITELIST_COMMANDER|WHITELIST_COMMANDER_COUNCIL)
#define WHITELIST_SYNTHETIC			32
#define WHITELIST_SYNTHETIC_COUNCIL	64
#define WHITELIST_SYNTHETIC_HAS		(WHITELIST_SYNTHETIC|WHITELIST_SYNTHETIC_COUNCIL)
#define WHITELIST_ALL				(WHITELIST_YAUTJA_UNBLOODED|WHITELIST_YAUTJA_ELDER|WHITELIST_COMMANDER|WHITELIST_SYNTHETIC)
//=================================================
