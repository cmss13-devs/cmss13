...
/obj/structure/machinery/atmospherics/binary/New()
	..()
	switch(dir)
		if(NORTH)
...
/obj/structure/machinery/atmospherics/binary/Dispose()
	if(node1)
...
/obj/structure/machinery/atmospherics/binary/return_air()
	return list(gas_type, temperature, pressure)

/obj/structure/machinery/atmospherics/binary/return_pressure()
	return pressure

/obj/structure/machinery/atmospherics/binary/return_temperature()
	return temperature

/obj/structure/machinery/atmospherics/binary/return_gas()
	return gas_type
