...
/datum/file/program/welcome
	...
	interact()
		...
		if(!interactable())
			return
		var/dat = ""
		dat += "<center><span style='font-size:24pt'><b>Welcome to WYOS</b></span></center>"
		dat += "<center><span style='font-size:8pt'>Thank you for choosing WYOS, your gateway to the future of mobile computing technology, sponsored by Nanotrasen (R)</span></center><br>"
		dat += "<span style='font-size:12pt'><b>Getting started with WYOS:</b></span><br>"
		dat += "To leave a current program, click the X button in the top right corner of the window. This will return you to the WYOS desktop. \
		...
		When you rented your laptop, you were supplied with programs that your Weyland Yupatni Issued ID has given you access to use. \
