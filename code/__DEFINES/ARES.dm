...
#define FACTION_LIST_ARES_UA list(FACTION_MARINE, FACTION_ARES, FACTION_MARSHAL, FACTION_CONTRACTOR, FACTION_UNISC)
#define FACTION_LIST_ARES_ALL list(FACTION_ARES, FACTION_MARINE, FACTION_PMC, FACTION_WY_DEATHSQUAD, FACTION_WY, FACTION_MARSHAL, FACTION_UNISC)
