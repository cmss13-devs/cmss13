...
//toggles_insert
#define PLAY_INSERT_CORPORATE (1<<0)
#define PLAY_INSERT_LEADER (1<<1)
#define PLAY_INSERT_MEDIC (1<<2)
#define PLAY_INSERT_ENGINEER (1<<3)
#define PLAY_INSERT_SPECIALIST (1<<4)
#define PLAY_INSERT_SMARTGUNNER (1<<5)
#define PLAY_INSERT_SYNTH (1<<6)
#define PLAY_INSERT_CO (1<<7)
...
#define TOGGLES_INSERT_DEFAULT (PLAY_INSERT_CORPORATE|PLAY_INSERT_LEADER|PLAY_INSERT_MEDIC|PLAY_INSERT_ENGINEER|PLAY_INSERT_SPECIALIST|PLAY_INSERT_SMARTGUNNER|PLAY_INSERT_SYNTH|PLAY_INSERT_CO)
