...
#define PLAY_XENO_T2 (1<<7)
#define PLAY_XENO_T3 (1<<8)
...
#define TOGGLES_ERT_DEFAULT (PLAY_LEADER|PLAY_MEDIC|PLAY_ENGINEER|PLAY_HEAVY|PLAY_SMARTGUNNER|PLAY_SYNTH|PLAY_MISC|PLAY_XENO_T2|PLAY_XENO_T3)
