...
.langchat { font-family: 'Small Fonts'; font-size: 7px; -dm-text-outline: 1px black; }\
.langchat_small { font-size: 6px; }\
.langchat_yell { font-weight: bold; font-size: 10px; }\
.langchat_bolded { font-weight: bold; font-size: 8px; }\
.langchat_announce { font-weight: bold; font-size: 12px; }\
.langchat_bolditalicbig {font-weight: bold; font-size: 24px; font-style: italic; }\
.langchat_italic {font-style: italic; }"
