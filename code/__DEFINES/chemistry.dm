...
#define PROPERTY_OPTICCONEENHANCING "optic-cone Enhancing"
#define PROPERTY_OPTICRODENHANCING "optic-rod Enhancing"
#define PROPERTY_HYPEROPTIC "hyperoptic"
///Legendary properties, no PROPERTY_TYPE_ANOMALOUS, only normal ones.
#define PROPERTY_LEGENDARY_LIST list(PROPERTY_HYPERGENETIC, PROPERTY_BOOSTING, PROPERTY_REGULATING, PROPERTY_OPTIMIZED, PROPERTY_OPTICCONEENHANCING, PROPERTY_OPTICRODENHANCING)
