...
//listed grouping
#define XENO_VS_HUMAN_ARMOR_TYPES list(ARMOR_MELEE, ARMOR_BIO, ARMOR_INTERNALDAMAGE)
#define HUMAN_VS_HUMAN_ARMOR_TYPES list(ARMOR_BULLET, ARMOR_BOMB, ARMOR_INTERNALDAMAGE)
#define ALL_ARMOR_TYPES list(ARMOR_MELEE, ARMOR_BULLET, ARMOR_LASER, ARMOR_ENERGY, ARMOR_BOMB, ARMOR_BIO, ARMOR_RAD, ARMOR_INTERNALDAMAGE)
