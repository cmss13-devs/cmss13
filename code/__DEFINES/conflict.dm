...
#define WIELD_DELAY_MIN 0.1 SECONDS
#define WIELD_DELAY_VERY_FAST 0.2 SECONDS
#define WIELD_DELAY_FASTER 0.3 SECONDS
#define WIELD_DELAY_FAST 0.4 SECONDS
#define WIELD_DELAY_QUICK 0.5 SECONDS
#define WIELD_DELAY_NORMAL 0.6 SECONDS
#define WIELD_DELAY_SLOW 0.8 SECONDS
#define WIELD_DELAY_VERY_SLOW 1 SECONDS
#define WIELD_DELAY_HORRIBLE 1.2 SECONDS
