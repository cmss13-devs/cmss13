...
#define WEAPON_DELAY_MIN 0.1 SECONDS
#define WEAPON_DELAY_VERY_FAST 0.2 SECONDS
#define WEAPON_DELAY_FASTER 0.3 SECONDS
#define WEAPON_DELAY_FAST 0.4 SECONDS
#define WEAPON_DELAY_QUICK 0.5 SECONDS
#define WEAPON_DELAY_NORMAL 0.6 SECONDS
#define WEAPON_DELAY_SLOW 0.8 SECONDS
#define WEAPON_DELAY_VERY_SLOW 1 SECONDS
#define WEAPON_DELAY_HORRIBLE 1.2 SECONDS
