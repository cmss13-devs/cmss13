...
#define CO_GUNS list(CO_GUN_MATEBA, CO_GUN_MATEBA_SPECIAL, CO_GUN_M1911C, CO_GUN_DEAGLE, CO_GUN_2006M)

///Council CO special weapons options
#define COUNCIL_CO_GUNS list(CO_GUN_MATEBA_COUNCIL, CO_GUN_MATEBA_COUNCIL_GOLDEN, CO_GUN_2006M_COUNCIL, CO_GUN_2006MB_COUNCIL, CO_GUN_DEAGLE_COUNCIL)
