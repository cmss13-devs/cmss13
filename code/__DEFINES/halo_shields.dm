#define TESTER_SHIELD /datum/halo_shield/tester_shield
#define SANG_SHIELD_MINOR /datum/halo_shield/sangheili/minor
#define SANG_SHIELD_MAJOR /datum/halo_shield/sangheili/major
