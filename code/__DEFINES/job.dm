...
#define JOB_UACQS_ROLES_LIST list(JOB_CIA_UACQS_SEC, JOB_CIA_UACQS_ADMN, JOB_CIA_UACQS_COMR, JOB_CIA_UACQS_DG, JOB_CIA_UACQS_SG)
#define JOB_GRS_ROLES_LIST list(JOB_CIA_GRS_OPR, JOB_CIA_GRS_MED, JOB_CIA_GRS_ENG, JOB_CIA_GRS_HVY, JOB_CIA_GRS_SNP, JOB_CIA_GRS_TL, JOB_CIA_GRS_CDR)
