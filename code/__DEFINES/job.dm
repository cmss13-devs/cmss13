...
#define JOB_DROPSHIP_ROLES_LIST   list(JOB_DROPSHIP_PILOT, JOB_CAS_PILOT)
#define JOB_AUXILIARY_ROLES    /datum/timelock/auxiliary
#define JOB_AUXILIARY_ROLES_LIST   list(JOB_CAS_PILOT, JOB_DROPSHIP_PILOT, JOB_CREWMAN, JOB_INTEL)
