...
#define JOB_CIA_UACQS "UACQS Administrator"
#define JOB_CIA_UACQS_C "UACQS Commissioner"

#define JOB_CIA_ROLES_LIST list(JOB_CIA, JOB_CIA_LIAISON, JOB_CIA_UACQS, JOB_CIA_UACQS_C)
//-------- DUTCH'S DOZEN --------//
