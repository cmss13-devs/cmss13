...
#define JOB_CLF_BREACHER "CLF Breacher"
...
#define CLF_JOB_LIST list(JOB_CLF, JOB_CLF_ENGI, JOB_CLF_MEDIC, JOB_CLF_SPECIALIST, JOB_CLF_BREACHER, JOB_CLF_LEADER, JOB_CLF_COMMANDER, JOB_CLF_SYNTH)
