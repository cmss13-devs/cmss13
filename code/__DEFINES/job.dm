...
#define FLAG_SHOW_SECURITY		8
#define FLAG_SHOW_ENGINEERING	16
#define FLAG_SHOW_REQUISITION	32
#define FLAG_SHOW_MEDICAL		64
#define FLAG_SHOW_MARINES		128
#define FLAG_SHOW_ALL_JOBS		FLAG_SHOW_CIC|FLAG_SHOW_AUXIL_SUPPORT|FLAG_SHOW_MISC|FLAG_SHOW_SECURITY|FLAG_SHOW_ENGINEERING|FLAG_SHOW_REQUISITION|FLAG_SHOW_MEDICAL|FLAG_SHOW_MARINES
