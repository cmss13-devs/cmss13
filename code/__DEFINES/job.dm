...
#define JOB_WY_COMMANDO_DOGCATHER "W-Y Commando Dogcather"

#define ROLES_WY_COMMANDOS list(JOB_COMMANDO_STANDARD, JOB_COMMANDO_LEADER, JOB_COMMANDO_DOGCATHER)
