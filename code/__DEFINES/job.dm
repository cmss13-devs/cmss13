...
#define JOB_TWE_RMC_TEAMLEADER "RMC Teamleader"
#define JOB_TWE_RMC_LIEUTENANT "RMC Lieutenat"

#define TWE_COMMANDO_JOB_LIST list(JOB_TWE_RMC_RIFLEMAN, JOB_TWE_RMC_SPECIALIST, JOB_TWE_RMC_TEAMLEADER, JOB_TWE_RMC_LIEUTENANT)
