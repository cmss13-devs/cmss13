...
#define JOB_CIA_UACQS_SYN "UACQS Synthetic"
#define JOB_CIA_UACQS_SEC "UACQS Security"
#define JOB_CIA_UACQS_SECM "UACQS Security Medic"
...
#define JOB_UACQS_ROLES_LIST list(JOB_CIA_UACQS_SYN, JOB_CIA_UACQS_SEC, JOB_CIA_UACQS_SECM, JOB_CIA_UACQS_SECL, JOB_CIA_UACQS_ADMN, JOB_CIA_UACQS_COMR, JOB_CIA_UACQS_DG, JOB_CIA_UACQS_SG)
