...
#define JOB_PHARMACIST "Pharmaceutical Chemist"
#define JOB_MORTICIAN "Mortician"
...
#define JOB_MEDIC_ROLES_LIST list(JOB_SQUAD_MEDIC, JOB_CMO, JOB_DOCTOR, JOB_FIELD_DOCTOR, JOB_NURSE, JOB_RESEARCHER, JOB_SURGEON, JOB_PHARMACIST, JOB_MORTICIAN)
