...
#define JOB_LIMITED_HUD_LIST			list(JOB_ADMIRAL, JOB_GENERAL, JOB_B_GENERAL, JOB_CO, JOB_XO, JOB_SO, JOB_PILOT, JOB_DROPSHIP_CREW_CHIEF, JOB_CREWMAN, JOB_SQUAD_MARINE, JOB_SQUAD_LEADER, JOB_SQUAD_ENGI, JOB_SQUAD_MEDIC, JOB_SQUAD_SPECIALIST, JOB_SQUAD_SMARTGUN, JOB_SQUAD_RTO)
