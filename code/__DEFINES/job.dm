...
#define MAX_SURVIVOR_PER_TYPE list(ANY_SURVIVOR = -1, CIVILIAN_SURVIVOR = -1, SECURITY_SURVIVOR = 2, SCIENTIST_SURVIVOR = 2, MEDICAL_SURVIVOR = 2, ENGINEERING_SURVIVOR = 2, CORPORATE_SURVIVOR = 2, HOSTILE_SURVIVOR = 1)
