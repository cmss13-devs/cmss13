...
#define MINIMAP_FLAG_ALL_XENO MINIMAP_FLAG_XENO|MINIMAP_FLAG_XENO_CORRUPTED|MINIMAP_FLAG_XENO_ALPHA|MINIMAP_FLAG_XENO_BRAVO|MINIMAP_FLAG_XENO_CHARLIE|MINIMAP_FLAG_XENO_DELTA|MINIMAP_FLAG_XENO_FERAL|MINIMAP_FLAG_XENO_TAMED|MINIMAP_FLAG_XENO_MUTATED|MINIMAP_FLAG_XENO_FORSAKEN|MINIMAP_FLAG_XENO_RENEGADE
