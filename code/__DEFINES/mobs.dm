...
#define XENO_HIVE_MOBA_LEFT "xeno_hive_moba_left"
#define XENO_HIVE_MOBA_RIGHT "xeno_hive_moba_right"

#define XENO_HIVE_TUTORIAL "xeno_hive_tutorial"

#define ALL_XENO_HIVES list(XENO_HIVE_NORMAL, XENO_HIVE_CORRUPTED, XENO_HIVE_ALPHA, XENO_HIVE_BRAVO, XENO_HIVE_CHARLIE, XENO_HIVE_DELTA, XENO_HIVE_FERAL, XENO_HIVE_TAMED, XENO_HIVE_MUTATED, XENO_HIVE_FORSAKEN, XENO_HIVE_YAUTJA, XENO_HIVE_RENEGADE, XENO_HIVE_MOBA_LEFT, XENO_HIVE_MOBA_RIGHT, XENO_HIVE_TUTORIAL)
