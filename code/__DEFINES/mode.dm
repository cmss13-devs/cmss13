...
GLOBAL_LIST_INIT(ROLES_DISTRESS_SIGNAL, GLOB.ROLES_USCM + GLOB.ROLES_GROUND - JOB_PREDATOR -JOB_SQUAD_SMARTGUN - JOB_SYNTH_SURVIVOR - JOB_SYNTH_CMD - JOB_SYNTH_INTEL - JOB_SYNTH - JOB_WORKING_JOE - JOB_SYNTH_ENG - JOB_SYNTH_MED)
...
#define DEFAULT_ALLY_BAN_LIST (FACTION_LIST_XENOMORPH_CORRUPTEDLESS + FACTION_LIST_HUMANOID) - FACTION_COVENANT
