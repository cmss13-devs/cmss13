...
#define FACTION_CEC "Cosmos Exploration Corps"
...
#define FACTION_LIST_CEC list(FACTION_CEC, FACTION_UPP)
...
#define FACTION_LIST_SURVIVOR_CEC list(FACTION_SURVIVOR, FACTION_UPP, FACTION_CEC)
