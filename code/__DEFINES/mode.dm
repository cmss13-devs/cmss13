...
/// The roles that belong to other factions, but appear on the Almayer manifest as they're roundstart jobs.
GLOBAL_LIST_INIT(ROLES_USCM_FACTION_SHARED, list(JOB_CORPORATE_LIAISON, JOB_CORPORATE_BODYGUARD))
