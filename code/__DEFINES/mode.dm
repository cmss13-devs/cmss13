...
#define FACTION_LIST_UPP list(FACTION_UPP, FACTION_PAP, FACTION_UNISC)
#define FACTION_LIST_CLF list(FACTION_CLF)
#define FACTION_LIST_TWE list(FACTION_TWE, FACTION_IASF, FACTION_UNISC)
#define FACTION_LIST_UA list(FACTION MARINE, FACTION_MARSHAL, FACTION_CONTRACTOR, FACTION_FREELANCER, FACTION_UNISC)
...
#define FACTION_LIST_SURVIVOR_UA list(FACTION_SURVIVOR, FACTION_MARINE, FACTION_MARSHAL, FACTION_CONTRACTOR, FACTION_FREELANCER)
