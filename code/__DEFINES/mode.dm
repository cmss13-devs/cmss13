...
var/global/list/ROLES_COMMAND = list(JOB_CO, JOB_XO, JOB_FO, JOB_SO, JOB_INTEL, JOB_PILOT, JOB_DROPSHIP_CREW_CHIEF, JOB_CREWMAN, JOB_POLICE, JOB_CORPORATE_LIAISON, JOB_CHIEF_REQUISITION, JOB_CHIEF_ENGINEER, JOB_CMO, JOB_CHIEF_POLICE, JOB_SEA, JOB_SYNTH, JOB_WARDEN)
...
var/global/list/ROLES_CIC = list(JOB_CO, JOB_XO, JOB_FO, JOB_SO, JOB_WO_CO, JOB_WO_XO)
...
#define BLURB_USCM_COMBAT JOB_CO, JOB_XO, JOB_FO, JOB_SO, JOB_WO_CO, JOB_WO_XO, JOB_CREWMAN, JOB_WO_CHIEF_POLICE, JOB_WO_SO, JOB_WO_CREWMAN, JOB_WO_POLICE, JOB_SEA,\
