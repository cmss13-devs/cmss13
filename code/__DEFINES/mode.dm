...
DEFINE_BITFIELD(whitelist_status, list(
	"WHITELIST_YAUTJA" = WHITELIST_YAUTJA|WHITELIST_COMMANDER|WHITELIST_SYNTHETIC,
	...
	"WHITELIST_COMMANDER" = WHITELIST_COMMANDER|WHITELIST_YAUTJA|WHITELIST_SYNTHETIC,
	...
	"WHITELIST_JOE" = WHITELIST_JOE|WHITELIST_YAUTJA|WHITELIST_COMMANDER|WHITELIST_SYNTHETIC,
	"WHITELIST_SYNTHETIC" = WHITELIST_SYNTHETIC|WHITELIST_YAUTJA|WHITELIST_COMMANDER,
