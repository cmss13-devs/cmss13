...
#define FACTION_LIST_UA list(FACTION MARINE, FACTION_MARSHAL, FACTION_CONTRACTOR)
...
#define FACTION_LIST_SURVIVOR_UA list(FACTION_SURVIVOR, FACTION_MARINE, FACTION_MARSHAL, FACTION_CONTRACTOR, FACTION_UNISC)
