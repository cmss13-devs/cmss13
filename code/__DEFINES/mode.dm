...
#define FACTION_LIST_SURVIVOR_UA list(FACTION_SURVIVOR, FACTION_UA)
...
#define FACTION_LIST_UA list(FACTION_UA)
#define FACTION_LIST_UA_CIA list(FACTION_UA, FACTION_CIA)
#define FACTION_LIST_CIA list(FACTION_CIA)
#define FACTION_LIST_CIA_MARINE list(FACTION_CIA, FACTION_MARINE, FACTION_UA)
#define FACTION_LIST_CIA_UPP list(FACTION_CIA, FACTION_UPP, FACTION_UA)
#define FACTION_LIST_CIA_CLF list(FACTION_CIA, FACTION_CLF, FACTION_UA)
#define FACTION_LIST_CIA_CMB list(FACTION_CIA, FACTION_CMB, FACTION_UA)
#define FACITON_LIST_SURVIVOR_CIA list(FACTION_SURVIVOR, FACTION_CIA, FACTION_UA)
