...
#define FACTION_LIST_YAUTJA list(FACTION_YAUTJA, FACTION_YAUTJA_YOUNG, FACTION_BLOODED_HUNTER)//For faction grouping
#define FACTION_LIST_ALL_YAUTJA list(FACTION_YAUTJA, FACTION_YAUTJA_YOUNG, FACTION_BLOODED_HUNTER, FACTION_YAUTJA_STRANDED, FACTION_YAUTJA_BADBLOOD)//For follow menu simplicity.
