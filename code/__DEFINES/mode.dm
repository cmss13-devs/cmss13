...
#define FACTION_LASALLE_BIONATIONAL "Lasalle Bionational"
...
#define FACTION_LIST_LASALLE_BIONATIONAL list(FACTION_LASALLE_BIONATIONAL)
...
#define FACTION_LIST_SURVIVOR_LASALLE_BIONATIONAL list(FACTION_SURVIVOR, FACTION_LASALLE_BIONATIONAL)
