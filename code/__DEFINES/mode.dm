...
var/global/list/ROLES_COMMAND 		= list(JOB_CO, JOB_XO, JOB_SO, JOB_INTEL, JOB_PILOT, JOB_DROPSHIP_CREW_CHIEF, JOB_CREWMAN, JOB_SHIP_MARINE, JOB_CORPORATE_LIAISON, JOB_CHIEF_REQUISITION, JOB_CHIEF_ENGINEER, JOB_CMO, JOB_SHIP_MASTER_AT_ARMS, JOB_SEA, JOB_SYNTH)

#define ROLES_OFFICERS				list(JOB_CO, JOB_XO, JOB_SO, JOB_INTEL, JOB_PILOT, JOB_DROPSHIP_CREW_CHIEF, JOB_CREWMAN, JOB_SEA, JOB_CORPORATE_LIAISON, JOB_SYNTH, JOB_SHIP_MASTER_AT_ARMS, JOB_SHIP_MARINE)
...
var/global/list/ROLES_SECURITY		= list(JOB_SHIP_MASTER_AT_ARMS, JOB_SHIP_MARINE)
...
var/global/list/ROLES_REGULAR_ALL 	= ROLES_CIC+ ROLES_SECURITY + ROLES_AUXIL_SUPPORT + ROLES_MISC + ROLES_ENGINEERING + ROLES_REQUISITION + ROLES_MEDICAL + ROLES_MARINES + ROLES_SPECIAL + ROLES_WHITELISTED + ROLES_XENO - ROLES_WO
...
#define BLURB_USCM_SHIP_MARINE JOB_SHIP_MASTER_AT_ARMS, JOB_SHIP_MARINE
