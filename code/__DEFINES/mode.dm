...
#define FACTION_SYNTH_SURVIVOR "Synthetic Survivor"
...
#define FACTION_LIST_SURVIVOR_WY list(FACTION_SURVIVOR, FACTION_SYNTH_SURVIVOR, FACTION_PMC, FACTION_WY)
#define FACTION_LIST_SURVIVOR_NSPA list(FACTION_SURVIVOR, FACTION_SYNTH_SURVIVOR, FACTION_NSPA, FACTION_TWE)
#define FACTION_LIST_SURVIVOR_IASF list(FACTION_SURVIVOR, FACTION_SYNTH_SURVIVOR, FACTION_IASF, FACTION_TWE)
#define FACTION_LIST_SURVIVOR_PAP list(FACTION_SURVIVOR, FACTION_SYNTH_SURVIVOR, FACTION_PAP, FACTION_UPP)
#define FACTION_LIST_SURVIVOR_UPP list(FACTION_SURVIVOR, FACTION_SYNTH_SURVIVOR, FACTION_UPP)
...
#define FACTION_LIST_COLONY list(FACTION_SURVIVOR, FACTION_SYNTH_SURVIVOR, FACTION_COLONIST)
...
#define DEFAULT_ALLY_BAN_LIST FACTION_LIST_XENOMORPH_CORRUPTEDLESS + FACTION_LIST_HUMANOID - FACTION_SYNTH_SURVIVOR
