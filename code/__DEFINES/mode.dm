...
GLOBAL_LIST_INIT(ROLES_CIC_ANTAG, list(JOB_UPP_CO_OFFICER, JOB_UPP_KPT_OFFICER, JOB_UPP_SRLT_OFFICER, JOB_UPP_COMMISSAR))
...
GLOBAL_LIST_INIT(ROLES_AUXIL_SUPPORT_ANTAG, list(JOB_UPP_PILOT, JOB_UPP_CREWMAN))
...
GLOBAL_LIST_INIT(ROLES_MARINES_ANTAG, list(JOB_UPP_LEADER, JOB_UPP_SPECIALIST, JOB_UPP_MEDIC, JOB_UPP_ENGI, JOB_UPP))
