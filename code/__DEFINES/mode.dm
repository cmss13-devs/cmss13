...
#define TOGGLE_ITEM_ANIMATIONS				(1<<14) //Toggles tg-style item animations on and off, default on.
#define TOGGLE_SAME_TILE_ITEM_ANIMATIONS	(1<<15) //Toggles being able to see animations that occur on the same tile.
//=================================================
