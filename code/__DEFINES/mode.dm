...
#define FACTION_LIST_UPP list(FACTION_UPP, FACTION_PAP)
#define FACTION_LIST_CLF list(FACTION_CLF)
#define FACTION_LIST_TWE list(FACTION_TWE, FACTION_IASF, FACTION_NSPA)
#define FACTION_LIST_UA list(FACTION MARINE, FACTION_MARSHAL, FACTION_CONTRACTOR, FACTION_FREELANCER)
...
#define FACTION_LIST_UNISC (FACTION_UNISC, FACTION_LIST_UA, FACTION_LIST_TWE, FACTION_LIST_UPP)
#define FACTION_LIST_SURVIVOR_WY list(FACTION_SURVIVOR, FACTION_PMC, FACTION_WY, FACTION_WY_DEATHSQUAD)
#define FACTION_LIST_SURVIVOR_NSPA list(FACTION_SURVIVOR, FACTION_NSPA, FACTION_TWE, FACTION_UNISC)
#define FACTION_LIST_SURVIVOR_IASF list(FACTION_SURVIVOR, FACTION_IASF, FACTION_TWE, FACTION_UNISC)
#define FACTION_LIST_SURVIVOR_PAP list(FACTION_SURVIVOR, FACTION_PAP, FACTION_UPP, FACTION_UNISC)
#define FACTION_LIST_SURVIVOR_UPP list(FACTION_SURVIVOR, FACTION_UPP, FACTION_UNISC)
#define FACTION_LIST_SURVIVOR_UA list(FACTION_SURVIVOR, FACTION_MARINE, FACTION_MARSHAL, FACTION_CONTRACTOR, FACTION_FREELANCER, FACTION_UNISC)
...
//The list of factions considered terrorist organizations by the UA
#define FACTION_LIST_MARINE_TERRORIST list(FACTION_CLF, FACTION_HEFA)
