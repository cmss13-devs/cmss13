...
GLOBAL_LIST_INIT(ROLES_MISC, list(JOB_SYNTH, JOB_WORKING_JOE, JOB_CORPORATE_LIAISON, JOB_CORPORATE_SECURITY, JOB_COMBAT_REPORTER, JOB_MESS_SERGEANT, JOB_WO_CORPORATE_LIAISON, JOB_WO_SYNTH))
...
#define BLURB_USCM_WY JOB_CORPORATE_LIAISON, JOB_CORPORATE_SECURITY
