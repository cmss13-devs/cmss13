...
#define FACTION_LIST_CIA_MARINE list(FACTION_CIA, FACTION_MARINE)
#define FACTION_LIST_CIA_UPP list(FACTION_CIA, FACTION_UPP)
#define FACTION_LIST_CIA_CLF list(FACTION_CIA, FACTION_CLF)
#define FACTION_LIST_CIA_CMB list(FACTION_CIA, FACTION_CMB)
