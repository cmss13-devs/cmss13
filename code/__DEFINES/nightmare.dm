...
#define NIGHTMARE_SCENARIO_HOSTILE_SURVIVOR list("lvevent" = list("fallen_ship", "clfpods", "clfraid", "clfcrash", "clfsmugglers", "clf", "clfship", "clfspecforce"), "riot_in_progress" = list("rocinante"), "panic_room" = list("clfraid"))
