...
#define NUKE_DECRYPT_SHOW_TIMER_MINUTE 8
#define NUKE_DECRYPT_SHOW_TIMER_HALF 16
#define NUKE_DECRYPT_SHOW_TIMER_ALL (NUKE_SHOW_TIMER_ALL|NUKE_DECRYPT_SHOW_TIMER_MINUTE|NUKE_DECRYPT_SHOW_TIMER_HALF)
