...
#define PATHOGEN_T1_CASTES list(PATHOGEN_CREATURE_SPRINTER)
...
#define ALL_PATHOGEN_CREATURES list(PATHOGEN_CREATURE_BURSTER, PATHOGEN_CREATURE_SPRINTER, PATHOGEN_CREATURE_POPPER, PATHOGEN_CREATURE_NEOMORPH, PATHOGEN_CREATURE_BLIGHT, PATHOGEN_CREATURE_CONDITOR, PATHOGEN_CREATURE_BRUTE, PATHOGEN_CREATURE_VENATOR, PATHOGEN_CREATURE_HARBINGER, PATHOGEN_CREATURE_MATRIARCH, PATHOGEN_CREATURE_OVERMIND, PATHOGEN_CREATURE_ABER_BURSTER, PATHOGEN_CREATURE_ABERRATION)
