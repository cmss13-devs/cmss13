...
#define RADIO_CHANNEL_CLF_CMD "CLF Command"//NEED FREQ
#define RADIO_CHANNEL_CLF_CCT "CLF CCT"//NEED FREQ
#define RADIO_CHANNEL_CLF_MED "CLF Med"//NEED FREQ
#define RADIO_CHANNEL_CLF_ENGI "CLF Engi"//NEED FREQ

//UPP Comms
#define RADIO_CHANNEL_UPP_GEN "UPP"
#define RADIO_CHANNEL_UPP_CMD "UPP Command"//NEED FREQ
#define RADIO_CHANNEL_UPP_MED "UPP Med"//NEED FREQ
#define RADIO_CHANNEL_UPP_ENGI "UPP Engi"//NEED FREQ
#define RADIO_CHANNEL_UPP_CCT "UPP CCT"//NEED FREQ
#define RADIO_CHANNEL_UPP_KDO "UPP Kdo"//NEED FREQ

//WY Comms
#define RADIO_CHANNEL_WY "WY"
#define RADIO_CHANNEL_PMC_GEN "WY PMC"
#define RADIO_CHANNEL_PMC_CMD "PMC Command"//NEED FREQ
#define RADIO_CHANNEL_PMC_MED "PMC Med"//NEED FREQ
#define RADIO_CHANNEL_PMC_ENGI "PMC Engi"//NEED FREQ
#define RADIO_CHANNEL_PMC_CCT "PMC CCT"//NEED FREQ
