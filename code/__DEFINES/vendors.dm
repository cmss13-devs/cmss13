...
#define PREDATOR_CAN_BUY_SHOES "greaves"
#define PREDATOR_CAN_BUY_CLAN_MASK "clan_mask"
#define PREDATOR_CAN_BUY_PREDATOR_ARMOR "clan_armour"
#define PREDATOR_CAN_BUY_MAIN_WEAPON "main_weapon"
#define PREDATOR_CAN_BUY_ESSENTIALS "hunting_equipment"
#define PREDATOR_CAN_BUY_BRACER_ATTACHMENT "bracer_attachment"
#define PREDATOR_CAN_BUY_POUCH "pouch_slots"
#define PREDATOR_CAN_BUY_ACCESSORY "predator_accessory"
...
#define PREDATOR_CAN_BUY_ALL list(PREDATOR_CAN_BUY_ESSENTIALS = 1, PREDATOR_CAN_BUY_SHOES = 1, PREDATOR_CAN_BUY_CLAN_MASK = 1, PREDATOR_CAN_BUY_MAIN_WEAPON = 1, PREDATOR_CAN_BUY_BRACER_ATTACHMENT = 1, PREDATOR_CAN_BUY_POUCH = 2, PREDATOR_CAN_BUY_ACCESSORY = 1)
