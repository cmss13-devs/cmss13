#define WATER_DEPTH_LAND 0
#define WATER_DEPTH_COAST_DEPTHLESS -0.01
#define WATER_DEPTH_COAST_SHALLOW -2
#define WATER_DEPTH_COAST_INTERMEDIATE -4
#define WATER_DEPTH_SHALLOW -8
#define WATER_DEPTH_INTERMEDIATE -12
#define WATER_DEPTH_DEEP -18

#define WATER_TOXIC_NO 0
#define WATER_TOXIC_YES 1
#define WATER_TOXIC_DISPERSING -1
