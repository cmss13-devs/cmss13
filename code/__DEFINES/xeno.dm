...
// Cost to create design nodes.
#define XENO_DESIGN_WALL_COST (XENO_RESIN_WALL_COST - (XENO_RESIN_BASE_COST * 2))
#define XENO_DESIGN_DOOR_COST (XENO_RESIN_DOOR_COST - (XENO_RESIN_BASE_COST * 2))

#define XENO_DESIGN_THICK_WALL_COST (XENO_RESIN_WALL_THICK_COST - (XENO_RESIN_BASE_COST * 2))
#define XENO_DESIGN_THICK_DOOR_COST (XENO_RESIN_DOOR_THICK_COST - (XENO_RESIN_BASE_COST * 2))

#define XENO_DESIGN_QUEEN_WALL_COST (XENO_RESIN_WALL_QUEEN_COST - (XENO_RESIN_BASE_COST * 2))
#define XENO_DESIGN_QUEEN_DOOR_COST (XENO_RESIN_DOOR_QUEEN_COST - (XENO_RESIN_BASE_COST * 2))
