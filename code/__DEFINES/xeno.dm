...
#define XENO_STARTING_CRYSTAL 100 //How much building resource the king gets to start with
...
#define XENO_HEALTH_KING		1000 * XENO_UNIVERSAL_HPMULT
...
#define XENO_RESIN_WALL_KING_COST 120
...
#define XENO_RESIN_DOOR_KING_COST 100
#define XENO_RESIN_DOOR_THICK_COST 120
#define XENO_RESIN_MEMBRANE_COST 70
#define XENO_RESIN_MEMBRANE_KING_COST 80
...
#define KING_SPAWN_TIMEOUT (2 MINUTES)
