...
#define TAILSTRIKE_COOLDOWN_NONE 0
#define TAILSTRIKE_COOLDOWN_VERY_LOW 0.1
#define TAILSTRIKE_COOLDOWN_LOW 0.5
#define TAILSTRIKE_COOLDOWN_NORMAL 1
#define TAILSTRIKE_COOLDOWN_HIGH 1.5
#define TAILSTRIKE_COOLDOWN_VERY_HIGH 2
