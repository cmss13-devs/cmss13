...
#define VICAR_SCREECH_BUFF 1
#define VICAR_SCREECH_DEBUFF 2
...
#define XENO_CASTE_VICAR             "Vicar"
#define XENO_T3_CASTES               list(XENO_CASTE_BOILER, XENO_CASTE_PRAETORIAN, XENO_CASTE_CRUSHER, XENO_CASTE_RAVAGER, XENO_CASTE_VICAR)
//special
...
// Vicar
#define VICAR_ROAR_ENHANCED (1<<1)
