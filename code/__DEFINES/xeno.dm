...
#define ALL_XENO_STRAINS list(FACEHUGGER_WATCHER, DRONE_HEALER, DRONE_GARDENER, HIVELORD_RESIN_WHISPERER, HIVELORD_DESIGNER, CARRIER_EGGSAC, BOILER_TRAPPER, RUNNER_ACIDER, LURKER_VAMPIRE, WARRIOR_BULWARK, RAVAGER_HEDGEHOD, RAVAGER_BERSERKER, DEFENDER_STEELCREST, CRUSHER_CHARGER, PRAETOREON_VANGUARD, PRAETOREON_DANCER, PRAETOREON_VALKYRIE, PRAETOREON_OPPRESSOR)
