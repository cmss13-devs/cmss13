...
#define ROYAL_SCREECH_BUFF 1
#define ROYAL_SCREECH_DEBUFF 2
...
#define XENO_CASTE_ROYAL            "Royal"
#define XENO_T3_CASTES               list(XENO_CASTE_BOILER, XENO_CASTE_PRAETORIAN, XENO_CASTE_CRUSHER, XENO_CASTE_RAVAGER, XENO_CASTE_ROYAL)
//special
...
// Royal
#define ROYAL_ROAR_ENHANCED (1<<1)
