...
#define GUARDIAN_SCREECH_BUFF 1
#define GUARDIAN_SCREECH_DEBUFF 2
...
#define XENO_CASTE_GUARDIAN             "Guardian"
#define XENO_T3_CASTES               list(XENO_CASTE_BOILER, XENO_CASTE_PRAETORIAN, XENO_CASTE_CRUSHER, XENO_CASTE_RAVAGER, XENO_CASTE_GUARDIAN)
//special
...
// Guardian
#define GUARDIAN_ROAR_ENHANCED (1<<1)
