...
/proc/sortRecord(list/datum/data/record/L, field = "name", var/order = 1)
	if(isnull(L))
		return list()
	if(L.len < 2)
		return L
...
/proc/mergeRecordLists(list/datum/data/record/L, list/datum/data/record/R, field = "name", var/order = 1)
	var/Li=1
	var/Ri=1
	var/list/result = new()
