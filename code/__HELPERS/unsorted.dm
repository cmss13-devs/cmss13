...
/proc/key_name(whom, include_link = null, var/include_name = 1, var/highlight_special_characters = 1)
	var/mob/M
	var/client/C
	var/key
...
/area/proc/move_contents_to(area/A, turftoleave=null, var/direction = null)
...
/proc/explosive_grief_check(obj/item/explosive/E)
