...
DEFINE_BITFIELD(hive_flags, list(
	"XENO_SLASH_FORBIDDEN" = XENO_SLASH_FORBIDDEN,
	"XENO_SLASH_RESTRICTED" = XENO_SLASH_RESTRICTED,
	"XENO_CONSTRUCTION_LEADERS_ONLY" = XENO_CONSTRUCTION_LEADERS_ONLY,
	"XENO_CONSTRUCTION_QUEEN_ONLY" = XENO_CONSTRUCTION_QUEEN_ONLY,
	"XENO_CONSTRUCTION_NOBODY" = XENO_CONSTRUCTION_NOBODY,
	"XENO_DECONSTRUCTION_QUEEN_ONLY" = XENO_DECONSTRUCTION_QUEEN_ONLY,
	"XENO_DECONSTRUCTION_LEADERS_ONLY" = XENO_DECONSTRUCTION_LEADERS_ONLY,
	"XENO_DECONSTRUCTION_NOBODY" = XENO_DECONSTRUCTION_NOBODY,
