...
DEFINE_BITFIELD(storage_flags, list(
	...
	"STORAGE_PRESET_HOLD_ONLY" = STORAGE_PRESET_HOLD_ONLY,
	"STORAGE_CAN_HOLD_SKILL_ONLY" = STORAGE_CAN_HOLD_SKILL_ONLY,
	"STORAGE_INSTANT_PILL_GRABBABLE" = STORAGE_INSTANT_PILL_GRABBABLE,
	"STORAGE_INSTANT_PILL_GRAB_MODE" = STORAGE_INSTANT_PILL_GRAB_MODE,
	"STORAGE_WEIGHTED" = STORAGE_WEIGHTED,
))
