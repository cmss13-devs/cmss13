...
DEFINE_BITFIELD(surgery_status, list(
	"INCISION_BLEEDING" = INCISION_BLEEDING,
	"INCISION_CLAMPED" = INCISION_CLAMPED,
	"INCISION_MADE" = INCISION_MADE,
	"INCISION_WIDENED" = INCISION_WIDENED,
	"INCISION_BONE_CLOSED" = INCISION_BONE_CLOSED,
	"INCISION_BONE_OPENED" = INCISION_BONE_OPENED,
	"INCISION_PELVIS_HIDDEN" = INCISION_PELVIS_HIDDEN,
	"INCISION_PELVIS_EXPOSED" = INCISION_PELVIS_EXPOSED,
	"INCISION_INT_BLEEDING" = INCISION_INT_BLEEDING,
))
