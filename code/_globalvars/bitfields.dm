...
DEFINE_BITFIELD(chem_effect_flags, list(
	...
	"CHEM_EFFECT_ORGAN_BODY_STASIS" = CHEM_EFFECT_ORGAN_BODY_STASIS,
	"CHEM_EFFECT_NO_BLEEDING" = CHEM_EFFECT_NO_BLEEDING,
	"CHEM_EFFECT_ORGAN_BRAIN_STASIS" = CHEM_EFFECT_ORGAN_BRAIN_STASIS,
	"CHEM_EFFECT_ORGAN_EYE_STASIS" = CHEM_EFFECT_ORGAN_EYE_STASIS,
))
