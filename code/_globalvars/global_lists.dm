...
/proc/setup_wy_droid_emotes()
	var/list/emotes_to_add = list()
	for(var/datum/emote/living/carbon/human/synthetic/gen_two/wy_droid/emote as anything in subtypesof(/datum/emote/living/carbon/human/synthetic/gen_two/wy_droid))
