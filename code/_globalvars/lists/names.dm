...
GLOBAL_LIST_INIT(first_names_male_pmc, file2list("strings/first_male_pmc.txt"))
GLOBAL_LIST_INIT(first_names_female_pmc, file2list("strings/first_female_pmc.txt"))
GLOBAL_LIST_INIT(last_names_pmc, file2list("strings/last_pmc.txt"))
