GLOBAL_LIST_FILE_LOAD(ai_names, "config/names/ai.txt")
GLOBAL_LIST_FILE_LOAD(first_names_male, "config/names/first_male.txt")
GLOBAL_LIST_FILE_LOAD(first_names_female, "config/names/first_female.txt")
GLOBAL_LIST_FILE_LOAD(last_names, "config/names/last.txt")
GLOBAL_LIST_FILE_LOAD(clown_names, "config/names/clown.txt")
GLOBAL_LIST_FILE_LOAD(operation_titles, "config/names/operation_title.txt")
GLOBAL_LIST_FILE_LOAD(operation_prefixes, "config/names/operation_prefix.txt")
GLOBAL_LIST_FILE_LOAD(operation_postfixes, "config/names/operation_postfix.txt")

GLOBAL_LIST_FILE_LOAD(verbs, "config/names/verbs.txt")
...
GLOBAL_LIST_INIT(monkey_names, list("Abu", "Aldo", "Bear", "Bingo", "Clyde", "Crystal", "Gordo", "George", "Koko", "Marcel", "Nim", "Geeves", "Nanu", "Rafiki", "Spike", "Banana", "Boots", "Bubbles", "Smiley", "Winston"))
