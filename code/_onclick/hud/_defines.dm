...
#define ui_alien_nightvision "EAST-1:28,9:13"
#define ui_alien_health "EAST-1:28,7:13" //aliens have the health display where humans have the bodytemp indicator.
#define ui_queen_locator "EAST-1:28,8:13"
#define ui_alienplasmadisplay "EAST-1:28,6:13"
#define ui_alienarmordisplay "EAST-1:28,5:13"
