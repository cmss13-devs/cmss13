...
/datum/hud/brain/New(mob/living/brain/owner, ui_style='icons/mob/hud/screen1_Midnight.dmi')
	..()
...
/datum/hud/hellhound/New(mob/living/carbon/hellhound/owner, ui_style = 'icons/mob/hud/screen1_Midnight.dmi')
	..()
