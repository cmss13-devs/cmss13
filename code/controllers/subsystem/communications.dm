...
#define DEPT_FREQS list(COMM_FREQ, MED_FREQ, SEC_FREQ, SEC_FREQ, ALPHA_FREQ, BRAVO_FREQ, CHARLIE_FREQ, DELTA_FREQ, ECHO_FREQ, CRYO_FREQ, REQ_FREQ, JTAC_FREQ, INTEL_FREQ, WY_FREQ)
...
/datum/radio_frequency/proc/post_signal(obj/source as obj|null, datum/signal/signal, var/filter = null as text|null, var/range = null as num|null)
	...
	if (filter)
		...
		send_to_filter(source, signal, RADIO_FROM_AIRALARM, start_point, range)
	else
