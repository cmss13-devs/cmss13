...
#define BADBLOOD_FREQ 1207
#define STRANDED_FREQ 1208
...
// Response Teams
#define ERT_FREQS list(VAI_FREQ, DUT_FREQ, YAUT_FREQ, YAUT_OVR_FREQ, BADBLOOD_FREQ, STRANDED_FREQ, CMB_FREQ, RMC_FREQ)
