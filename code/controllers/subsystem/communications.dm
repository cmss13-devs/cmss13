...
#define DSP1_FREQ 1497
#define DSP2_FREQ 1498
#define DSP3_FREQ 1499
...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_PELICAN_ECHO = DSP1_FREQ,
	RADIO_CHANNEL_PELICAN_SIERRA = DSP2_FREQ,
	RADIO_CHANNEL_PELICAN_WHISKEY = DSP3_FREQ,
