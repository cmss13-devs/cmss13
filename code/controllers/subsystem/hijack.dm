...
/datum/controller/subsystem/hijack/proc/initiate_charge_ftl()
	...
	marine_announcement("Quantum jump initiated. Virtual mass field opened... Hyperspace transition successful. Lifeboats and pods disabled until arrival.", HIJACK_ANNOUNCE, sound('sound/mecha/powerup.ogg'))
