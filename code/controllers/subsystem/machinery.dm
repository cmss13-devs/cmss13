...
GLOBAL_LIST_EMPTY_TYPED(powernets, /datum/powernet) //Holds all powernet datums in use or pooled
GLOBAL_LIST_EMPTY_TYPED(powernets_by_name, /datum/powernet) //Holds all powernet datums in use or pooled
