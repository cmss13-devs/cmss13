...
#define PIPE_COLOUR_RED "#ff0000"
#define PIPE_COLOUR_BLUE "#0000ff"
#define PIPE_COLOUR_CYAN "#00ffff"
#define PIPE_COLOUR_GREEN "#00ff00"
#define PIPE_COLOUR_YELLOW "#ffcc00"
#define PIPE_COLOR_PURPLE "#5c1ec0"

var/global/list/pipe_colors = list("grey" = PIPE_COLOR_GREY, "red" = PIPE_COLOUR_RED, "blue" = PIPE_COLOUR_BLUE, "cyan" = PIPE_COLOUR_CYAN, "green" = PIPE_COLOUR_GREEN, "yellow" = PIPE_COLOUR_YELLOW, "purple" = PIPE_COLOR_PURPLE)
