...
client
	proc/debug_variables(datum/D in world)
		...
		if(istype(D,/atom))
			var/atom/A = D
			if(isliving(A))
				body += "<a href='?_src_=vars;rename=\ref[D]'><em>[D]</em></a>"
				if(A.dir)
				...
				body += "<a href='?_src_=vars;datumedit=\ref[D];varnameedit=name'><em>[D]</em></a>"
				if(A.dir)
					body += "<br><font size='1'><a href='?_src_=vars;rotatedatum=\ref[D];rotatedir=left'><<</a> <a href='?_src_=vars;datumedit=\ref[D];varnameedit=dir'>[dir2text(A.dir)]</a> <a href='?_src_=vars;rotatedatum=\ref[D];rotatedir=right'>>></a></font>"
		else
			body += "<em>[D]</em>"
		...
		if(src.holder && src.holder.marked_datum && src.holder.marked_datum == D)
			body += "<br><font size='1' color='red'><em>Marked Object</em></font>"
		...
		body += "<font size='1'><em>E</em> - Edit, tries to determine the variable type by itself.<br>"
		body += "<em>C</em> - Change, asks you for the var type first.<br>"
		body += "<em>M</em> - Mass modify: changes this variable for all objects of this type.</font><br>"
