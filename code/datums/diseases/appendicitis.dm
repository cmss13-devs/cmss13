...
/datum/disease/appendicitis/stage_act()
	...
	if(stage == 1)
		if(prob(5))
			to_chat(affected_mob, SPAN_DANGER("You feel a stinging pain in your abdomen!"))
			affected_mob.emote("me",1,"winces slightly.")
	if(stage > 1)
		if(prob(3))
			to_chat(affected_mob, SPAN_DANGER("You feel a stabbing pain in your abdomen!"))
	...
	if(stage > 2)
		if(prob(1))
			if (affected_mob.nutrition > 100)
				...
				to_chat(affected_mob, SPAN_DANGER("You gag as you want to throw up, but there's nothing in your stomach!"))
				affected_mob.KnockDown(10)
				affected_mob.adjustToxLoss(3)
	if(stage > 3)
		if(prob(1) && ishuman(affected_mob))
			var/mob/living/carbon/human/H = affected_mob
			to_chat(H, SPAN_DANGER("Your abdomen is a world of pain!"))
			H.KnockDown(10)
