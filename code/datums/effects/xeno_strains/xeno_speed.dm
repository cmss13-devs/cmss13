...
/datum/effects/xeno_speed/New(atom/A, mob/from = null, last_dmg_source = null, zone = "chest", ttl = 3.5 SECONDS, set_speed_modifier = 0, set_modifier_source = null, set_end_message = SPAN_XENONOTICE("You feel lethargic..."), show_balloon_alert = FALSE)
...
/datum/effects/xeno_speed/Destroy()
	if(added_effect)
		...
		if(istype(xeno) && show_balloon_alert)
