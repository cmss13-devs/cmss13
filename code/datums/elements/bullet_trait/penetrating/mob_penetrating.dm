/datum/element/bullet_trait_penetrating/weak/mob_penetrating
	...
	var/initial_portion_lost_per_hit = 0.55

/datum/element/bullet_trait_penetrating/weak/mob_penetrating/Attach(datum/target, distance_loss_per_hit, damage_percent_lost_per_hit, turf_hit_slow_mult, initial_portion_lost_per_hit)
	. = ..()
	src.initial_portion_lost_per_hit = initial_portion_lost_per_hit
...
/datum/element/bullet_trait_penetrating/weak/mob_penetrating/handle_passthrough_movables(obj/projectile/bullet, atom/movable/hit_movable, did_hit)
	if(ismob(hit_movable))
		...
		damage = damage - bullet.ammo.damage * initial_portion_lost_per_hit
