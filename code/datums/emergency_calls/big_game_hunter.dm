...
/datum/emergency_call/van_bandolier/create_member(datum/mind/M, turf/override_spawn_loc)
	...
	game wherever you can find it. You've heard grisly tales of murderous xenomorphs, trigger-happy soldiers, and bloodthirsty alien hunters (who sound like they have \
