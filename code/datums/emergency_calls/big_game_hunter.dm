...
/datum/emergency_call/van_bandolier/create_member(datum/mind/M, turf/override_spawn_loc)
	...
	arm_equipment(human, /datum/equipment_preset/fun/van_bandolier, FALSE, TRUE)

	to_chat(human, SPAN_ROLE_HEADER("You are a big game hunter!"))
	to_chat(human, SPAN_ROLE_BODY("You've taken a shot at every beast of the earth, every fowl of the air, and everything that creepeth upon the earth. Mundane beasts \
