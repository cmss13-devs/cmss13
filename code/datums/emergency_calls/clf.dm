...
/datum/emergency_call/clf/print_backstory(mob/living/carbon/human/mob)
	...
	to_chat(mob, "<B>As a native of the Tychon's Rift sector, you joined the CLF because [message_grew].")
	to_chat(mob, "<B>You grew up [message] and are considered a terrorist by the UA.</B>")
