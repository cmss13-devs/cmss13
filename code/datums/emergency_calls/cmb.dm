...
/datum/emergency_call/cmb/New()
    ...
    objectives = "Investigate the distress signal aboard the [MAIN_SHIP_NAME], and assist the crew with rescue if possible. If necessary, we have a contingent of Colonial Marines available."
