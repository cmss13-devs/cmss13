...
/datum/emergency_call/inspection_cmb/New()
	...
	objectives = "Get your instructions from the CMB Office at Anchorpoint Station, and carry out your orders. Ensure that Colonial assets are safe and in your custody. Do not enforce or override Marine Law on a Marine Ship unless requested, as it's outside of your jurisdiction."
...
/datum/emergency_call/inspection_cmb/print_backstory(mob/living/carbon/human/M)
	if(M == leader)
		...
		to_chat(M, SPAN_BOLD("You are [pick(30; "skeptical", 40;"amiable", 30;"supportive")] of Weyland-Yutani."))
		...
		to_chat(M, SPAN_BOLD("You are [pick(60; "skeptical", 40;"amiable", 10;"supportive")] of Weyland-Yutani and their practices."))
		to_chat(M, SPAN_BOLD("You are [pick(40; "skeptical", 30;"amiable", 30;"supportive")] with the USCM's actions on the frontier."))
