...
/datum/emergency_call/inspection_cmb/print_backstory(mob/living/carbon/human/M)
	if(M == leader)
		to_chat(M, SPAN_BOLD("You are the Colonial Marshal, originally from [pick_weight(list("The United Americas" = 70, "Sol" = 20, "a colony on the frontier" = 10))
		to_chat(M, SPAN_BOLD("You started in the Marshals through [pick_weight(list( "pursuing a career during college" = 50, "working for law enforcement" = 40, "being recruited for your skills" = 10))
		...
		to_chat(M, SPAN_BOLD("You are an Interstellar Commerce Liaison, originally from [pick_weight(list("The United Americas" = 70, "Sol" = 25, "a colony on the frontier" = 5))
		to_chat(M, SPAN_BOLD("You are [pick_weight(list( "skeptical" = 30, "ambicable" = 40, "supportive" = 30))
		...
		to_chat(M, SPAN_BOLD("You are an Interstellar Human Rights Observer, originally from [pick_weight(list("The United Americas" = 50, "Europe" = 10, "Luna" = 10, "Sol" = 20, "a colony on the frontier" = 10))
		to_chat(M, SPAN_BOLD("You are [pick_weight(list( "skeptical" = 60, "ambicable" = 40, "supportive" = 10))
		to_chat(M, SPAN_BOLD("You are [pick_weight(list( "skeptical" = 40, "ambicable" = 30, "supportive" = 30))
		...
		to_chat(M, SPAN_BOLD("You are a CMB Deputy, originally from [pick_weight(list("The United Americas" = 70, "Sol" = 20, "a colony on the frontier" = 10))
		to_chat(M, SPAN_BOLD("You joined the Marshals through [pick_weight(list( "pursuing a career during college" = 50, "working for law enforcement" = 40, "being recruited for your skills" = 10))
		...
		to_chat(M, SPAN_BOLD("You have interstellar jurisdiction as a CMB Official to enforce Colonial and Earth law, but you cannot and should not override Marine Law on a Marine Ship."))
		to_chat(M, SPAN_BOLD("You have been stationed at Anchorpoint Station for [pick_weight(list("several months" = 80, "only a week" = 10, "years" = 10))
