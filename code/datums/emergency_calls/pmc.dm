...
/datum/emergency_call/pmc/print_backstory(mob/living/carbon/human/M)
	...
	to_chat(M, "<em>Joining the ranks of Weyland Yutani has proven to be very profitable for you.</em>")
	...
	to_chat(M, "")
	to_chat(M, "")
	to_chat(M, "<em>Ensure no damage is incurred against Weyland Yutani. Make sure the CL is safe.</em>")
