...
/datum/emergency_call/pred/create_member(datum/mind/man, turf/override_spawn_loc)
	...
	if(mercs < max_mercs && HAS_FLAG(hunted.client.prefs.toggles_ert_pred, PLAY_MERC))
		mercs++
		var/list/hunted_types = list(/datum/equipment_preset/other/freelancer/leader, /datum/equipment_preset/contractor/duty/standard, /datum/equipment_preset/contractor/duty/leader, /datum/equipment_preset/other/freelancer/standard)
		...
		upp++
		var/list/hunted_types = list(/datum/equipment_preset/upp/soldier,/datum/equipment_preset/upp/officer, /datum/equipment_preset/upp/leader, /datum/equipment_preset/upp/sapper)
		var/hunted_type = pick(hunted_types)
		arm_equipment(hunted, hunted_type , TRUE, TRUE)
		...
		var/list/hunted_types = list (/datum/equipment_preset/uscm/rifleman_pve, /datum/equipment_preset/uscm/tl_pve, /datum/equipment_preset/uscm/sg_pve, /datum/equipment_preset/uscm/sl_pve)
		var/hunted_type = pick(hunted_types)
		arm_equipment(hunted, hunted_type , TRUE, TRUE)
