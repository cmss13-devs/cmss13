...
/datum/emergency_call/souto
	...
	mob_max = 1
	mob_min = 1
	arrival_message = "Give a round of applause for the marine who sent in ten-thousand Souto tabs to get me here! "+MAIN_SHIP_DEFAULT_NAME+", Souto Man's here to party with YOU!"
