...
/datum/emergency_call/upp/print_backstory(mob/living/carbon/human/M)
	...
	to_chat(M, SPAN_BOLD("With the recent arrival of the  USCM battalion the 'Falling Falcons' and their flagship, the [MAIN_SHIP_NAME], Podpolkovnik Ganbaatar has felt threatened in the sector."))
