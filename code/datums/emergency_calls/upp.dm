...
/datum/emergency_call/upp/New()
		...
		objectives = "Eliminate the UA Forces to ensure the UPP prescence in this sector is continued. Listen to your superior officers and take over \the [MAIN_SHIP_NAME] at all costs."
