...
/datum/emergency_call/upp_commando/print_backstory(mob/living/carbon/human/M)
	...
	to_chat(M, SPAN_BOLD("You were shipped off with the battalion to one of the UPP's most remote territories, a gas giant designated MV-35 in the Anglo-Japanese Arm, in the Neroid Sector sector."))
	...
	to_chat(M, SPAN_BOLD("With the recent arrival of the USCM battalion the 'Falling Falcons' and their flagship, the [MAIN_SHIP_NAME], Ganbaatar has felt threatened."))
