...
/datum/emergency_call/upp_commando/print_backstory(mob/living/carbon/human/M)
	...
	to_chat(M, SPAN_BOLD("In an effort to protect the vulnerable MV-35 from the emproaching UA/USCM imperialists, the leadership of your battalion has opted this the best opportunity to strike at the Falling Falcons to catch them off guard."))
