...
/datum/faction/clf/get_antag_guns_snowflake_equipment()
	return list(
		...
		list("MSP-64 Submachinegun", 20, /obj/item/weapon/gun/smg/bizon, null, VENDOR_ITEM_REGULAR),
...
/datum/faction/clf/get_antag_guns_sorted_equipment()
	return list(
		...
		list("MSP-64 Submachinegun", 20, /obj/item/weapon/gun/smg/bizon, VENDOR_ITEM_REGULAR),
		...
		list("MSP-64 Helical Magazine (8.6x20mm)", 60, /obj/item/ammo_magazine/smg/bizon, VENDOR_ITEM_REGULAR),
