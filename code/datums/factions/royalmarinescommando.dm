...
/datum/faction/royal_marines_commando/modify_hud_holder_from_data(image/holder, location, job_rank, paygrade, assignment, rank_fallback, rank_override, datum/squad/squad)
	...
	if(hud_icon_state)
		holder.overlays += image(base_icon_file, location, "rmc_[hud_icon_state]")
