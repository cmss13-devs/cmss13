/datum/faction/zombie
	...
	organ_faction_iff_tag_type = /obj/item/faction_tag/organ/meshy_rooting_gland
...
/datum/faction/zombie/get_join_status(mob/user, dat)
	...
	var/mob/living/carbon/human/zombie = zombie_list[choice]
	...
	user.mind.transfer_to(zombie, TRUE)
	msg_admin_niche("[key_name(usr)] has joined as a [zombie].")
