...
/datum/looping_sound
	...
	//Let's you make a "loud" sound that "projects." IE you can hear this sound from a further distance away.______qdel_list_wrapper(list/L)
...
/datum/looping_sound/proc/play(soundfile, volume_override)
	...
	if (is_sound_projecting)
		...
		//playsound(loc, 		'.ogg', 	100, 		0, 	100,		 VOLUME_SFX, 0, 0, 50, 50)
		return
