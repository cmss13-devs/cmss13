...
/datum/map_template/shuttle/load(turf/target_turf, centered=FALSE, delete=FALSE, allow_cropping=FALSE, crop_within_type=null, crop_within_border=1, expand_type=null, register=TRUE)
	. = ..()
	if(!.)
		return
