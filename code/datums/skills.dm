...
/datum/skill/security
	skill_name = SKILL_SECURITY
	skill_level = SKILL_SECURITY_DEFAULT
...
/datum/skills/upp
	...
	skills = list(
		...
		SKILL_CQC = SKILL_CQC_EXPERT,
		SKILL_SECURITY = SKILL_SECURITY_SKILLED, //mostly here for fireman carry
		SKILL_FIREARMS = SKILL_FIREARMS_TRAINED
	)
...
/datum/skills/everything //max it out
	...
	skills = list(
		...
		SKILL_SECURITY = SKILL_SECURITY_MAX,
