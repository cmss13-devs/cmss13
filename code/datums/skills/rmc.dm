...
/datum/skills/military/survivor/rmc
	name = "Royal Marines Commando"
	skills = list(
		SKILL_CQC = SKILL_CQC_TRAINED,
...
/datum/skills/military/survivor/rmc/specialist
	name = "Royal Marines Commando Specialist"
	skills = list(
		SKILL_CQC = SKILL_CQC_TRAINED,
		SKILL_FIREARMS = SKILL_FIREARMS_EXPERT,
...
/datum/skills/military/survivor/rmc/leader
	name = "Royal Marines Commando Team Leader"
	skills = list(
		SKILL_CQC = SKILL_CQC_SKILLED,
		SKILL_FIREARMS = SKILL_FIREARMS_EXPERT,
		SKILL_POLICE = SKILL_POLICE_SKILLED,
