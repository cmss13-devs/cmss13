...
/datum/spaceport/uscm
	...
	docking_message = "Attention, USS Almayer. This is Major Pereira with the Solar Devils Battalion. We are launching umbilical cords and deploying a fireteam now."
	allies = list(
		/datum/emergency_call/solar_devils, //10 marines with buffed gear and skills it a bit too much.
	)
