...
/datum/supply_packs/plants/potato
	name = "Potatoes(x20)"
	contains = list(
...
/datum/supply_packs/plants/tomatoes
	name = "tomatoes (x20)"
	contains = list(
...
/datum/supply_packs/plants/soybeans
	name = "soybeans (x20)"
	contains = list(
...
/datum/supply_packs/plants/cocoapod
	name = "cocoapod(x10)"
	contains = list(
...
/datum/supply_packs/plants/fruits
...
/datum/supply_packs/plants/wheat
	name = "wheat (x20)"
	contains = list(
