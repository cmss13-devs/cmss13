...
//guncases clean and neat

/datum/supply_packs/m56_hmg
	name = "M56D Heavy Machine Gun (Guncase x1)"
	contains = list(
...
/datum/supply_packs/m2c_hmg
	name = "M2C Heavy Machine Gun (Guncase x1)"
	contains = list(
...
/datum/supply_packs/grenade_launchers
	name = "M79 Grenade Launcher Crate (Guncase x2)"
	contains = list(
...
/datum/supply_packs/mou53
	name = "MOU-53 Break Action Shotgun Crate (Guncase x2)"
	contains = list(
...
/datum/supply_packs/smartpistol
	name = "SU-6 Smart Pistol Crate (Guncase x2)"
	contains = list(
...
/datum/supply_packs/vp78
	name = "VP-78 Hand Cannon Crate (Guncase x2)"
	contains = list(
...
/datum/supply_packs/gun
	...
	name = "M41A MK1 Rifle Crate (Guncase x2)"
	cost = 40
	containertype = /obj/structure/closet/crate/weapon
...
/datum/supply_packs/gun/heavyweapons
	...
	name = "M41AE2 HPR crate (Guncase x2)"
	cost = 40
	containertype = /obj/structure/closet/crate/weapon
...
/datum/supply_packs/gun/xm88
	...
	name = "XM88 Heavy Rifle crate (Guncase x2)"
	cost = 40
	containertype = /obj/structure/closet/crate/weapon
