...
/datum/tutorial/marine/basic/init_map()
	...
	var/obj/structure/machinery/cm_vending/clothing/tutorial/clothing_vendor = new(locate(bottom_left_corner.x, bottom_left_corner.y + 4, bottom_left_corner.z))
	add_to_tracking_atoms(clothing_vendor)
	var/obj/structure/machinery/cm_vending/sorted/cargo_guns/squad_prep/tutorial/gun_vendor = new(locate(bottom_left_corner.x, bottom_left_corner.y + 5, bottom_left_corner.z))
