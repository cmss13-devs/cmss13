...
/datum/tutorial/marine/medical_basic/proc/on_health_examine(datum/source, mob/living/carbon/human/attacked_mob)
	...
	var/obj/item/reagent_container/hypospray/autoinjector/ez/one_use/bicaridine/brute_injector = new(loc_from_corner(0, 4))
...
/datum/tutorial/marine/medical_basic/proc/on_brute_inject(datum/source, obj/item/reagent_container/hypospray/injector)
	...
	if(!istype(injector, /obj/item/reagent_container/hypospray/autoinjector/ez/one_use/bicaridine))
		return

	UnregisterSignal(tutorial_mob, COMSIG_LIVING_HYPOSPRAY_INJECTED)
	TUTORIAL_ATOM_FROM_TRACKING(/obj/item/reagent_container/hypospray/autoinjector/ez/one_use/bicaridine, brute_injector)
...
/datum/tutorial/marine/medical_basic/proc/burn_tutorial()
	...
	var/obj/item/reagent_container/hypospray/autoinjector/ez/one_use/kelotane/burn_injector = new(loc_from_corner(0, 4))
...
/datum/tutorial/marine/medical_basic/proc/on_burn_inject(datum/source, obj/item/reagent_container/hypospray/injector)
	...
	if(!istype(injector, /obj/item/reagent_container/hypospray/autoinjector/ez/one_use/kelotane))
		return

	UnregisterSignal(tutorial_mob, COMSIG_LIVING_HYPOSPRAY_INJECTED)
	TUTORIAL_ATOM_FROM_TRACKING(/obj/item/reagent_container/hypospray/autoinjector/ez/one_use/kelotane, burn_injector)
...
/datum/tutorial/marine/medical_basic/proc/pain_tutorial()
	...
	var/obj/item/reagent_container/hypospray/autoinjector/ez/one_use/tramadol/pain_injector = new(loc_from_corner(0, 4))
...
/datum/tutorial/marine/medical_basic/proc/on_pain_inject(datum/source, obj/item/reagent_container/hypospray/injector)
	...
	if(!istype(injector, /obj/item/reagent_container/hypospray/autoinjector/ez/one_use/tramadol))
		return

	UnregisterSignal(tutorial_mob, COMSIG_LIVING_HYPOSPRAY_INJECTED)
	TUTORIAL_ATOM_FROM_TRACKING(/obj/item/reagent_container/hypospray/autoinjector/ez/one_use/tramadol, pain_injector)
