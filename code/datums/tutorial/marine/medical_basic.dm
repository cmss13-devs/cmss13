...
/datum/tutorial/marine/medical_basic/proc/pain_tutorial()
	...
	var/obj/item/reagent_container/hypospray/autoinjector/marine/tramadol/pain_injector = new(loc_from_corner(0, 4))
...
/datum/tutorial/marine/medical_basic/proc/on_pain_inject(datum/source, obj/item/reagent_container/hypospray/injector)
	...
	if(!istype(injector, /obj/item/reagent_container/hypospray/autoinjector/marine/tramadol))
		return

	UnregisterSignal(tutorial_mob, COMSIG_LIVING_HYPOSPRAY_INJECTED)
	TUTORIAL_ATOM_FROM_TRACKING(/obj/item/reagent_container/hypospray/autoinjector/marine/tramadol, pain_injector)
