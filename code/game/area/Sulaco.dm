...
/area/shuttle/drop_upp/gagarin
	name = "\improper Dropship Gagarin"
	icon_state = "shuttle"
	base_muffle = MUFFLE_HIGH
	base_lighting_alpha = 255
...
/area/shuttle/drop_upp/transit
	ambience_exterior = 'sound/ambience/dropship_ambience_loop.ogg'
	name = "\improper Dropship Gagarin Transit"
	icon_state = "shuttlered"

/area/shuttle/drop_upp/lz_upp
	name = "\improper Gagarin Landing Zone"
	icon_state = "away2"

////

/area/shuttle/drop_upp2/korolev
	name = "\improper Dropship Korolev"
	icon_state = "shuttle"
	base_muffle = MUFFLE_HIGH
	base_lighting_alpha = 255
...
/area/shuttle/drop_upp2/transit
	ambience_exterior = 'sound/ambience/dropship_ambience_loop.ogg'
	name = "\improper Dropship Korolev Transit"
	icon_state = "shuttlered"

/area/shuttle/drop_upp2/lz_upp
	name = "\improper Korolev Landing Zone"
	icon_state = "away2"
