...
/atom/proc/flamer_fire_act(dam = BURN_LEVEL_TIER_1, var/datum/cause_data/flame_cause_data)
	return
...
/atom/proc/Shake(pixelshiftx = 15, var/pixelshifty = 15, var/duration = 250)
