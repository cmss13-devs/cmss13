...
/atom/movable/proc/spin(duration, turn_delay = 1, var/clockwise = 0, var/cardinal_only = 1)
	set waitfor = 0
...
/atom/movable/proc/spin_circle(num_circles = 1, var/turn_delay = 1, var/clockwise = 0, var/cardinal_only = 1)
	set waitfor = 0
