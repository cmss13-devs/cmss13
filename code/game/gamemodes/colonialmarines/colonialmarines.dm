...
/datum/game_mode/colonialmarines/proc/lore_announcement()
	...
	switch(SSmapping.configs[GROUND_MAP].map_name)
		if(MAP_WHITE_VENIR_RESEARCH_FACILITY)
			...
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(venir_announcement), "Attention! The site is experiencing a massive containment breach! Full site lockdown initiated.", "White Venir Central Announcement", 'sound/ambience/containment_breach1.ogg'), 30 SECONDS)
			...
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(xeno_announcement), "My children. I sense the putrid presence of another hive. They are of our flesh but not of our own. I sense unyielding anger, rage and fury emenating from this hive, you must prepare yourself, no doors will bar you nor them forever.", "everything", QUEEN_MOTHER_ANNOUNCE), 10 SECONDS)
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(xeno_lore_announcement), "Something is happening. Your chance to escape may soon reveal itself, prepare! 2.", "everything", "Queen Mother Announcement", 'sound/ambience/containment_breach1.ogg'), 30 SECONDS)
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(xeno_announcement), "My children. I sense the putrid hive has fled, but some of the hosts that entrapped you remain alive within this metal complex, and I sense even more are on their way. Defeat these hosts to showcase your supremacy!", "everything", QUEEN_MOTHER_ANNOUNCE), 2 MINUTES)
