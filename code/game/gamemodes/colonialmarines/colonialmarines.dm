...
/datum/game_mode/colonialmarines/post_setup()
	...
	spawn (50)
		switch(map_tag)
			...
			if(MAP_BIG_RED)
				marine_announcement("We've lost contact with the Weyland-Yutani's research facility, [map_tag]. The [MAIN_SHIP_NAME] has been dispatched to assist.", "[MAIN_SHIP_NAME]")
