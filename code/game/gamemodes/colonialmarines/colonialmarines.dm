...
/datum/game_mode/colonialmarines/proc/lore_announcement()
	...
	switch(SSmapping.configs[GROUND_MAP].map_name)
		...
		if(MAP_NEW_VARADERO)
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(xeno_announcement), "My children. Your hive has become seperated by a great auqatic barrier, and as such I have divided your hive into two. Your sub-hive will defend the island, you will defeat the sky hosts above and ensure they do not claim this island and its metal structures whilst the other sub-hive overtakes the last defences of this world’s hosts.", "everything", QUEEN_MOTHER_ANNOUNCE), 20 SECONDS)
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(marine_announcement), "US#M fo#$#, this is N$% Var##-- ##&@ion #$%^-------------------#ou r#$#? Rep#*t, ###% i# the New Varadero Gararrison’s Acting Commander Lieute$an# #--#$#-------- #% you rea##.\n\n Base has been overrun by some kinda ’bug men’ most of our forces are K and or M, I.A.\n\n Me and what reminas of the garrison are set up in entrenchements across the coast, long side of a collapsed tunnel.\n\n Ain’t cut these things off though, we’re doing out best to keep the bugs from reaching New Varadero Actual.\n\n You lot need to get in there, and wipe out whatever the source of these damn bugs is and stat. Over.", "New Varadero, LACN One-Way Emergency Relay",'sound/AI/commandreport.ogg'), 5 MINUTES)
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(marine_announcement), "Almayer! You still re## &@? We’re trying to g&@ through to you #$# two-way communic##%#ns we got, however seems theres some kinda radio interferance on anything weaker then this emergency relay this far from the base's comms towers.\n\n Regardless, local law enforcement is lending a hand here in coastal quarintine and preparing the city for the worst.\n\n Plan still stands, we’re gonna need you to deploy to the base and cut off this thing off from the source. Over.", "New Varadero, LACN One-Way Emergency Relay",'sound/AI/commandreport.ogg'), 20 MINUTES)
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(marine_announcement), "#@@#%-- %-%#--- #%#%#-? #%^#^--- situ#&@on is worsening, gia#$ lobst#$ like bug me# overwhelmed coastal defences near the tunnel.\n\n We’ve pulled back to New Vara#%### City li%^ts, local civilians are armed to defend their home, defenc#$ ain’t good. We’re being bombarded by acid here though. Doc#yards under siege by f##%^## cra# m#$, we’re losing ground here.\n\n Seems d#&@ bugs are target#%^ requ%^----------d areosp#%e craft wi%h #%#^##, wip# out th#$ hive on tha# island now. Over.", "New Varadero, LACN One-Way Emergency Relay",'sound/AI/commandreport.ogg'), 45 MINUTES)
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(marine_announcement), "Almaye#! Status report, east suburbs and dock#%^# fully overwhelmed.\n\n Its full out streetfighting out here, barely got a visua# on it. Have ordered the la#t of my men a#% function##% as my link to forces of armed and untrai#%# civili%#s and a handful of peacekeepers.\n\n I am praying that you are close to decapitating that source or there wont be any of New Varadero left. Over", "New Varadero, LACN One-Way Emergency Relay",'sound/AI/commandreport.ogg'), 70 MINUTES)
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(marine_announcement), "Alma#$%^ This is Private First Class Torr#%, Lieute$### is KIA. City is almost entirely overan, las#!$@--- #%#treate# #enteral Buisness Distr%##^---- As Acting N#% Va#%#ero Com#%nder I am offi#%^# #equesting immediate aid. Pleas-# send anythin#%!^- we’r% almos% ou# of a#^s dow# her#","New Varadero, LACN One-Way Emergency Relay",'sound/AI/commandreport.ogg'), 100 MINUTES)
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(marine_announcement), "Private First #l%ss To#r#@ again What little is left of us a%# h#ld out in Saint Ferrer’s Hospital- Well what litt#l #s left.\n\n The ER and the childrens ward have falle%#---- #%ve ordered via hospit#% PA system for whoever is left to retreat to the hospital landing#%- on the ro#f. Howeve# I’m c#% o## with a #%^ oth#% #%---", "New Varadero, LACN One-Way Emergency Relay",'sound/AI/commandreport.ogg'), 120 MINUTES)
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(marine_announcement), "Th#s is Commision#%r #%#^-@#%##! Po#% k#% s^#& #%#sel%! I% #%e marine# th#t the Lieu#%^## menti##%d ar# readi#% th#s, every#%# is d#^#@$--#%^-fa#l%##^#-------", "New Varadero, LACN One-Way Emergency Relay",'sound/AI/commandreport.ogg'), 140 MINUTES)
