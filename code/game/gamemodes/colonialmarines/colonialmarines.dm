...
/datum/game_mode/colonialmarines/check_win()
	...
	if(EvacuationAuthority.dest_started_at && (EvacuationAuthority.dest_started_at + SELF_DESTRUCT_ROD_STARTUP_TIME + 1200) < world.time) round_finished = MODE_INFESTATION_X_MINOR
