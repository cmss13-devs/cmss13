...
/datum/game_mode/colonialmarines/proc/lore_announcement()
	...
	switch(SSmapping.configs[GROUND_MAP].map_name)
		if(MAP_WHITE_VENIR_RESEARCH_FACILITY)
			...
			addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(xeno_announcement), "My children. I sense the putrid presence of another hive. They are of our flesh but not of our own. I sense this putrid hive is preparing to escape this metal cage, you must prepare yourself, no doors will bar you forever, you will soon have revenge on the hosts for their entrapment of your hive.", "everything", QUEEN_MOTHER_ANNOUNCE), 10 SECONDS)
