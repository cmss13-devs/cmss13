...
/datum/game_mode/whiskey_outpost
	...
	role_mappings = list(
		/datum/job/command/commander/whiskey = JOB_WO_CO,
		/datum/job/command/executive/whiskey = JOB_WO_XO,
		/datum/job/civilian/synthetic/whiskey = JOB_WO_SYNTH,
		/datum/job/command/warrant/whiskey = JOB_WO_CHIEF_POLICE,
		/datum/job/command/bridge/whiskey = JOB_WO_SO,
		/datum/job/command/tank_crew/whiskey = JOB_WO_CREWMAN,
		/datum/job/command/police/whiskey = JOB_WO_POLICE,
		/datum/job/command/pilot/whiskey = JOB_WO_PILOT,
		/datum/job/logistics/requisition/whiskey = JOB_WO_CHIEF_REQUISITION,
		/datum/job/civilian/professor/whiskey = JOB_WO_CMO,
		/datum/job/civilian/doctor/whiskey = JOB_WO_DOCTOR,
		/datum/job/civilian/researcher/whiskey = JOB_WO_RESEARCHER,
		/datum/job/logistics/engineering/whiskey = JOB_WO_CHIEF_ENGINEER,
		/datum/job/logistics/tech/maint/whiskey = JOB_MAINT_TECH,
		/datum/job/logistics/cargo/whiskey = JOB_WO_REQUISITION,
		/datum/job/civilian/liaison/whiskey = JOB_WO_CORPORATE_LIAISON,
		/datum/job/marine/leader/whiskey = JOB_WO_SQUAD_LEADER,
		/datum/job/marine/specialist/whiskey = JOB_WO_SQUAD_SPECIALIST,
		/datum/job/marine/smartgunner/whiskey = JOB_WO_SQUAD_SMARTGUNNER,
		/datum/job/marine/medic/whiskey = JOB_WO_SQUAD_MEDIC,
		/datum/job/marine/engineer/whiskey = JOB_WO_SQUAD_ENGINEER,
		/datum/job/marine/standard/whiskey = JOB_WO_SQUAD_MARINE,
	)
