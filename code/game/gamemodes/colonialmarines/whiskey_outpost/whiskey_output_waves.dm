...
/datum/whiskey_outpost_wave/wave1
	...
	command_announcement = list("We're tracking the creatures that wiped out our patrols heading towards your outpost, Multiple small life-signs detected enroute to the outpost.. Stand-by while we attempt to establish a signal with the USS Alistoun to alert them of these creatures.", "Colonel Naiche, 3rd Battalion Command, LV-624 Garrison")
	scaling_factor = 0.3
...
/datum/whiskey_outpost_wave/wave7
	...
	number_of_xenos = 3
	command_announcement = list("Captain Ike Saker, aide of Colonel Naiche, speaking. The Colonel is still trying to try and get off world contact. An engineer platoon managed to destroy the main entrance into this valley this should give you a short break while the aliens find another way in. We are receiving reports of seismic waves occuring nearby, there might be creatures burrowing underground, keep an eye on your defenses. I have also received word that marines from an overrun outpost are evacuating to you and will help you. I used to be stationed with them, they are top notch!", "Captain Ike Saker, 3rd Battalion Command, LV-624 Garrison")
...
/datum/whiskey_outpost_wave/wave8
	...
	wave_castes = list(XENO_CASTE_LURKER,
					...
					XENO_CASTE_WARRIOR)
	sound_effect = list()
	command_announcement = list("Colonel Naiche speaking, we've been unsuccessful in establishing offworld communication for the moment. We're prepping our M402 mortars to destroy the inbound xeno force on the main road. Standby for fire support.", "Colonel Naiche, 3rd Battalion Command, LV-624 Garrison")
...
/datum/whiskey_outpost_wave/wave12
	...
	wave_castes = list(XENO_CASTE_RUNNER,
					...
					XENO_CASTE_PRAETORIAN)
	command_announcement = list("This is Colonel Naiche, we are picking up large signatures inbound, we'll see what we can do to delay them.", "Colonel Naiche, 3rd Battalion Command, LV-624")
...
/datum/whiskey_outpost_wave/wave14
	...
	wave_type = WO_STATIC_WAVE
	number_of_xenos = 50
	command_announcement = list("This is Colonel Naiche, we've established our distress beacon for the USS Alistoun and the remaining Dust Raiders. Hold on for a bit longer while we trasmit our coordinates!", "Colonel Naiche, 3rd Battalion Command, LV-624 Garrison")
