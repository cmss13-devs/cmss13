...
/datum/whiskey_outpost_wave/wave1
	...
	command_announcement = list(
		"We're tracking the creatures that wiped out our patrols. They're heading towards your outpost, multiple small life-signs detected. We're attempting to establish a signal with the USS Alistoun, stand by.",
		"Captain Naiche, 3rd Battalion Command, LV-624 Garrison",
		)
	scaling_factor = 0.3
...
/datum/whiskey_outpost_wave/wave7
	...
	number_of_xenos = 4
	command_announcement = list(
		"This is First Lieutenant Ike Saker, Executive Officer of Captain Naiche. The Captain is still trying to get off world contact. An engineer platoon managed to destroy the main entrance into this valley; this should give you a short break while the aliens find another way in. We are receiving reports of seismic waves occurring nearby, there might be creatures burrowing underground. Keep an eye on your defenses. I have also received word that marines evacuating from an overrun outpost are coming to reinforce you. I used to be stationed with them, those troops are top notch.",
		"First Lieutenant Ike Saker, 3rd Battalion Command, LV-624 Garrison",
		)
...
/datum/whiskey_outpost_wave/wave8
	...
	sound_effect = list()
	command_announcement = list(
		"Captain Naiche speaking, we've been unsuccessful in establishing offworld communication so far. We're prepping our M402 mortars to destroy the inbound forces on the main road. Stand by for fire support.",
		"Captain Naiche, 3rd Battalion Command, LV-624 Garrison",
		)
...
/datum/whiskey_outpost_wave/wave9 // Tier II more common, Tier I less common, Early Ravs and Early Boiler (Ideal only 1 boiler)
	...
	command_announcement = list(
		"Our garrison forces are reaching seventy percent casualties. We're losing our grip here. It appears that the vanguard of the hostile force is still approaching, and most of the other Dust Raider platoons have been shattered. We need you to hold.",
		"Captain Naiche, 3rd Battalion Command, LV-624 Garrison",
		)
...
/datum/whiskey_outpost_wave/wave12
	...
	command_announcement = list(
		"This is Captain Naiche. Large signatures inbound. We'll try to buy you some time.",
		"Captain Naiche, 3rd Battalion Command, LV-624",
		)
...
/datum/whiskey_outpost_wave/wave14
	...
	number_of_xenos = 50
	command_announcement = list(
		"This is Captain Naiche, we've just succeeded in establishing off-world contact. We're transmitting our coordinates, but it'll take time. Hold for just a little bit longer!",
		"Captain Naiche, 3rd Battalion Command, LV-624 Garrison",
		)
