...
/proc/carp_migration() // -- Darem
	...
	spawn(rand(300, 600)) //Delayed announcements to keep the crew on their toes.
		marine_announcement("Неизвестные формы жизни зафиксированы рядом с [MAIN_SHIP_NAME], пожалуйста ожидайте.", "Уведомление о признаках жизни", 'sound/AI/commandreport.ogg')
