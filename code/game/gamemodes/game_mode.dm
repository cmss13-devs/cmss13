...
GLOBAL_LIST_EMPTY(player_entities)
...
/datum/game_mode/proc/check_finished() //to be called by ticker
	if(GLOB.EvacuationAuthority.dest_status == NUKE_EXPLOSION_FINISHED || GLOB.EvacuationAuthority.dest_status == NUKE_EXPLOSION_GROUND_FINISHED )
		return TRUE
