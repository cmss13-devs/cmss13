...
/proc/get_all_main_access()//Grants standard access for all factions, does not include high restrictions like COs office.
...
/proc/get_all_marine_access()//Includes restricted accesses
	return list(
...
/proc/get_main_marine_access() //Does not have the more restrictive accesses.
	return list(
