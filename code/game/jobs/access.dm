...
/proc/get_region_accesses(code)
	switch(code)
		...
		if(5)
			return list(ACCESS_MARINE_CAPTAIN, ACCESS_MARINE_SENIOR, ACCESS_MARINE_DATABASE, ACCESS_MARINE_COMMAND, ACCESS_MARINE_RO, ACCESS_MARINE_CARGO, ACCESS_MARINE_SEA, ACCESS_MARINE_SYNTH, ACCESS_MARINE_IO) // Command
		if(6)
...
/proc/get_access_desc(A)
	switch(A)
		...
		if(ACCESS_MARINE_IO) return "Intelligence Officer"
