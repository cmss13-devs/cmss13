...
/datum/job/antag/xenos/queen/transform_to_xeno(mob/living/carbon/human/human_to_transform, faction_index)
	SSticker.mode.pick_queen_spawn(human_to_transform, faction_index)
