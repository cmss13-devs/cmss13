/datum/job/civilian/liaison
	...
	total_positions = 1
	spawn_positions = 1
	supervisors = "ONI High Command"
	selection_class = "job_cl"
	flags_startup_parameters = ROLE_ADD_TO_DEFAULT
	gear_preset = /datum/equipment_preset/uscm_ship/liaison
	entry_message_body = "As a <a href='"+WIKI_PLACEHOLDER+"'>Specialist from the Office of Naval Intelligence</a> from Section Two, your job requires you to stay in character at all times. On ship, you are subject to orders only by the Command and Security departments. You are not required to follow any orders but you can be arrested if you do not. Your primary job is to observe and report back your findings to ONI. Follow regular game rules unless told otherwise by your superiors. Use your office fax machine to communicate with ONI headquarters or to acquire new directives. You may not receive anything back, and this is normal."
