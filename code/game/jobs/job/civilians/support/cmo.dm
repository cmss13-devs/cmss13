...
/datum/job/civilian/professor
	...
	entry_message_body = "As the primary representative of the medical knowledge and practice onboard this vessel, your job is to <a href='"+WIKI_PLACEHOLDER+"'>supervise the medical and research teams and ensure they are well behaved and coordinated</a>. Your authority is ample, even though your real knowledge is not necessarily so, and you should have this in mind when supervising your subordinates. You answer to the Commander and, if necessity calls you to take over-all command as the acting Commander, High Command. You are also encouraged to fill the gaps where your teams are inefective or understaffed."
