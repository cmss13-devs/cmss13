...
/datum/job/civilian/doctor/generate_entry_message(mob/living/carbon/human/target)
	switch(doctor_variant)
		if(SURGEON_VARIANT)
			. = {"You're a commissioned officer of the USCM. <a href='[generate_wiki_link()]'>You are a doctor specialized in surgery and triage.</a> Your primary job is keeping marines healthy and strong by fixing broken bones, blood vessels, and organs and performing foreign object extractions based on case severity. You are also very capable in medicine and pharmacology; if the pharmacy and triage bays are understaffed, and you have nobody left to operate on, it is also your job to develop chemicals or treat patients based on case severity. If you do not know what you are doing, mentorhelp so a mentor can assist you."}
		if(PHARMACIST_VARIANT)
			. = {"You're a commissioned officer of the USCM. <a href='[generate_wiki_link()]'>You are a doctor specialized in the development and testing of pharmaceuticals.</a> Your primary job is providing the medical bay and marines with medicine and chemicals. You are also very capable in medicine and surgery; if the triage and surgery bays are understaffed, and you have nobody left to operate on, it is also your job to to treat patients based on case severity. If you do not know what you are doing, mentorhelp so a mentor can assist you."}
		else
