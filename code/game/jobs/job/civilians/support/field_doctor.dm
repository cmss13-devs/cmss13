...
/datum/job/civilian/field_doctor
	...
	entry_message_body = "You are a <a href='"+WIKI_PLACEHOLDER+"'>Field Doctor</a> tasked with keeping the marines healthy and strong in the field. Usually in the form of surgery. You must stay onboard the Almayer medical bay if there are no other doctors present. You must wait until the FOB is secured before deploying. Your deployment to the field may be subject to approval by the CMO or other superior officers. Make sure to look at the field doctor wiki page for other rules."
