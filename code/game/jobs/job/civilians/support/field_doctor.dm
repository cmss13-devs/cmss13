...
/datum/job/civilian/field_doctor
	...
	entry_message_body = "You're a commissioned officer of the USCM. <a href='"+WIKI_PLACEHOLDER+"'>You are a doctor specialized in field medicine and surgery.</a> Your primary job is to deploy with your fellow marines, medicate, and operate on the wounded the safety of your FOB tent. You must stay onboard the Almayer until your superior says it is safe to deploy, after the FOB is secured, and there is least one other doctor on the ship. You are still a doctor, so if you are waiting for deployment, it is your responsibility to assist other doctors in surgery and chembay prep."
