/datum/job/command/pilot/operations_pilot
	...
	entry_message_body = "<a href='"+WIKI_PLACEHOLDER+"'>Your job is to fly, protect, and maintain the AD-19D chimera.</a> While you are an officer, your authority is limited to the vtol, where you have authority over the enlisted personnel."
