...
/datum/job/command/executive
	...
	entry_message_body = "<a href='"+URL_WIKI_XO_GUIDE+"'>You are second in command aboard the USS Almayer,</a> and are in next in the chain of command after the Commanding Officer. You must abide by the <a href='"+URL_WIKI_CO_RULES+"'>Commanding Officer Code of Conduct</a>. You may need to fill in for other duties if areas are understaffed, and you are given access to do so. Make the USCM proud!"
