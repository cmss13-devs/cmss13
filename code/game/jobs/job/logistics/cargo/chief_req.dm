...
/datum/job/command/pilot/chief_requisition/generate_entry_conditions(mob/living/chief_requisition, whitelist_status)
	. = ..()
...
/datum/job/command/pilot/chief_requisition/proc/cleanup_active_chief_requisition(mob/chief_requisition)
	SIGNAL_HANDLER
	active_chief_requisition = null

/datum/job/command/pilot/chief_requisition/get_active_player_on_job()
