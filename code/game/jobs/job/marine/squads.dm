...
/datum/squad/proc/send_maptext(text="", title_text="", only_leader=FALSE)
...
/datum/squad/proc/send_message(text="", transmitter=null, only_leader=FALSE)
	var/nametext = ""
	if(transmitter)
...
/// Displays a message to squad members in chat and directly on the game map.
/datum/squad/proc/transmit_alert(prefix="", text="", postfix="", maptext_title="", transmitter=null, only_leader=FALSE)
	send_message("[prefix][text][postfix]", transmitter, only_leader)
	send_maptext(text, maptext_title, only_leader)

/// Displays and sets an objective for squad members in chat and directly on the game map.
/datum/squad/proc/transmit_objective(text="", transmitter=null, primary=TRUE)
	...
	send_message("[prefix][text][postfix]", transmitter)
	send_maptext(text, maptext_title)
