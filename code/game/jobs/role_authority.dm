...
/datum/authority/branch/role/proc/assign_to_xenomorph(mob/M)
...
/datum/authority/branch/role/proc/free_role_admin(datum/job/J, latejoin = 1, var/user) //Specific proc that used for admin "Free Job Slots" verb (round tab)
