...
/obj/machinery/computer/message_monitor/attack_hand(var/mob/living/user as mob)
	...
	if(auth)
		...
		dat += " Server Power: <A href='?src=\ref[src];active=1'>[src.linkedServer && src.linkedServer.active ? "<font color='green'>\[On\]</font>":"<span class='caution'>\[Off\]</span>"]</a></h4>"
	else
		dat += "<h4><dd><A href='?src=\ref[src];auth=1'>&#09;<span class='caution'>\[Unauthenticated\]</span></a>&#09;/"
		dat += " Server Power: <u>[src.linkedServer && src.linkedServer.active ? "<font color='green'>\[On\]</font>":"<span class='caution'>\[Off\]</span>"]</u></h4>"
