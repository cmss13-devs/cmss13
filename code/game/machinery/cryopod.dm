...
/obj/structure/machinery/cryopod/proc/despawn_occupant()
	...
	if(cryo_pod.record_id_ref)
		QDEL_NULL(GLOB.data_core.medical[cryo_pod.record_id_ref])
		QDEL_NULL(GLOB.data_core.general[cryo_pod.record_id_ref])
		QDEL_NULL(GLOB.data_core.security[cryo_pod.record_id_ref])
