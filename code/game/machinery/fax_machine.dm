		...
		if(!(receiver.inoperable()))
			...
			spawn(30)
				...
				if(sending_priority)
					...
					langchat_send_message("beeps with a priority message", LANGCHAT_IMAGE_IGNORE_LANG | LANGCHAT_IMAGE_IS_EMOTE, get_mobs_in_view(GLOB.world_view_size, receiver), animation_style = LANGCHAT_FAST_POP, additional_styles = list("langchat_small"))
