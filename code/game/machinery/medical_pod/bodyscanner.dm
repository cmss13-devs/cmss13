...
/obj/structure/machinery/body_scanconsole/proc/format_occupant_data(list/occ)
	...
	dat += "[SET_CLASS("Blood Level:", INTERFACE_HEADER_COLOR)] [SET_CLASS("[occ["blood_amount"]*100 / occ["normal_blood"]]% ([occ["blood_amount"]] units)", s_class)]<br><br>"
