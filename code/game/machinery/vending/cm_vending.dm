...
/obj/structure/machinery/cm_vending/clothing
	...
	listed_products = list(
		...
		list("Underbarrel extinguisher", 10, /obj/item/attachable/attached_gun/extinguisher, null, "black"),
		list("M37 wooden stock", 15, /obj/item/attachable/stock/shotgun, null, "black"),
		list("M41A solid stock", 15, /obj/item/attachable/stock/rifle, null, "black"),
...
/obj/structure/machinery/cm_vending/clothing/medic
	...
	listed_products = list(
		...
		list("BELT (choose 1)", 0, null, null, null),
		list("Lifesaver belt", 0, /obj/item/storage/belt/medical/lifesaver/full, MARINE_CAN_BUY_BELT, "orange"),
		list("Medical belt", 0, /obj/item/storage/belt/medical/full, MARINE_CAN_BUY_BELT, "black"),
...
/obj/structure/machinery/cm_vending/clothing/synth
	...
	listed_products = list(
		...
		list("Lifesaver belt", 0, /obj/item/storage/belt/medical/lifesaver/full, MARINE_CAN_BUY_BELT, "black"),
		list("Medical belt", 0, /obj/item/storage/belt/medical/full, MARINE_CAN_BUY_BELT, "black"),
...
/obj/structure/machinery/cm_vending/gear/medic
	...
	listed_products = list(
		...
		list("M41A solid stock", 10, /obj/item/attachable/stock/rifle, null, "black"),
...
/obj/structure/machinery/cm_vending/gear/spec
	...
	listed_products = list(
		...
		list("Underbarrel extinguisher", 6, /obj/item/attachable/attached_gun/extinguisher, null, "black"),
...
/obj/structure/machinery/cm_vending/sorted/attachments/populate_product_list(var/scale)
	listed_products = list(
		...
		list("Underbarrel extinguisher", round(scale * 4.5), /obj/item/attachable/attached_gun/extinguisher, "black"),
		...
		list("M41A solid Stock", round(scale * 4.5), /obj/item/attachable/stock/rifle, "black"),
...
/obj/structure/machinery/cm_vending/sorted/attachments/squad/populate_product_list(var/scale)
	listed_products = list(
		...
		list("Underbarrel extinguisher", round(scale * 1.5), /obj/item/attachable/attached_gun/extinguisher, "black"),
		...
		list("M41A solid Stock", round(scale * 1.5), /obj/item/attachable/stock/rifle, "black"),
