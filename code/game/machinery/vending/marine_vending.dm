...
/obj/machinery/vending/marine/proc/populate_product_list(var/scale)
	...
	products = list(
		...
		/obj/item/ammo_magazine/rifle/l42mk1 = round(scale * 15),
		/obj/item/ammo_magazine/rifle/l42mk1/ap = 0,
...
/obj/machinery/vending/marine/cargo_guns/wo/populate_product_list(var/scale)
	...
	products = list(
		...
		//obj/item/weapon/gun/rifle/m41a/elite = round(0),
		//obj/item/weapon/gun/rifle/lmg = round(0),
		...
		//obj/item/storage/box/nade_box = round(0),
		/obj/item/explosive/grenade/HE = round(scale * 1),
		//obj/item/explosive/grenade/HE/m15 = round(0),
		/obj/item/explosive/grenade/HE = round(scale * 1),
		//obj/item/explosive/grenade/HE/m15 = round(0),
		/obj/item/explosive/grenade/incendiary = round(scale * 1),
		/obj/item/explosive/grenade/smokebomb = round(scale * 1),
		//obj/item/explosive/grenade/phosphorus = round(0),
		/obj/item/storage/box/m94 = round(scale * 10),
		//obj/item/storage/box/zipcuffs = round(0),
...
/obj/machinery/vending/marine/cargo_ammo/populate_product_list(var/scale)
	...
	products = list(
		...
		/obj/item/ammo_magazine/rifle/l42mk1/ap = round(scale * 5),
		/obj/item/ammo_magazine/rifle/l42mk1/extended = round(scale * 8),
		...
		/obj/item/magazine_box/rifle/l42mk1 = round(scale * 30 / 10),
		/obj/item/magazine_box/rifle/l42mk1/ap = round(scale * 10) % 10,
		/obj/item/magazine_box/rifle/l42mk1/ext = round(scale * 8),
