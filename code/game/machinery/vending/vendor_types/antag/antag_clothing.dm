...
GLOBAL_LIST_INIT(cm_vending_clothing_synth_upp, list(
	...
	list("Medical Scrubs, Black", 12, /obj/item/clothing/under/rank/medical/black, null, VENDOR_ITEM_REGULAR),
	...
	list("Surgical Cap, Black", 12, /obj/item/clothing/head/surgery/black, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
