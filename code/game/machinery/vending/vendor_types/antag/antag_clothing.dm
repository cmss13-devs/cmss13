...
GLOBAL_LIST_INIT(cm_vending_clothing_synth_upp, list(
	...
	list("Medical Scrubs, White", 12, /obj/item/clothing/under/rank/medical/white, null, VENDOR_ITEM_REGULAR),
	list("Medical Scrubs, Black", 12, /obj/item/clothing/under/rank/medical/pharmacist, null, VENDOR_ITEM_REGULAR),
	list("Medical Scrubs, White and Orange-Striped", 12, /obj/item/clothing/under/rank/medical/mortician, null, VENDOR_ITEM_REGULAR),
	...
	list("Surgical Cap, Green", 12, /obj/item/clothing/head/surgery/green, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
	list("Surgical Cap, Blue", 12, /obj/item/clothing/head/surgery/blue, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
	list("Surgical Cap, Light Blue", 12, /obj/item/clothing/head/surgery/lightblue, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
	list("Surgical Cap, Purple", 12, /obj/item/clothing/head/surgery/purple, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
	list("Surgical Cap, Olive", 12, /obj/item/clothing/head/surgery/olive, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
	list("Surgical Cap, Grey", 12, /obj/item/clothing/head/surgery/grey, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
	list("Surgical Cap, Brown", 12, /obj/item/clothing/head/surgery/brown, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
	list("Surgical Cap, White", 12, /obj/item/clothing/head/surgery/white, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
	list("Surgical Cap, Black", 12, /obj/item/clothing/head/surgery/mortician, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
	list("Surgical Cap, White and Orange-Striped", 12, /obj/item/clothing/head/surgery/pharmacist, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
	...
	list("Lab Coat, Pharmaceutical Chemist", 12, /obj/item/clothing/suit/storage/labcoat/pharmacist, null, VENDOR_ITEM_REGULAR),
