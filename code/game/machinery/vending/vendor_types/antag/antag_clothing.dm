...
GLOBAL_LIST_INIT(cm_vending_clothing_synth_upp, list(
	...
	list("Medical Scrubs, White and Orange-Striped", 12, /obj/item/clothing/under/rank/medical/morgue, null, VENDOR_ITEM_REGULAR),
	...
	list("Surgical Cap, Black", 12, /obj/item/clothing/head/surgery/morgue, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
