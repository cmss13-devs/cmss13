...
GLOBAL_LIST_INIT(cm_vending_equipment_badblood, list(
		...
		list("Dissolver Armor", 0, list(/obj/item/clothing/suit/armor/yautja/hunter/scalable/badblood/dissolver, /obj/item/clothing/mask/gas/yautja/hunter/scalable/badblood/dissolver, /obj/item/clothing/shoes/yautja/hunter/scalable/badblood/dissolver), YAUTJA_CAN_BUY_ARMOR, VENDOR_ITEM_MANDATORY),
