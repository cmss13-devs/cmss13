...
GLOBAL_LIST_INIT(cm_vending_gear_upp_commanding_officer, list(
		...
		list("NSP-773 Submachinegun", 0, /obj/item/weapon/gun/smg/bizon/upp, MARINE_CAN_BUY_SECONDARY, VENDOR_ITEM_MANDATORY),
		...
		list("NSP-773 Helical Magazine", 20, /obj/item/ammo_magazine/smg/bizon, null, VENDOR_ITEM_REGULAR),

		list("SIDEARM AMMUNITION", 0, null, null, null),
		list("Type 73 Magazine (10x18mm)", 5, /obj/item/ammo_magazine/pistol/t73, null, VENDOR_ITEM_RECOMMENDED),
		list("High Impact Type 73 Magazine (10x18mm)", 15, /obj/item/ammo_magazine/pistol/t73_impact , null, VENDOR_ITEM_REGULAR),
