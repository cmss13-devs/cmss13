...
GLOBAL_LIST_INIT(cm_vending_clothing_corporate_liaison, list(
	...
	list("Pharmaceutical Physician's Lab Coat", 0, /obj/item/clothing/suit/storage/labcoat/pharmacist, CIVILIAN_CAN_BUY_SUIT, VENDOR_ITEM_REGULAR),
	list("High-Cut Lab Coat", 0, /obj/item/clothing/suit/storage/labcoat/short, CIVILIAN_CAN_BUY_SUIT,VENDOR_ITEM_REGULAR),
	list("Low-Cut Lab Coat", 0, /obj/item/clothing/suit/storage/labcoat/long, CIVILIAN_CAN_BUY_SUIT, VENDOR_ITEM_REGULAR),
