...
GLOBAL_LIST_INIT(cm_vending_clothing_field_officer, list(
		...
		list("Laser Designator", 0, /obj/item/device/binoculars/range/designator, null, VENDOR_ITEM_MANDATORY),
		...
		list("Small Radio Telephone Pack", 0, /obj/item/storage/backpack/marine/satchel/rto/small, MARINE_CAN_BUY_BACKPACK, VENDOR_ITEM_MANDATORY),
