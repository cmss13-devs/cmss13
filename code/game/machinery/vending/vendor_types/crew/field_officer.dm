/obj/structure/machinery/cm_vending/clothing/field_officer
	name = "\improper ColMarTech Field Officer Equipment Rack"
	desc = "An automated equipment vendor for Field Officers."
	req_access = list(ACCESS_MARINE_COMMANDER)
	vendor_role = list(JOB_FO)

/obj/structure/machinery/cm_vending/clothing/field_officer/get_listed_products(var/mob/user)
	return GLOB.cm_vending_clothing_field_officer

//------------GEAR---------------

GLOBAL_LIST_INIT(cm_vending_clothing_field_officer, list(
		list("STANDARD EQUIPMENT (TAKE ALL)", 0, null, null, null),
		list("Boots", 0, /obj/item/clothing/shoes/marine/knife, MARINE_CAN_BUY_SHOES, VENDOR_ITEM_MANDATORY),
		list("Armor", 0, /obj/item/clothing/suit/storage/marine/MP/SO, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_MANDATORY),
		...
		list("Small Radio Telephone Pack", 0, /obj/item/storage/backpack/marine/satchel/rto/small, MARINE_CAN_BUY_BACKPACK, VENDOR_ITEM_RECOMMENDED),

		list("OFFICER'S PRIMARY (CHOOSE 1)", 0, null, null, null),
		list("M41A Pulse Rifle", 0, /obj/item/storage/box/guncase/m41aMK1, MARINE_CAN_BUY_ESSENTIALS, VENDOR_ITEM_MANDATORY),
		list("Tactical Shotgun", 0, /obj/item/weapon/gun/shotgun/combat, MARINE_CAN_BUY_ESSENTIALS, VENDOR_ITEM_MANDATORY),
