...
GLOBAL_LIST_INIT(cm_vending_clothing_doctor, list(
		...
		list("Doctor's Surgical Cap", 0, /obj/item/clothing/under/rank/medical/blue, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_RECOMMENDED),
		list("Surgeon's Surgical Cap", 0, /obj/item/clothing/under/rank/medical/green, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_RECOMMENDED),
		list("Pharmaceutical Physician's Surgical Cap", 0, /obj/item/clothing/under/rank/medical/pharmacist, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_RECOMMENDED),
		list("Nurse's Surgical Cap", 0, /obj/item/clothing/under/rank/medical/lightblue, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
		list("Purple Surgical Cap", 0, /obj/item/clothing/under/rank/medical/purple, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
		list("Olive Surgical Cap", 0, /obj/item/clothing/under/rank/medical/olive, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
		list("Grey Surgical Cap", 0, /obj/item/clothing/under/rank/medical/grey, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
		list("Brown Surgical Cap", 0, /obj/item/clothing/under/rank/medical/brown, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
		list("White Surgical Cap", 0, /obj/item/clothing/under/rank/medical/white, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
		list("Morgue Surgical Cap", 0, /obj/item/clothing/under/rank/medical/morgue, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_clothing_nurse, list(
		...
		list("HEADWEAR (CHOOSE 1)", 0, null, null, null),
		list("Nurse's Surgical Cap", 0, /obj/item/clothing/under/rank/medical/lightblue, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_RECOMMENDED),
		list("Doctor's Surgical Cap", 0, /obj/item/clothing/under/rank/medical/blue, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
		list("Surgeon's Surgical Cap", 0, /obj/item/clothing/under/rank/medical/green, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
		list("Pharmaceutical Physician's Surgical Cap", 0, /obj/item/clothing/under/rank/medical/pharmacist, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
		list("Purple Surgical Cap", 0, /obj/item/clothing/under/rank/medical/purple, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
		list("Olive Surgical Cap", 0, /obj/item/clothing/under/rank/medical/olive, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
		list("Grey Surgical Cap", 0, /obj/item/clothing/under/rank/medical/grey, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
		list("Brown Surgical Cap", 0, /obj/item/clothing/under/rank/medical/brown, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_clothing_researcher, list(
		...
		list("Grey Scrubs", 0, /obj/item/clothing/under/rank/medical/grey, MARINE_CAN_BUY_UNIFORM, VENDOR_ITEM_REGULAR),
		list("Brown Scrubs", 0, /obj/item/clothing/under/rank/medical/brown, MARINE_CAN_BUY_UNIFORM, VENDOR_ITEM_REGULAR),
		list("Black Scrubs", 0, /obj/item/clothing/under/rank/medical/morgue, MARINE_CAN_BUY_UNIFORM, VENDOR_ITEM_REGULAR),
		list("White Scrubs", 0, /obj/item/clothing/under/rank/medical/white, MARINE_CAN_BUY_UNIFORM, VENDOR_ITEM_REGULAR),
