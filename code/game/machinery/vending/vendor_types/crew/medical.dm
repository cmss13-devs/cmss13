...
GLOBAL_LIST_INIT(cm_vending_clothing_researcher, list(
		...
		list("Lab coat, white", 0, /obj/item/clothing/suit/storage/labcoat, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_MANDATORY),
		list("High-cut lab coat, white", 0, /obj/item/clothing/suit/storage/labcoat/short, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_RECOMMENDED),
		list("Low-cut lab coat, white", 0, /obj/item/clothing/suit/storage/labcoat/long, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_RECOMMENDED),
		list("Lab coat, tan", 0, /obj/item/clothing/suit/storage/labcoat/researcher, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_REGULAR),
		...
		list("SNEAKERS (CHOOSE 1)", 0, null, null, null),
		list("Sneakers, black", 0, /obj/item/clothing/shoes/black, MARINE_CAN_BUY_SHOES, VENDOR_ITEM_REGULAR),
		list("Sneakers, brown", 0, /obj/item/clothing/shoes/brown, MARINE_CAN_BUY_SHOES, VENDOR_ITEM_REGULAR),
		list("Sneakers, blue", 0, /obj/item/clothing/shoes/blue, MARINE_CAN_BUY_SHOES, VENDOR_ITEM_REGULAR),
		list("Sneakers, green", 0, /obj/item/clothing/shoes/green, MARINE_CAN_BUY_SHOES, VENDOR_ITEM_REGULAR),
		list("Sneakers, yellow", 0, /obj/item/clothing/shoes/yellow, MARINE_CAN_BUY_SHOES, VENDOR_ITEM_REGULAR),
		list("Sneakers, purple", 0, /obj/item/clothing/shoes/purple, MARINE_CAN_BUY_SHOES, VENDOR_ITEM_REGULAR),
		list("Sneakers, red", 0, /obj/item/clothing/shoes/red, MARINE_CAN_BUY_SHOES, VENDOR_ITEM_REGULAR),
		list("Sneakers, rainbow", 0, /obj/item/clothing/shoes/rainbow, MARINE_CAN_BUY_SHOES, VENDOR_ITEM_REGULAR),
