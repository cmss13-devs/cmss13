...
//		list("Nurse's Low-Cut Lab Coat", 0, /obj/item/clothing/suit/storage/labcoat/nurse/long, MARINE_CAN_BUY_MRE,VENDOR_ITEM_RECOMMENDED), naw. Only big boy doctors get the big boy coats.
