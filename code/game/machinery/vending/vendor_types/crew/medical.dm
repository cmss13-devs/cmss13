...
GLOBAL_LIST_INIT(cm_vending_clothing_researcher, list(
		...
		list("Simple Orange Shirt, Black Pants", 0, /obj/item/clothing/under/liaison_suit/orange, MARINE_CAN_BUY_UNIFORM, VENDOR_ITEM_REGULAR),
		...
		list("Blue Sweater, Tan Pants", 0, /obj/item/clothing/under/marine/officer/researcher, MARINE_CAN_BUY_UNIFORM, VENDOR_ITEM_RECOMMENDED),
		...
		list("BUTTON-UP SHIRTS (CHOOSE 1)", 0, null, null, null),
		list("Black Work Shirt, Dark Tan Pants", 0, /obj/item/clothing/under/marine/reporter/black, MARINE_CAN_BUY_UNIFORM, VENDOR_ITEM_REGULAR),
		list("Blue Work Shirt, Dark Tan Pants", 0, /obj/item/clothing/under/colonist/workwear/blue, MARINE_CAN_BUY_UNIFORM, VENDOR_ITEM_REGULAR),
		list("Green Work Shirt, Dark Tan Pants", 0, /obj/item/clothing/under/colonist/workwear/green, MARINE_CAN_BUY_UNIFORM, VENDOR_ITEM_REGULAR),
		list("Grey Work Shirt, Grey Pants", 0, /obj/item/clothing/under/colonist/workwear, MARINE_CAN_BUY_UNIFORM, VENDOR_ITEM_REGULAR),
		list("Khaki Work Shirt, Blue Pants", 0, /obj/item/clothing/under/colonist/workwear/khaki, MARINE_CAN_BUY_UNIFORM, VENDOR_ITEM_REGULAR),
		list("Orange Work Shirt, Black Pants", 0, /obj/item/clothing/under/marine/reporter/orange, MARINE_CAN_BUY_UNIFORM, VENDOR_ITEM_REGULAR),
		list("Pink Work Shirt, Blue Pants", 0, /obj/item/clothing/under/colonist/workwear/pink, MARINE_CAN_BUY_UNIFORM, VENDOR_ITEM_REGULAR),
		list("Red Work Shirt, Light Tan Pants", 0, /obj/item/clothing/under/marine/reporter/red, MARINE_CAN_BUY_UNIFORM, VENDOR_ITEM_REGULAR),
		list("White Work Shirt, Grey Pants", 0, /obj/item/clothing/under/marine/reporter, MARINE_CAN_BUY_UNIFORM, VENDOR_ITEM_REGULAR),

		list("T-SHIRTS (CHOOSE 1)", 0, null, null, null),
		list("Gray T-Shirt, Blue Jeans", 0, /obj/item/clothing/under/tshirt/gray_blu, MARINE_CAN_BUY_UNIFORM, VENDOR_ITEM_REGULAR),
		list("Red T-Shirt, Black Jeans", 0, /obj/item/clothing/under/tshirt/r_bla, MARINE_CAN_BUY_UNIFORM, VENDOR_ITEM_REGULAR),
		list("White T-Shirt, Brown Jeans", 0, /obj/item/clothing/under/tshirt/w_br, MARINE_CAN_BUY_UNIFORM, VENDOR_ITEM_REGULAR),

		list("TIES (Choose 1)", 0, null, null, null),
		list("Black Tie", 0, /obj/item/clothing/accessory/tie/black, MARINE_CAN_BUY_MRE, VENDOR_ITEM_REGULAR),
		list("Blue Tie", 0, /obj/item/clothing/accessory/tie, MARINE_CAN_BUY_MRE, VENDOR_ITEM_REGULAR),
		list("Gold Tie", 0, /obj/item/clothing/accessory/tie/gold, MARINE_CAN_BUY_MRE, VENDOR_ITEM_REGULAR),
		list("Green Tie", 0, /obj/item/clothing/accessory/tie/green, MARINE_CAN_BUY_MRE, VENDOR_ITEM_REGULAR),
		list("Purple Tie", 0, /obj/item/clothing/accessory/tie/purple, MARINE_CAN_BUY_MRE, VENDOR_ITEM_REGULAR),
		list("Red Tie", 0, /obj/item/clothing/accessory/tie/red, MARINE_CAN_BUY_MRE, VENDOR_ITEM_REGULAR),
		list("Special Tie", 0, /obj/item/clothing/accessory/tie/horrible, MARINE_CAN_BUY_MRE, VENDOR_ITEM_REGULAR),

		list("COATS (CHOOSE 1)", 0, null, null, null),
		list("Lab Coat", 0, /obj/item/clothing/suit/storage/labcoat, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_REGULAR),
		list("Lab Coat, Short", 0, /obj/item/clothing/suit/storage/labcoat/short, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_REGULAR),
		list("Lab Coat, Long", 0, /obj/item/clothing/suit/storage/labcoat/long, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_REGULAR),
		list("Brown Lab Coat", 0, /obj/item/clothing/suit/storage/labcoat/researcher, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_REGULAR),
		list("Brown Lab Coat, Short", 0, /obj/item/clothing/suit/storage/labcoat/researcher/short, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_REGULAR),

		list("LACEUPS (CHOOSE 1)", 0, null, null, null),
