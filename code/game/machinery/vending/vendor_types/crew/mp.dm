...
GLOBAL_LIST_INIT(cm_vending_clothing_military_police, list(
		...
		list("M3 Peacekeeping Pattern Armor", 0, /obj/item/clothing/suit/storage/marine/MP, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_MANDATORY),
		list("M3 Ceremonial Pattern Armor", 0, /obj/item/clothing/suit/storage/marine/MP/jacket, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_MANDATORY),
...
GLOBAL_LIST_INIT(cm_vending_clothing_military_police_warden, list(
		...
		list("ARMOR (CHOOSE 1)", 0, null, null, null),
		list("M3 Peacekeeping Armor", 0, /obj/item/clothing/suit/storage/marine/MP, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_MANDATORY),
		list("M3 Ceremonial Armor", 0, /obj/item/clothing/suit/storage/marine/MP/jacket, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_MANDATORY),
