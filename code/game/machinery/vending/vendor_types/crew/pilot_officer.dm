...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/pilot_officer
	...
	listed_products = list(
		...
		list("VP78-A1 Magazine (9mm)", 16, /obj/item/ammo_magazine/pistol/vp78, VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_clothing_pilot_officer, list(
		...
		list("VP78-A1 Pistol", 0, /obj/item/weapon/gun/pistol/vp78, MARINE_CAN_BUY_ATTACHMENT, VENDOR_ITEM_REGULAR),
		...
		list("M276 Combat Sidearm Rig", 0, /obj/item/storage/belt/gun/combat_rig, MARINE_CAN_BUY_SECONDARY, VENDOR_ITEM_REGULAR),
