...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/pilot_officer
	...
	listed_products = list(
		...
		list("VP-78 Pistol", 2, /obj/item/weapon/gun/pistol/vp78, VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_clothing_pilot_officer, list(
		...
		list("Headset", 0, /obj/item/device/radio/headset/almayer/po, MARINE_CAN_BUY_EAR, VENDOR_ITEM_MANDATORY),
		...
		list("M70 Flak Jacket", 0, /obj/item/clothing/suit/armor/vest/pilot, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_RECOMMENDED),
		...
		list("M30 Tactical Helmet", 0, /obj/item/clothing/head/helmet/marine/pilot, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_RECOMMENDED),
		list("Officer Cap", 0, /obj/item/clothing/head/cmcap/bridge, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
		list("Beret, Green", 0, /obj/item/clothing/head/beret/cm, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
		...
		list("HOLSTER (CHOOSE 1)", 0, null, null, null),
		list("M276 M39 Holster Rig", 0, /obj/item/storage/belt/gun/m39, MARINE_CAN_BUY_ATTACHMENT, VENDOR_ITEM_REGULAR),
		list("M276 M44 Holster Rig", 0, /obj/item/storage/belt/gun/m44, MARINE_CAN_BUY_ATTACHMENT, VENDOR_ITEM_REGULAR),
