...
GLOBAL_LIST_INIT(cm_vending_gear_sea, list(
		...
		list("ABR-40 Ceremonial Rifle", 0, /obj/item/weapon/gun/rifle/l42a/abr40/drill, MARINE_CAN_BUY_ESSENTIALS, VENDOR_ITEM_RECOMMENDED),
		...
		list("ABR-40 Magazine", 2, /obj/item/ammo_magazine/rifle/l42a/half, null, VENDOR_ITEM_REGULAR),
		list("L42A Magazine", 3, /obj/item/ammo_magazine/rifle/l42a, null, VENDOR_ITEM_REGULAR),

		list("BLANK AMMUNITION", 0, null, null, null),
		list("ABR-40 Blank Magazine", 1, /obj/item/ammo_magazine/rifle/l42a/half/blank, null, VENDOR_ITEM_REGULAR),
		list("M41A MK2 Blank Magazine", 1, /obj/item/ammo_magazine/rifle/blank, null, VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_clothing_sea, list(
		...
		list("Dress shoes", 0, /obj/item/clothing/shoes/dress, MARINE_CAN_BUY_SHOES, VENDOR_ITEM_MANDATORY),
