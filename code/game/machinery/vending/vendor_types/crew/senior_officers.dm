/obj/structure/machinery/cm_vending/clothing/senior_officer
	...
	vendor_role = list(JOB_SHIP_MASTER_AT_ARMS,JOB_CMO,JOB_XO,JOB_CHIEF_ENGINEER,JOB_CHIEF_REQUISITION)
...
GLOBAL_LIST_INIT(cm_vending_clothing_chief_engineer, list(
		...
		list("Officer M10 Helmet", 0, /obj/item/clothing/head/helmet/marine/ship_marine/SO, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_MANDATORY),
		list("Marine Combat Boots", 0, /obj/item/clothing/shoes/marine/knife, MARINE_CAN_BUY_SHOES, VENDOR_ITEM_MANDATORY),
