...
GLOBAL_LIST_INIT(cm_vending_clothing_military_police_chief, list(
		...
		list("M3 Peacekeeping Pattern Armor", 0, /obj/item/clothing/suit/storage/marine/MP, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_RECOMMENDED),
		list("M3 Ceremonial Pattern Armor", 0, /obj/item/clothing/suit/storage/marine/MP/jacket, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_clothing_chief_engineer, list(
		...
		list("COMBAT EQUIPMENT (TAKE ALL)", 0, null, null, null),
		list("Officer M3 Armor", 0, /obj/item/clothing/suit/storage/marine, MARINE_CAN_BUY_COMBAT_ARMOR, VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_clothing_req_officer, list(
		...
		list("COMBAT EQUIPMENT (TAKE ALL)", 0, null, null, null),
		list("Officer M3 Armor", 0, /obj/item/clothing/suit/storage/marine, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_MANDATORY),
...
GLOBAL_LIST_INIT(cm_vending_clothing_xo, list(
		...
		list("COMBAT EQUIPMENT (TAKE ALL)", 0, null, null, null),
		list("M3 Body Armor", 0, /obj/item/clothing/suit/storage/marine, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_MANDATORY),
		list("Officer M10 Helmet", 0, /obj/item/clothing/head/helmet/marine/MP/SO, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_MANDATORY),
		list("Marine Combat Boots", 0, /obj/item/clothing/shoes/marine/knife, MARINE_CAN_BUY_SHOES, VENDOR_ITEM_MANDATORY),
