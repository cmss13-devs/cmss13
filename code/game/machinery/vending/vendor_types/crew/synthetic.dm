...
GLOBAL_LIST_INIT(cm_vending_clothing_synth, list(
		...
		list("Smartpack, Dark Blue", 0, /obj/item/storage/backpack/marine/smartpack/darkblue, MARINE_CAN_BUY_BACKPACK, VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_clothing_synth_snowflake, list(
	...
	list("Dispatch Shirt and Khakis", 12, /obj/item/clothing/under/rank/dispatch, null, VENDOR_ITEM_REGULAR),
