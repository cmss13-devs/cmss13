...
/obj/structure/machinery/cm_vending/sorted/boozeomat/get_listed_products(mob/user)
	return GLOB.cm_vending_boozemat
...
/obj/structure/machinery/cm_vending/sorted/boozeomat/chess/get_listed_products(mob/user)
	return GLOB.cm_vending_boozemat_chess

GLOBAL_LIST_INIT(cm_vending_marine_food, list(
...
GLOBAL_LIST_INIT(cm_vending_marine_food_flasks, list(
...
GLOBAL_LIST_INIT(cm_vending_marine_food_christmas, list(
...
GLOBAL_LIST_INIT(cm_vending_boozemat, list(
...
GLOBAL_LIST_INIT(cm_vending_boozemat_chess, list(
