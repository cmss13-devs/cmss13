...
GLOBAL_LIST_INIT(cm_vending_clothing_intelligence_officer, list(
		...
		list("Expedition Leather Satchel (Brown)", 0, /obj/item/storage/backpack/marine/satchel/intel/leathersatchel, MARINE_CAN_BUY_BACKPACK, VENDOR_ITEM_RECOMMENDED),
		list("Expedition Leather Satchel (Black)", 0, /obj/item/storage/backpack/marine/satchel/intel/leathersatchelblack, MARINE_CAN_BUY_BACKPACK, VENDOR_ITEM_RECOMMENDED),
