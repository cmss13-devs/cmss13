...
/obj/structure/machinery/cm_vending/clothing/military_police_chief
	name = "\improper ColMarTech Military Police Chief Equipment Rack"
	desc = "An automated rack hooked up to a colossal storage of Military Police standard-issue equipment."
	req_access = list(ACCESS_MARINE_BRIG)
	vendor_role = list(JOB_CHIEF_POLICE)

/obj/structure/machinery/cm_vending/clothing/military_police_chief/Initialize(mapload, ...)
	. = ..()
