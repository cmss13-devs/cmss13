...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/upp_cargo_guns/populate_product_list(scale)
	listed_products = list(
		...
		list("Type 42 Pattern Shotgun Shell Loading Rig", floor(scale * 10), /obj/item/storage/belt/shotgun/upp, VENDOR_ITEM_REGULAR),
		...
		list("Bayonet Pouch", floor(scale * 2), /obj/item/storage/pouch/bayonet/upp, VENDOR_ITEM_REGULAR),
