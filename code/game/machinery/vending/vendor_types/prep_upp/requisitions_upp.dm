...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/upp_cargo_guns/populate_product_list(scale)
	listed_products = list(
		...
		list("Sidearm Holster", floor(scale * 5), /obj/item/storage/pouch/pistol, VENDOR_ITEM_REGULAR),
		list("Sidearm Carrier", floor(scale * 5), /obj/item/storage/pouch/pistol/mag_carrier, VENDOR_ITEM_REGULAR),
