...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/upp_squad_prep/populate_product_list(scale)
	listed_products = list(
		...
		list("Helmet Netting", floor(scale * 10), /obj/item/prop/helmetgarb/netting, VENDOR_ITEM_REGULAR),
		list("Helmet Rain Cover", floor(scale * 10), /obj/item/prop/helmetgarb/raincover, VENDOR_ITEM_REGULAR),
