...
/obj/structure/machinery/cm_vending/sorted/attachments/populate_product_list(var/scale)
	listed_products = list(
		...
		list("XM-VESG-1 Flamer Nozzle", round(scale * 2), /obj/item/attachable/attached_gun/flamer_nozzle, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/attachments/squad/populate_product_list(var/scale)
	listed_products = list(
		...
		list("XM-VESG-1 Flamer Nozzle", round(scale * 0.5), /obj/item/attachable/attached_gun/flamer_nozzle, VENDOR_ITEM_REGULAR),
