...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/populate_product_list(scale)
	listed_products = list(
		...
		list("M276-B Pattern Submachine Gun Holster Rig", floor(scale * 5), /obj/item/storage/large_holster/smg, VENDOR_ITEM_REGULAR),
		list("M276-C Pattern M39 Belt Rig", floor(scale * 3), /obj/item/storage/belt/gun/m39, VENDOR_ITEM_REGULAR),
