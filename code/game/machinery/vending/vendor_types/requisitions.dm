...
/obj/structure/machinery/cm_vending/sorted/cargo_ammo/populate_product_list(scale)
	listed_products = list(
		...
		list("M41AE2 Holo Target Rounds (10x24mm)", round(scale * 3), /obj/item/ammo_magazine/rifle/lmg/holo_target, VENDOR_ITEM_REGULAR),
		...
		list("M41AE2 Box Magazine (10x24mm)", round(scale * 7), /obj/item/ammo_magazine/rifle/lmg, VENDOR_ITEM_REGULAR),
