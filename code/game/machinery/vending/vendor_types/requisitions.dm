...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/populate_product_list(scale)
	listed_products = list(
		...
		list("Technician Welder Chestrig", 5, /obj/item/storage/backpack/marine/engineerpack/welder_chestrig, MARINE_CAN_BUY_BACKPACK, VENDOR_ITEM_MANDATORY),
...
/obj/structure/machinery/cm_vending/sorted/uniform_supply
	...
	listed_products = list(
		...
		list("M10 Pattern Welding Helmet", 20, /obj/item/clothing/head/helmet/marine/welding, VENDOR_ITEM_REGULAR),
		...
		list("M10 Pattern White Corpsman Helmet", 20, /obj/item/clothing/head/helmet/marine/medic/white, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
