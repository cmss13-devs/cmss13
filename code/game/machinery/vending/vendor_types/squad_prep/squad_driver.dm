...
GLOBAL_LIST_INIT(cm_vending_gear_driver, list(
		list("AFV Operator SET (MANDATORY)", 0, null, null, null),
...
/obj/structure/machinery/cm_vending/gear/driver
	name = "\improper ColMarTech Squad AFV Operator Gear Rack"
	desc = "An automated gear rack for AFV Operators."
	icon_state = "eng_gear"
	vendor_role = list(JOB_SQUAD_DRIVER)
	req_access = list(ACCESS_MARINE_DRIVER_PREP)

/obj/structure/machinery/cm_vending/gear/driver/get_listed_products(mob/user)
	return GLOB.cm_vending_gear_driver

//------------CLOTHING RACK---------------

GLOBAL_LIST_INIT(cm_vending_clothing_driver, list(
		...
		list("Uniform", 0, /obj/item/clothing/under/marine/tanker, MARINE_CAN_BUY_UNIFORM, VENDOR_ITEM_MANDATORY),
...
/obj/structure/machinery/cm_vending/clothing/driver
	name = "\improper ColMarTech AFV Operator Equipment Rack"
	desc = "An automated rack hooked up to a colossal storage of AFV Operator standard-issue equipment."
	req_access = list(ACCESS_MARINE_DRIVER_PREP)
	vendor_role = list(JOB_SQUAD_DRIVER)

/obj/structure/machinery/cm_vending/clothing/driver/get_listed_products(mob/user)
	return GLOB.cm_vending_clothing_driver

/obj/structure/machinery/cm_vending/clothing/driver/alpha
	squad_tag = SQUAD_MARINE_1
	req_access = list(ACCESS_MARINE_DRIVER_PREP, ACCESS_MARINE_ALPHA)
	gloves_type = /obj/item/clothing/gloves/marine/insulated
	headset_type = /obj/item/device/radio/headset/almayer/marine/alpha/driver

/obj/structure/machinery/cm_vending/clothing/driver/bravo
	squad_tag = SQUAD_MARINE_2
	req_access = list(ACCESS_MARINE_DRIVER_PREP, ACCESS_MARINE_BRAVO)
	gloves_type = /obj/item/clothing/gloves/marine/insulated
	headset_type = /obj/item/device/radio/headset/almayer/marine/bravo/driver

/obj/structure/machinery/cm_vending/clothing/driver/charlie
	squad_tag = SQUAD_MARINE_3
	req_access = list(ACCESS_MARINE_DRIVER_PREP, ACCESS_MARINE_CHARLIE)
	gloves_type = /obj/item/clothing/gloves/marine/insulated
	headset_type = /obj/item/device/radio/headset/almayer/marine/charlie/driver

/obj/structure/machinery/cm_vending/clothing/driver/delta
	squad_tag = SQUAD_MARINE_4
	req_access = list(ACCESS_MARINE_DRIVER_PREP, ACCESS_MARINE_DELTA)
	gloves_type = /obj/item/clothing/gloves/marine/insulated
	headset_type = /obj/item/device/radio/headset/almayer/marine/delta/driver