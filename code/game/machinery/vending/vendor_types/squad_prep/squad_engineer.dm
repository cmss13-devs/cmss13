...
GLOBAL_LIST_INIT(cm_vending_gear_engi, list(
		...
		list("Welding Visor", 0, /obj/item/device/helmet_visor/welding_visor, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_clothing_engi, list(
		...
		list("Welding Visor", 0, /obj/item/device/helmet_visor/welding_visor, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_MANDATORY),
