...
GLOBAL_LIST_INIT(cm_vending_gear_engi, list(
		...
		list("B12 Pattern Armor", 24, /obj/item/clothing/suit/storage/marine/leader, null, VENDOR_ITEM_REGULAR),
		list("B12 Pattern Padless Marine Armor", 24, /obj/item/clothing/suit/storage/marine/leader/padless, null, VENDOR_ITEM_REGULAR),
