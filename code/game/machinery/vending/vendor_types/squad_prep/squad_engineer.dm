...
GLOBAL_LIST_INIT(cm_vending_gear_engi, list(
		...
		list("BRUTE breacher kit",0, /obj/item/storage/belt/gun/brutepack/full, MARINE_CAN_BUY_ATTACHMENT, VENDOR_ITEM_MANDATORY),
		...
		list("BRUTE anti-structure rocket", 8, /obj/item/ammo_magazine/rocket/brute, null, VENDOR_ITEM_RECOMMENDED),
