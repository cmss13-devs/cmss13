...
GLOBAL_LIST_INIT(cm_vending_gear_leader, list(
		...
		list("M56D Drum Magazine", 12, /obj/item/ammo_magazine/m56d, null, VENDOR_ITEM_REGULAR),
		list("M2C Box Magazine", 12, /obj/item/ammo_magazine/m2c, null, VENDOR_ITEM_REGULAR),
