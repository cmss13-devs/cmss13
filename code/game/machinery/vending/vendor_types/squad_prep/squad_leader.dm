...
GLOBAL_LIST_INIT(cm_vending_gear_leader, list(
		...
		list("M10 AP magazine (10x20mm)", 5, /obj/item/ammo_magazine/pistol/m10/ap , null, VENDOR_ITEM_REGULAR),
		list("M10 AP extended magazine (10x20mm)", 10, /obj/item/ammo_magazine/pistol/m10/ap/extended , null, VENDOR_ITEM_REGULAR),
		list("M10 AP drum magazine (10x20mm)", 15, /obj/item/ammo_magazine/pistol/m10/ap/drum , null, VENDOR_ITEM_REGULAR),
		...
		list("M10 HV extended magazine (10x20mm)", 5, /obj/item/ammo_magazine/pistol/m10/extended , null, VENDOR_ITEM_REGULAR),
		list("M10 HV drum magazine (10x20mm)", 10, /obj/item/ammo_magazine/pistol/m10/drum , null, VENDOR_ITEM_REGULAR),
