...
GLOBAL_LIST_INIT(cm_vending_gear_leader, list(
		...
		list("M4 Pattern Armor", 16, /obj/item/clothing/suit/storage/marine/medium/rto/patched, null, VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_clothing_leader, list(
		...
		list("B12 Pattern Armor", 0, /obj/item/clothing/suit/storage/marine/medium/leader/patched, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_MANDATORY),
