...
GLOBAL_LIST_INIT(cm_vending_gear_leader, list(
		...
		list("M41A MK1 Magazine (10x24mm)", 3, /obj/item/ammo_magazine/rifle/m41aMK1, null, VENDOR_ITEM_REGULAR),
		list("M41A MK1 AP Magazine (10x24mm)", 6, /obj/item/ammo_magazine/rifle/m41aMK1/ap, null, VENDOR_ITEM_REGULAR),
