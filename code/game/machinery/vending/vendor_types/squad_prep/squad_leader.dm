...
GLOBAL_LIST_INIT(cm_vending_clothing_leader, list(
		...
		list("B12 Armor", 0, /obj/item/clothing/suit/storage/marine/leader, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_MANDATORY),
		list("B12 Armor Padless", 0, /obj/item/clothing/suit/storage/marine/leader/padless, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_MANDATORY),
