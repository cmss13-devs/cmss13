...
GLOBAL_LIST_INIT(cm_vending_clothing_medic, list(
		...
		list("POUCHES INJECTORS (CHOOSE 2 TOTAL)", 0, null, null, null),
		...
		list("POUCHES STORAGE (CHOOSE 2 TOTAL)", 0, null, null, null),
		...
		list("Medical Pouch (Small)", 0, /obj/item/storage/pouch/medical, MARINE_CAN_BUY_POUCH, VENDOR_ITEM_REGULAR),
