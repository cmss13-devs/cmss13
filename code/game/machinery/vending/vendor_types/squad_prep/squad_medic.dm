...
GLOBAL_LIST_INIT(cm_vending_clothing_medic, list(
		...
		list("Medical Helmet Visor", 0, /obj/item/device/helmet_visor/medical/advanced, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
		list("Medical HUDglasses", 0, /obj/item/clothing/glasses/hud/health, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_REGULAR),
