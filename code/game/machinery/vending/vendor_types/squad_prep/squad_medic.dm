...
GLOBAL_LIST_INIT(cm_vending_gear_medic, list(
		...
		list("MS-11 Smart Refill Tank", 5, /obj/item/reagent_container/glass/minitank, null, VENDOR_ITEM_REGULAR),
		list("FixOVein", 5, /obj/item/tool/surgery/FixOVein, null, VENDOR_ITEM_RECOMMENDED),
		list("Roller Bed", 1, /obj/item/roller, null, VENDOR_ITEM_REGULAR),
		list("Health Analyzer", 1, /obj/item/device/healthanalyzer, null, VENDOR_ITEM_REGULAR),
		...
		list("Pill Bottle (Bicaridine)", 1, /obj/item/storage/pill_bottle/bicaridine, null, VENDOR_ITEM_REGULAR),
		list("Pill Bottle (Dexalin)", 1, /obj/item/storage/pill_bottle/dexalin, null, VENDOR_ITEM_REGULAR),
		list("Pill Bottle (Dylovene)", 1, /obj/item/storage/pill_bottle/antitox, null, VENDOR_ITEM_REGULAR),
		list("Pill Bottle (Inaprovaline)", 1, /obj/item/storage/pill_bottle/inaprovaline, null, VENDOR_ITEM_REGULAR),
		list("Pill Bottle (Kelotane)", 1, /obj/item/storage/pill_bottle/kelotane, null, VENDOR_ITEM_REGULAR),
		list("Pill Bottle (Oxycodone)", 1, /obj/item/storage/pill_bottle/oxycodone, null, VENDOR_ITEM_REGULAR),
		list("Pill Bottle (Peridaxon)", 1, /obj/item/storage/pill_bottle/peridaxon, null, VENDOR_ITEM_REGULAR),
		list("Pill Bottle (Tramadol)", 1, /obj/item/storage/pill_bottle/tramadol, null, VENDOR_ITEM_REGULAR),
		...
		list("Autoinjector (Epinephrine)", 1, /obj/item/reagent_container/hypospray/autoinjector/adrenaline, null, VENDOR_ITEM_REGULAR),
		...
		list("USCM Radio Telephone Pack", 10, /obj/item/storage/backpack/marine/satchel/rto, null, VENDOR_ITEM_REGULAR),
