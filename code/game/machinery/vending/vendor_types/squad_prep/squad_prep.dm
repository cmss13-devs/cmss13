...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/populate_product_list(scale)
	listed_products = list(
		...
		list("M276-B Pattern Submachine Gun Holster Rig", floor(scale * 15), /obj/item/storage/large_holster/smg, VENDOR_ITEM_REGULAR),
		list("M276-C Pattern M39 Belt Rig", floor(scale * 10), /obj/item/storage/belt/gun/m39, VENDOR_ITEM_REGULAR),
