...
//------------SQUAD PREP WEAPON RACKS TRAINiNG RANGE---------------
...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/populate_product_list(scale)
	listed_products = list(
		...
		list("Marine Combat Boots", round(scale * 10), /obj/item/clothing/shoes/marine, VENDOR_ITEM_REGULAR),
		list("USCM Uniform", round(scale * 10), /obj/item/clothing/under/marine, VENDOR_ITEM_REGULAR),
		list("Marine Combat Gloves", round(scale * 10), /obj/item/clothing/gloves/marine, VENDOR_ITEM_REGULAR),
		list("Marine Black Combat Gloves", round(scale * 2), /obj/item/clothing/gloves/marine/black, VENDOR_ITEM_REGULAR),
		list("Marine Radio Headset", round(scale * 10), /obj/item/device/radio/headset/almayer, VENDOR_ITEM_REGULAR),
		list("M10 Pattern Marine Helmet", round(scale * 10), /obj/item/clothing/head/helmet/marine, VENDOR_ITEM_REGULAR),

		list("ARMOR", -1, null, null),
		list("M3 Pattern Carrier Marine Armor", round(scale * 2), /obj/item/clothing/suit/storage/marine/carrier, VENDOR_ITEM_REGULAR),
		list("M3 Pattern Padded Marine Armor", round(scale * 2), /obj/item/clothing/suit/storage/marine/padded, VENDOR_ITEM_REGULAR),
		list("M3 Pattern Padless Marine Armor", round(scale * 2), /obj/item/clothing/suit/storage/marine/padless, VENDOR_ITEM_REGULAR),
		list("M3 Pattern Ridged Marine Armor", round(scale * 2), /obj/item/clothing/suit/storage/marine/padless_lines, VENDOR_ITEM_REGULAR),
		list("M3 Pattern Skull Marine Armor", round(scale * 2), /obj/item/clothing/suit/storage/marine/skull, VENDOR_ITEM_REGULAR),
		list("M3 Pattern Smooth Marine Armor", round(scale * 2), /obj/item/clothing/suit/storage/marine/smooth, VENDOR_ITEM_REGULAR),
		...
		list("USCM Satchel", round(scale * 10), /obj/item/storage/backpack/marine/satchel, VENDOR_ITEM_REGULAR),
		list("USCM Technical Satchel", round(scale * 2), /obj/item/storage/backpack/marine/satchel/tech, VENDOR_ITEM_REGULAR),
		list("Lightweight IMP Backpack", round(scale * 10), /obj/item/storage/backpack/marine, VENDOR_ITEM_REGULAR),

		list("BELTS", -1, null, null),
		list("M276 Pattern Ammo Load Rig", round(scale * 10), /obj/item/storage/belt/marine, VENDOR_ITEM_REGULAR),
		list("M276 Pattern General Pistol Holster Rig", round(scale * 10), /obj/item/storage/belt/gun/m4a3, VENDOR_ITEM_REGULAR),
		list("M276 Knife Rig (Full)", round(scale * 2), /obj/item/storage/belt/knifepouch, VENDOR_ITEM_REGULAR),
		list("M276 Pattern M39 Holster Rig", round(scale * 2), /obj/item/storage/large_holster/m39, VENDOR_ITEM_REGULAR),
		...
		list("M276 G8-A General Utility Pouch", round(scale * 2), /obj/item/storage/backpack/general_belt, VENDOR_ITEM_REGULAR),
		...
		list("Heat Absorbent Coif", round(scale * 2), /obj/item/clothing/mask/rebreather/scarf, VENDOR_ITEM_REGULAR),
		list("M5 Integrated Gas Mask", round(scale * 2), /obj/item/prop/helmetgarb/helmet_gasmask, VENDOR_ITEM_REGULAR),

		list("MISCELLANEOUS", -1, null, null, null),
		list("M10 Helmet Netting", round(scale * 2), /obj/item/prop/helmetgarb/netting, VENDOR_ITEM_REGULAR),
		list("M10 Helmet Rain Cover", round(scale * 2), /obj/item/prop/helmetgarb/raincover, VENDOR_ITEM_REGULAR),
		list("Firearm Lubricant", round(scale * 2), /obj/item/prop/helmetgarb/gunoil, VENDOR_ITEM_REGULAR),
		list("USCM Flair", round(scale * 2), /obj/item/prop/helmetgarb/flair_uscm, VENDOR_ITEM_REGULAR),
		)
...
//--------------SQUAD SPECIFIC VERSION OF ATTACHEMENTS VENDOR--------------
...
//--------------SQUAD SPECIFIC VERSION OF ARMEMENTS VENDOR--------------
...
*/
		...
		list("Marine Radio Headset", round(scale * 10), /obj/item/device/radio/headset/almayer, VENDOR_ITEM_REGULAR),
		list("Alpha Squad Radio Encryption Key", round(scale * 5), /obj/item/device/encryptionkey/alpha, VENDOR_ITEM_REGULAR),
		list("Bravo Squad Radio Encryption Key", round(scale * 5), /obj/item/device/encryptionkey/bravo, VENDOR_ITEM_REGULAR),
		list("Charlie Squad Radio Encryption Key", round(scale * 5), /obj/item/device/encryptionkey/charlie, VENDOR_ITEM_REGULAR),
		list("Delta Squad Radio Encryption Key", round(scale * 5), /obj/item/device/encryptionkey/delta, VENDOR_ITEM_REGULAR),
...
//--------------SQUAD SPECIFIC VERSION OF MUNITION VENDOR--------------
