...
GLOBAL_LIST_INIT(cm_vending_clothing_marine, list(
		...
		list("M39 Submachine Gun guncase", 0, /obj/item/storage/box/guncase/m39, MARINE_CAN_BUY_PRIMARY, VENDOR_ITEM_REGULAR),
		list("M41A Pulse Rifle MK2 guncase", 0, /obj/item/storage/box/guncase/m41a, MARINE_CAN_BUY_PRIMARY, VENDOR_ITEM_RECOMMENDED),
