...
GLOBAL_LIST_INIT(cm_vending_clothing_smartgun, list(
		...
		list("M802 Smartgunner Sidearm Belt", 0, /obj/item/storage/belt/gun/smartgunner/uscm/full, MARINE_CAN_BUY_BELT, VENDOR_ITEM_MANDATORY),
		list("M280 Smartgunner Drum Belt", 0, /obj/item/storage/belt/marine/smartgunner/uscm/full, MARINE_CAN_BUY_BELT, VENDOR_ITEM_MANDATORY),
