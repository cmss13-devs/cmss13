...
GLOBAL_LIST_INIT(cm_vending_gear_smartgun, list(
		...
		list("M56 Standard Combat Harness", 0, /obj/item/clothing/suit/storage/marine/smartgunner/patched, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_MANDATORY),
		list("M56 Reinforced Combat Harness", 0, /obj/item/clothing/suit/storage/marine/smartgunner/reinforced/patched, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_MANDATORY),
