...
GLOBAL_LIST_INIT(cm_vending_gear_spec, list(
		...
		list("Phalanx Shield Set", 0, /obj/item/storage/box/spec/phalanx, MARINE_CAN_BUY_ESSENTIALS, VENDOR_ITEM_RECOMMENDED),
		...
		list("EXTRA PHALANX BATTERIES", 0, null, null, null),
