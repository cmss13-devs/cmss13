...
GLOBAL_LIST_INIT(cm_vending_gear_tl, list(
		...
		list("M3 B12 Pattern Marine Armor", 30, /obj/item/clothing/suit/storage/marine/medium/leader/patched, null, VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_clothing_tl, list(
		...
		list("M4 Pattern Armor", 0, /obj/item/clothing/suit/storage/marine/medium/rto/patched, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_MANDATORY),
