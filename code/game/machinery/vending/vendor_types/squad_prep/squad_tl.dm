...
GLOBAL_LIST_INIT(cm_vending_clothing_tl, list(
		...
		list("Standard Marine Apparel", 0, list(/obj/item/clothing/under/marine, /obj/item/clothing/shoes/marine/knife, /obj/item/device/radio/headset/almayer/marine), MARINE_CAN_BUY_UNIFORM, VENDOR_ITEM_MANDATORY),
		...
		list("USCM Radio Telephone Pack", 0, /obj/item/storage/backpack/marine/satchel/rto/unsc, MARINE_CAN_BUY_BACKPACK, VENDOR_ITEM_MANDATORY),
