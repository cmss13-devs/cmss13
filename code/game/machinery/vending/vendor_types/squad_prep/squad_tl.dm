...
/obj/structure/machinery/cm_vending/gear/tl
	name = "ColMarTech Team Leader Gear Rack"
	desc = "An automated gear rack for team leaders."
...
GLOBAL_LIST_INIT(cm_vending_clothing_tl, list(
		...
		list("Essential Team Leader Utilities", 0, /obj/effect/essentials_set/tl, MARINE_CAN_BUY_ESSENTIALS, VENDOR_ITEM_MANDATORY),
...
/obj/structure/machinery/cm_vending/clothing/tl
	name = "ColMarTech Team Leader Equipment Rack"
	desc = "An automated rack hooked up to a colossal storage of team leader standard-issue equipment."
	req_access = list(ACCESS_MARINE_TL_PREP)
	vendor_role = list(JOB_SQUAD_TEAM_LEADER)
