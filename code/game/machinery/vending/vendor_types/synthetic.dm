...
/obj/structure/machinery/cm_vending/clothing/synth/snowflake
	...
	listed_products = list(
		...
		list("Bomber Jacket", 12, /obj/item/clothing/suit/bomber/open, null, VENDOR_ITEM_REGULAR),
		...
		list("Coveralls", 12, /obj/item/clothing/suit/apron/overalls, null, VENDOR_ITEM_REGULAR),
		...
		list("Overalls", 12, /obj/item/clothing/suit/apron/overalls, null, VENDOR_ITEM_REGULAR),
		...
		list("Waistcoat", 12, /obj/item/clothing/suit/wcoat, null, VENDOR_ITEM_REGULAR),
