...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/wo/populate_product_list(scale)
	listed_products = list(
		...
		list("Black Drop Pouch", 1, /obj/item/clothing/accessory/storage/droppouch/black, MARINE_CAN_BUY_ACCESSORY, VENDOR_ITEM_REGULAR),
		...
		list("Radio Telephone Backpack", 0.5, /obj/item/storage/backpack/marine/satchel/rto, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/cargo_ammo/cargo/wo/populate_product_list(scale)
	...
	listed_products += list(
		...
		list("M74 AGM-F Grenade Pack (x6)", floor(scale * 1.5), /obj/effect/essentials_set/agm_6_pack, VENDOR_ITEM_REGULAR),
