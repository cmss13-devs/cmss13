...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/wo/populate_product_list(scale)
	listed_products = list(
		...
		list("M276 pattern Submachine gun holster rig", floor(scale * 10), /obj/item/storage/large_holster/smg, VENDOR_ITEM_REGULAR),
		list("M276 pattern Submachine gun holster rig And Pouch", floor(scale * 5), /obj/item/storage/belt/gun/m39, VENDOR_ITEM_REGULAR),
