...
/obj/structure/machinery/mech_bay_recharge_port/New()
	..()
	pr_recharger = new /datum/global_iterator/mech_bay_recharger(null,0)
	return

/obj/structure/machinery/mech_bay_recharge_port/proc/start_charge(var/obj/mecha/recharging_mecha)
...
/obj/structure/machinery/mech_bay_recharge_port/proc/stop_charge()
	if(recharge_console && !recharge_console.stat)
		recharge_console.icon_state = initial(recharge_console.icon_state)
	pr_recharger.stop()
	return

/obj/structure/machinery/mech_bay_recharge_port/proc/active()
	if(pr_recharger.active())
		return 1
	else
		return 0

/obj/structure/machinery/mech_bay_recharge_port/power_change()
	if(powered())
		stat &= ~NOPOWER
	else
		spawn(rand(0, 15))
...
/obj/structure/machinery/mech_bay_recharge_port/proc/set_voltage(new_voltage)
...
/datum/global_iterator/mech_bay_recharger/process(var/obj/structure/machinery/mech_bay_recharge_port/port, var/obj/mecha/mecha)
	if(!port)
		return 0
...
/obj/structure/machinery/computer/mech_bay_power_console
...
/obj/structure/machinery/computer/mech_bay_power_console/proc/mecha_in(var/obj/mecha/mecha)
	if(stat&(NOPOWER|BROKEN))
...
/obj/structure/machinery/computer/mech_bay_power_console/proc/mecha_out()
	if(recharge_port)
		recharge_port.stop_charge()
	return


/obj/structure/machinery/computer/mech_bay_power_console/power_change()
	if(stat & BROKEN)
...
/obj/structure/machinery/computer/mech_bay_power_console/set_broken()
	icon_state = initial(icon_state)+"_broken"
	stat |= BROKEN
	if(recharge_port)
		recharge_port.stop_charge()

/obj/structure/machinery/computer/mech_bay_power_console/attack_hand(mob/user as mob)
	if(..())
		return
...
/*
/obj/structure/machinery/computer/mech_bay_power_console/Topic(href, href_list)
