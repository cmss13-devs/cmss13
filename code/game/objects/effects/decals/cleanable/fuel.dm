...
/obj/effect/decal/cleanable/liquid_fuel/flamethrower_fuel/Spread()
	...
	for(var/d in list(turn(dir,90),turn(dir,-90), dir))
		var/turf/current_obj = get_step(current_turf,d)
		if(locate(/obj/effect/decal/cleanable/liquid_fuel/flamethrower_fuel) in current_obj)
			continue
		if(current_obj.BlockedPassDirs(src, d) || current_turf.BlockedExitDirs(src, d))
			continue
		new/obj/effect/decal/cleanable/liquid_fuel/flamethrower_fuel(current_obj, amount * 0.25)
