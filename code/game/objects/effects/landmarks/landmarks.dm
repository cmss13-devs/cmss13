...
/obj/effect/landmark/yautja_teleport/Initialize(mapload, ...)
	...
	if(is_mainship_level(z))
		...
		GLOB.mainship_yautja_desc[current_turf.loc.name + current_turf.loc_to_string()] = src
	else
		GLOB.yautja_teleports += src
		GLOB.yautja_teleport_descs[current_turf.loc.name + current_turf.loc_to_string()] = src

/obj/effect/landmark/yautja_teleport/Destroy()
	var/turf/current_turf = get_turf(src)
	GLOB.mainship_yautja_teleports -= src
	GLOB.yautja_teleports -= src
	GLOB.mainship_yautja_desc -= current_turf.loc.name + current_turf.loc_to_string()
	GLOB.yautja_teleport_descs -= current_turf.loc.name + current_turf.loc_to_string()
	return ..()
