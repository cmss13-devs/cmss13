...
/obj/effect/landmark/survivor_spawner/lv624_skylight
	...
	"[SPAN_NOTICE("You are a survivor of the attack on the colony. You worked or lived in the archaeology colony, and managed to avoid the alien attacks...until now.")]",
	"[SPAN_NOTICE("You are fully aware of the xenomorph threat and are able to use this knowledge as you see fit.")]",
	"[SPAN_DANGER("Your primary objective is to heal up and survive until marines rescue you. If you want to assault the hive - adminhelp.")]")
...
/obj/effect/landmark/survivor_spawner/lv624_crashed_clf
	...
	"[SPAN_NOTICE("You are NOT aware of the xenomorph threat.")]",
	"[SPAN_DANGER("Your primary objective is to heal up and survive. If you want to assault the hive - adminhelp.")]")
