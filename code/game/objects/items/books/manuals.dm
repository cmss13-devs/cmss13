...
/obj/item/book/manual/engineering_guide
	...
	dat = {"
		...
		<body>
		<iframe width='780px' height='640px' src="https://cm-ss13.com/wiki/Guide_to_Engineering" frameborder="0" id="main_frame"></iframe> </body>
...
/obj/item/book/manual/engineering_construction
	...
	dat = {"
		...
		<body>
		<iframe width='780px' height='640px' src="https://cm-ss13.com/wiki/Guide_to_construction" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/book/manual/engineering_hacking
	...
	dat = {"
		...
		<body>
		<iframe width='780px' height='640px' src="https://cm-ss13.com/wiki/Guide_to_Engineering#Hacking" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/book/manual/ordnance
	...
	dat = {"
		...
		<body>
		<iframe width='780px' height='640px' src="https://cm-ss13.com/wiki/Ordnance_Technician" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/book/manual/comms
	...
	dat = {"
		...
		<body>
		<iframe width='780px' height='640px' src="https://cm-ss13.com/wiki/Comms" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/book/manual/security_space_law
	...
	dat = {"
		...
		<body>
		<iframe width='780px' height='640px' src="https://cm-ss13.com/wiki/Standard_Operating_Procedure" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/book/manual/marine_law
	...
	dat = {"
		...
		<body>
		<iframe width='780px' height='640px' src="http://cm-ss13.com/wiki/Marine_Law" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/book/manual/surgery
	...
	dat = {"
		...
		<body>
		<iframe width='780px' height='640px' src="https://cm-ss13.com/wiki/Surgery" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/book/manual/medical_diagnostics_manual
	...
	dat = {"<html>
				...
				<h3>Main guide</h3>
				<iframe width='780px' height='640px' src="http://cm-ss13.com/wiki/Guide_to_Medicine" frameborder="0" id="main_frame"></iframe>
				</body>
			</html>
...
/obj/item/book/manual/chemistry
	...
	dat = {"
		...
		<body>
		<iframe width='780px' height='640px' src="https://cm-ss13.com/wiki/Chemistry" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/book/manual/research_and_development
	...
	dat = {"
		...
		<body>
		<iframe width='780px' height='640px' src="https://cm-ss13.com/wiki/Researcher" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/book/manual/chef_recipes
	...
	dat = {"<html>
				...
				<iframe width='780px' height='640px' src="https://cm-ss13.com/wiki/Cooking" frameborder="0" id="main_frame"></iframe>
				</body>
			</html>
			"}
...
/obj/item/book/manual/barman_recipes
	...
	dat = {"<html>
				...
				<h3>Further recipes</h3>
				<iframe width='780px' height='640px' src="https://cm-ss13.com/wiki/Drinks" frameborder="0" id="main_frame"></iframe>
				</body>
			</html>
			"}
