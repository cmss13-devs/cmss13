...
/obj/item/device/lightreplacer/attackby(obj/item/thing, mob/user)
	if(istype(thing, /obj/item/stack/sheet/glass))
		var/obj/item/stack/sheet/glass/glass = thing
		if(uses >= max_uses)
	...
	if(istype(thing, /obj/item/light_bulb))
		var/obj/item/light_bulb/bulb = thing
