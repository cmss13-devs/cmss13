...
/obj/item/device/portable_vendor/corporate
	...
	listed_products = list(
		...
		list("Corporate Security Bodyguard", 40, /obj/item/handheld_distress_beacon/bodyguard, "white", "A beacon which sends the Corporate Security Division an encoded message informing them of your request for a Corporate Security Bodyguard."),
		list("Corporate Lawyer Team", 40, /obj/item/handheld_distress_beacon/lawyer, "white", "A beacon which sends the Corporate Affairs Division an encoded message informing them of your request for a Corporate Lawyer, required when a contract signee breaks one of their clauses."),
		...
		list("United States Dollars", 10, /obj/item/spacecash/c1000/counterfeit, "white", "$1000 USD, unmarked bills"),
		list("Cyanide Pill", 5, /obj/item/reagent_container/pill/cyanide, "white", "A cyanide pill, also known as a suicide pill. For the easy way out."),
		...
		list("Drinking Glass", 2, /obj/item/reagent_container/food/drinks/drinkingglass, "white", "A Drinking Glass, because you have class."),
		list("Weyland-Yutani Coffee Mug", 2, /obj/item/reagent_container/food/drinks/coffeecup/wy, "white", "A Weyland-Yutani coffee mug, for any Marines who want a Company souvenir."),

		list("STATIONERY", 0, null, null, null),
		list("WY pen, black", 0, /obj/item/tool/pen/clicky, "white", "A WY pen, for writing formally on the go."),
		list("WY pen, blue", 0, /obj/item/tool/pen/blue/clicky, "white", "A WY pen, for writing with a flourish on the go."),
		list("WY pen, red", 0, /obj/item/tool/pen/red/clicky, "white", "A WY pen, for writing angrily on the go."),
		list("WY pen, green", 0, /obj/item/tool/pen/green/clicky, "white", "A WY pen, for writing angrily on the go."),
		list("Paper", 0, /obj/item/paper, "white", "A fresh piece of paper, for writing on."),
		list("WY Paper", 0, /obj/item/paper/wy, "white", "A fresh piece of WY-branded paper, for writing important things on."),
		list("Carbon Paper", 0, /obj/item/paper/carbon, "white", "A piece of carbon paper, to double the writing output."),
		list("Clipboard", 0, /obj/item/clipboard, "white", "A clipboard, for storing all that writing."),
		...
		list("Charlie Squad", 10, /obj/item/device/encryptionkey/charlie, "white", "Radio Key for USCM Charlie Squad."),
		list("Delta Squad", 10, /obj/item/device/encryptionkey/delta, "white", "Radio Key for USCM Delta Squad."),
		list("Echo Squad", 10, /obj/item/device/encryptionkey/echo, "white", "Radio Key for USCM Echo Squad."),

		list("RESEARCH EXCHANGE GRANT", 0, null, null, null),
		list("Research Grant (10 points)", 30, /obj/item/paper/research_notes/grant/cl_special, "white", "A scientific grant to use as a bargain tool while trading with those pesky researchers."),
	)
