...
/obj/item/device/portable_vendor/corporate
	...
	listed_products = list(
		...
		list("WY pen, black", 1, /obj/item/tool/pen/weyyu, "white", "A WY pen, for writing formally on the go."),
		list("WY pen, blue", 1, /obj/item/tool/pen/blue/weyyu, "white", "A WY pen, for writing with a flourish on the go."),
		list("WY pen, red", 1, /obj/item/tool/pen/red/weyyu, "white", "A WY pen, for writing angrily on the go."),
		list("WY pen, green", 1, /obj/item/tool/pen/green/weyyu, "white", "A WY pen, for writing angrily on the go."),
