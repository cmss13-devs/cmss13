...
/obj/item/device/portable_vendor/corporate
	...
	listed_products = list(
		...
		list("Corporate Security Bodyguard", 50, /obj/item/handheld_distress_beacon/bodyguard, "white", "A beacon which sends the PMC Dispatch Division an encoded message informing them of your request to a Corporate Security Bodyguard."),
		list("Corporate Lawyer Team", 50, /obj/item/handheld_distress_beacon/lawyer, "white", "A beacon which sends the Corporate Affairs Division an encoded message informing them of your request to a Corporate Lawyer for when a contract signee breaks their contract."),
