...
/obj/item/device/portable_vendor/corporate
	...
	listed_products = list(
		...
		list("Modified Security Access Tuner", 50, /obj/item/device/black_market_hacking_device, "white", "A security access tuner with wires and electrical pins sticking out at odd angles. A handwritten label on the bottom says something about the ASRS system."),
