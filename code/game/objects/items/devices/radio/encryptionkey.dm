...
/obj/item/device/encryptionkey/mcom/alt
	channels = list(
		...
		SQUAD_MARINE_5 = FALSE,
		SQUAD_MARINE_CRYO = FALSE,
		RADIO_CHANNEL_ENGI = TRUE,
		RADIO_CHANNEL_MEDSCI = TRUE,
		RADIO_CHANNEL_REQ = TRUE,
		RADIO_CHANNEL_JTAC = TRUE,
...
/obj/item/device/encryptionkey/qm
	...
	channels = list(
		RADIO_CHANNEL_REQ = TRUE,
		RADIO_CHANNEL_COMMAND = TRUE,
		RADIO_CHANNEL_ENGI = FALSE,
		RADIO_CHANNEL_MEDSCI = FALSE,
		SQUAD_MARINE_1 = FALSE,
		SQUAD_MARINE_2 = FALSE,
		SQUAD_MARINE_3 = FALSE,
		SQUAD_MARINE_4 = FALSE,
...
/obj/item/device/encryptionkey/mcom/cl
	...
	channels = list(
		...
		RADIO_CHANNEL_JTAC = TRUE,
		RADIO_CHANNEL_INTEL = TRUE,
		RADIO_CHANNEL_ALMAYER = TRUE,
		RADIO_CHANNEL_WY = TRUE,
		RADIO_CHANNEL_WY_PUB = TRUE,
		)
...
/obj/item/device/encryptionkey/pmc/engi
	...
	channels = list(
		...
		RADIO_CHANNEL_WY_PUB = TRUE,
		RADIO_CHANNEL_WY_SEC = TRUE,
		RADIO_CHANNEL_PMC_ENGI = TRUE,
		RADIO_CHANNEL_PMC_CCT = TRUE,
		)
...
/obj/item/device/encryptionkey/upp/command
	...
	channels = list(
		RADIO_CHANNEL_UPP_CMD = TRUE,
		RADIO_CHANNEL_UPP_GEN = TRUE,
		RADIO_CHANNEL_UPP_ENGI = TRUE,
		RADIO_CHANNEL_UPP_MED = TRUE,
		RADIO_CHANNEL_UPP_CCT = TRUE,
		)
...
/obj/item/device/encryptionkey/clf/command
	...
	channels = list(
		RADIO_CHANNEL_CLF_CMD = TRUE,
		RADIO_CHANNEL_CLF_GEN = TRUE,
		RADIO_CHANNEL_CLF_ENGI = TRUE,
		RADIO_CHANNEL_CLF_MED = TRUE,
		RADIO_CHANNEL_CLF_CCT = TRUE,
		)
//---------------------------------------------------
/obj/item/device/encryptionkey/highcom
	...
	channels = list(
		...
		RADIO_CHANNEL_ENGI = TRUE,
		RADIO_CHANNEL_MEDSCI = TRUE,
		RADIO_CHANNEL_REQ = FALSE,
		RADIO_CHANNEL_JTAC = FALSE,
		RADIO_CHANNEL_INTEL = TRUE,
		RADIO_CHANNEL_ALMAYER = TRUE,
		)
