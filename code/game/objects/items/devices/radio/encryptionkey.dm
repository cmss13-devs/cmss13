...
/obj/item/device/encryptionkey/ce
	...
	icon_state = "ce_key"
	channels = list(RADIO_CHANNEL_ENGI = TRUE, RADIO_CHANNEL_COMMAND = TRUE, RADIO_CHANNEL_MEDSCI = TRUE, RADIO_CHANNEL_REQ = TRUE)
...
/obj/item/device/encryptionkey/ro
	...
	icon_state = "ce_key"
	channels = list(RADIO_CHANNEL_REQ = TRUE, RADIO_CHANNEL_COMMAND = TRUE, RADIO_CHANNEL_ENGI = FALSE, RADIO_CHANNEL_MEDSCI = FALSE)
...
/obj/item/device/encryptionkey/mmpo
	...
	icon_state = "sec_key"
	channels = list(RADIO_CHANNEL_COMMAND = TRUE, RADIO_CHANNEL_MP = TRUE, RADIO_CHANNEL_ENGI = TRUE, RADIO_CHANNEL_MEDSCI = TRUE)
...
/obj/item/device/encryptionkey/cmpcom
	...
	icon_state = "cmp_key"
	channels = list(RADIO_CHANNEL_COMMAND = TRUE, RADIO_CHANNEL_MP = TRUE, RADIO_CHANNEL_ENGI = TRUE, RADIO_CHANNEL_MEDSCI = TRUE, RADIO_CHANNEL_REQ = TRUE)

/obj/item/device/encryptionkey/cmpcom/cdrcom
	name = "\improper Marine Senior Command Radio Encryption Key"
	channels = list(RADIO_CHANNEL_COMMAND = TRUE, RADIO_CHANNEL_MP = TRUE, SQUAD_MARINE_5 = TRUE, RADIO_CHANNEL_ENGI = TRUE, RADIO_CHANNEL_MEDSCI = TRUE, RADIO_CHANNEL_REQ = TRUE, RADIO_CHANNEL_JTAC = TRUE, RADIO_CHANNEL_INTEL = TRUE)
...
/obj/item/device/encryptionkey/mcom
	...
	icon_state = "cap_key"
	channels = list(RADIO_CHANNEL_COMMAND = TRUE, SQUAD_MARINE_5 = TRUE, RADIO_CHANNEL_ENGI = TRUE, RADIO_CHANNEL_MEDSCI = TRUE, RADIO_CHANNEL_REQ = TRUE, RADIO_CHANNEL_JTAC = TRUE, RADIO_CHANNEL_INTEL = TRUE)
...
/obj/item/device/encryptionkey/po
	...
	icon_state = "cap_key"
	channels = list(RADIO_CHANNEL_COMMAND = TRUE, RADIO_CHANNEL_JTAC = TRUE, RADIO_CHANNEL_INTEL = TRUE)

/obj/item/device/encryptionkey/io
	name = "\improper Marine Intelligence Officer Radio Encryption Key"
	icon_state = "cap_key"
	channels = list(RADIO_CHANNEL_COMMAND = TRUE, SQUAD_MARINE_CRYO = FALSE, RADIO_CHANNEL_INTEL = TRUE)
