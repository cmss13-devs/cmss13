/obj/item/explosive/plastic
	...
	var/image/overlay
	var/list/breachable = list(/obj/structure/window, /turf/closed, /obj/structure/machinery, /obj/structure/mineral_door , /obj/structure/cargo_container,/obj/structure/machinery/colony_floodlight, /obj/structure/prop, /mob/living)
