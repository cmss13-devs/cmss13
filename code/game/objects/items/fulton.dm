...
/obj/item/stack/fulton/proc/deploy_fulton()
	...
	var/middle_x = reservation.bottom_left_turfs[1].x + FLOOR((reservation.top_right_turfs[1].x - reservation.bottom_left_turfs[1].x) / 2, 1)
	var/middle_y = reservation.bottom_left_turfs[1].y + FLOOR((reservation.top_right_turfs[1].y - reservation.bottom_left_turfs[1].y) / 2, 1)
	var/turf/space_tile = locate(middle_x, middle_y, reservation.bottom_left_turfs[1].z)
	if(!space_tile)
