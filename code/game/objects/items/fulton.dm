...
/obj/item/stack/fulton/proc/deploy_fulton()
	...
	var/middle_x = bottom_left_turf.x + FLOOR((top_right_turf.x - bottom_left_turf.x) / 2, 1)
	var/middle_y = bottom_left_turf.y + FLOOR((top_right_turf.y - bottom_left_turf.y) / 2, 1)
