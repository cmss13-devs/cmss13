...
/obj/item/prop/helmetgarb/gunoil
	name = "gun oil"
	desc = "It is a bottle of oil, for your gun. Don't fall for the rumors, the M41A is NOT a self-cleaning firearm. This doesn't look like it'd be sufficient for gun repairs, but it can clean your gun, at least."
	icon_state = "gunoil"
