...
/obj/item/reagent_container/borghypo/Initialize()
	...
	for(var/T in reagent_ids)
		...
		var/datum/reagent/R = GLOB.chemical_reactions_list[T]
...
/obj/item/reagent_container/borghypo/attack_self(mob/user)
	...
	if(!selection) return
	var/datum/reagent/R = GLOB.chemical_reactions_list[selection]
...
/obj/item/reagent_container/borghypo/get_examine_text(mob/user)
	...
	var/datum/reagent/R = GLOB.chemical_reactions_list[reagent_ids[mode]]
