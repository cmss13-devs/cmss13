...
GLOBAL_LIST_INIT(silver_recipes, list ( \
	...
	new/datum/stack_recipe("silver beaker", /obj/item/reagent_container/glass/beaker/large/silver, 3, time = 30, skill_req = SKILL_CONSTRUCTION, skill_lvl = SKILL_CONSTRUCTION_TRAINED), \
	))
