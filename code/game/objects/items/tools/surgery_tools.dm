...
/obj/item/tool/surgery/scalpel/manager
	...
	desc_lore = "Thousands of surgeons across the galaxy can only dream of holding one of these in their hands. With the technology of an advanced laser scalpel and a mechanical retractor all in one tool, a surgeon can incise, seal blood vessels, and widen incisions all in one step. Sadly, the tool is overhyped, aiding in its unconscionable price tag; it cannot function as a scalpel, hemostat, or retractor in any circumstances other than making an incision."
	force = 15
	attack_speed = 6
...
/obj/item/tool/surgery/bonesetter
	name = "bone setter"
	desc = "Known formally as 'bone reduction forceps,' it is a surgical tool used for a procedure called 'fracture reduction,' during which surgeons use it to reposition ractured bones into their proper positions so they may heal properly."
