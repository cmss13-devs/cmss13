...
/obj/item/prop/magazine/boots/n080
	name = "Boots!: Issue No.80"
	desc = "The only official USCM magazine, the headline reads 'Ten Ways To Extend Your Barrel Before Your CO Notices.'"
