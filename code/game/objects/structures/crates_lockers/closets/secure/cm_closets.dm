...
/obj/structure/closet/secure_closet/military_police/Initialize()
	...
	new /obj/item/clothing/shoes/marine(src)
	new /obj/item/clothing/under/marine/ship_marine(src)
	new /obj/item/clothing/suit/storage/marine/ship_marine(src)
	new /obj/item/storage/belt/security/ship_marine(src)
	new /obj/item/device/flashlight(src)
	new /obj/item/clothing/glasses/sunglasses/sechud(src)
	new /obj/item/device/radio/headset/almayer/ship_marine(src)
...
/obj/structure/closet/secure_closet/warrant_officer/Initialize()
	...
	new /obj/item/clothing/accessory/storage/holster/armpit(src)
	new /obj/item/clothing/shoes/marine(src)
	new /obj/item/clothing/under/marine/officer/master_at_arms(src)
	new /obj/item/clothing/suit/storage/marine/ship_marine(src)
	new /obj/item/storage/belt/security/ship_marine(src)
	new /obj/item/device/flashlight(src)
	new /obj/item/clothing/glasses/sunglasses/sechud(src)
	new /obj/item/device/radio/headset/almayer/master_at_arms(src)
	new /obj/item/weapon/gun/energy/taser(src)
	new /obj/item/weapon/melee/baton(src)
	new /obj/item/storage/backpack/security (src)
	new /obj/item/storage/backpack/satchel/sec(src)
