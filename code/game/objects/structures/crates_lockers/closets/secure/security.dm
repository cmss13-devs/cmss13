...
/obj/structure/closet/secure_closet/detective/Initialize()
	. = ..()
	new /obj/item/clothing/under/hybrisa/detective(src)
	new /obj/item/clothing/under/hybrisa/detective/grey(src)
	new /obj/item/clothing/suit/storage/CMB/hybrisa/detective_coat/brown(src)
	new /obj/item/clothing/suit/storage/CMB/hybrisa/detective_coat/grey(src)
	new /obj/item/clothing/suit/storage/forensics/blue(src)
	new /obj/item/clothing/suit/storage/forensics/red(src)
	new /obj/item/clothing/gloves/black(src)
	new /obj/item/clothing/head/hybrisa/fedora/brown(src)
	new /obj/item/clothing/head/hybrisa/fedora/grey(src)
