...
/obj/structure/largecrate/baseball
	name = "baseball equipment crate"

/obj/structure/largecrate/baseball/Initialize()
	. = ..()
	new /obj/item/toy/baseball(src)
	new /obj/item/toy/baseball(src)
	new /obj/item/weapon/baseballbat/metal(src)
	new /obj/item/weapon/baseballbat/metal(src)
	new /obj/item/weapon/baseballbat(src)
	new /obj/item/weapon/baseballbat(src)
	new /obj/item/toy/baseball_mitt(src)
	new /obj/item/toy/baseball_mitt(src)
	new /obj/item/toy/baseball_mitt(src)
	new /obj/item/toy/baseball_mitt(src)
	new /obj/item/toy/baseball_mitt(src)
