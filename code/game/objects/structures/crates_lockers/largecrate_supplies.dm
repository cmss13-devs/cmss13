...
/obj/structure/largecrate/supply/weapons/shotgun
	name = "\improper M37A4 pump action shotgun weapons chest (x10)"
	desc = "A weapons chest containing ten M37A4 pump shotguns."
	supplies = list(/obj/item/weapon/gun/shotgun/pump/m37a4 = 10)
