...
/obj/structure/extinguisher_cabinet/blackfoot
	...
	desc = "A compact on-board fire suppression system specially designed for implementation onboard the aircraft. In grunt terms, it's a fancy-pants fire extinguisher cabinet. Good if the Chimeras misfire, or if some chucklehead forgets to put the pilot light out on their flamer."
