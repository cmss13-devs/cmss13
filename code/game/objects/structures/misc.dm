...
/obj/structure/target/bullet_act(obj/projectile/bullet)
	...
	langchat_send_message(damage_dealt, LANGCHAT_IMAGE_IGNORE_LANG, get_mobs_in_view(7, src), LANGCHAT_FAST_POP, list("langchat_small"))
...
/obj/structure/target/proc/start_practice_health_reset()
	...
	langchat_send_message("[src] folds to the ground!", LANGCHAT_IMAGE_IGNORE_LANG, get_mobs_in_view(7, src), LANGCHAT_FAST_POP, list("langchat_small"))
...
/obj/structure/target/proc/raise_target()
	...
	langchat_send_message("[src] raises back into position!", LANGCHAT_IMAGE_IGNORE_LANG, get_mobs_in_view(7, src), LANGCHAT_FAST_POP, list("langchat_small"))
	practice_health = practice_mode[1]
