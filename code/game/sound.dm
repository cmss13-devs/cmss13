...
/proc/get_sfx(sound)
	if(istext(sound))
		switch(sound)
			...
			if("male_speak")
				sound = pick('sound/voice/human_male_speak.ogg')
			if("male_ask")
				sound = pick('sound/voice/human_male_speak_ask.ogg')
			if("male_exclaim")
				sound = pick('sound/voice/human_male_speak_exclaim.ogg')
			if("female_speak")
				sound = pick('sound/voice/human_female_speak.ogg')
			if("female_ask")
				sound = pick('sound/voice/human_female_speak_ask.ogg')
			if("female_exclaim")
				sound = pick('sound/voice/human_female_speak_exclaim.ogg')
			if("plush")
