...
/proc/get_sfx(S)
	if(istext(S))
		switch(S)
			...
			// Human
			if("male_scream")
				S = pick('sound/voice/human_male_scream_1.ogg','sound/voice/human_male_scream_2.ogg','sound/voice/human_male_scream_3.ogg','sound/voice/human_male_scream_4.ogg',5;'sound/voice/human_male_scream_5.ogg',10;'sound/voice/human_jackson_scream.ogg',10;'sound/voice/mscream2.ogg',10;'sound/voice/human_ack_scream.ogg',10;'sound/voice/tomscream.ogg')
			if("male_pain")
				S = pick('sound/voice/human_male_pain_1.ogg','sound/voice/human_male_pain_2.ogg','sound/voice/human_male_pain_3.ogg',10;'sound/voice/tomscream.ogg',10;'sound/voice/mscream2.ogg')
			if("male_fragout")
			...
			if("female_scream")
				S = pick('sound/voice/human_female_scream_1.ogg','sound/voice/human_female_scream_2.ogg','sound/voice/human_female_scream_3.ogg','sound/voice/human_female_scream_4.ogg',5;'sound/voice/human_female_scream_5.ogg',5;'sound/voice/human_jackson_scream.ogg')
			if("female_pain")
