...
/proc/get_sfx(S)
	if(istext(S))
		switch(S)
			...
			if("explosion")
				S = pick('sound/effects/explosion1.ogg','sound/effects/explosion2.ogg','sound/effects/explosion3.ogg')
			if("bigboom")
			...
			if("alien_resin_break")
				S = pick('sound/effects/alien_resin_hit1.ogg','sound/effects/alien_resin_hit2.ogg','sound/effects/alien_resin_hit3.ogg','sound/effects/alien_resin_hit4.ogg','sound/effects/alien_resin_hit5.ogg')
			if("alien_resin_move")
			...
			if("alien_help")
				S = pick('sound/voice/alien_help1.ogg','sound/voice/alien_help2.ogg','sound/voice/alien_help3.ogg','sound/voice/alien_help4.ogg')
			if("alien_drool")
			...
			if("male_fragout")
				S = pick('sound/voice/human_male_grenadethrow_1.ogg', 'sound/voice/human_male_grenadethrow_2.ogg', 'sound/voice/human_male_grenadethrow_3.ogg', 'sound/voice/human_male_grenadethrow_4.ogg', 'sound/voice/human_male_grenadethrow_5.ogg', 'sound/voice/human_male_grenadethrow_6.ogg', 'sound/voice/human_male_grenadethrow_7.ogg', 'sound/voice/human_male_grenadethrow_8.ogg', 'sound/voice/human_male_grenadethrow_9.ogg')
			if("male_warcry")
				S = pick('sound/voice/warcry/male_go.ogg', 'sound/voice/warcry/male_attack.ogg', 'sound/voice/warcry/male_charge.ogg', 'sound/voice/warcry/male_charge2.ogg', 'sound/voice/warcry/warcry_male_1.ogg', 'sound/voice/warcry/warcry_male_2.ogg', 'sound/voice/warcry/warcry_male_3.ogg', 'sound/voice/warcry/warcry_male_4.ogg', 'sound/voice/warcry/warcry_male_5.ogg', 'sound/voice/warcry/warcry_male_6.ogg', 'sound/voice/warcry/warcry_male_7.ogg', 'sound/voice/warcry/warcry_male_8.ogg', 'sound/voice/warcry/warcry_male_9.ogg', 'sound/voice/warcry/warcry_male_10.ogg', 'sound/voice/warcry/warcry_male_11.ogg', 'sound/voice/warcry/warcry_male_12.ogg', 'sound/voice/warcry/warcry_male_13.ogg', 'sound/voice/warcry/warcry_male_14.ogg', 'sound/voice/warcry/warcry_male_15.ogg', 'sound/voice/warcry/warcry_male_16.ogg', 5;'sound/voice/warcry/warcry_male_rare_1.ogg', 5;'sound/voice/warcry/warcry_male_rare_2.ogg', 5;'sound/voice/warcry/warcry_male_rare_3.ogg', 5;'sound/voice/warcry/warcry_male_rare_4.ogg', 5;'sound/voice/warcry/warcry_male_rare_5.ogg')
			if("female_scream")
			...
			if("female_fragout")
				S = pick("sound/voice/human_female_grenadethrow_1.ogg", 'sound/voice/human_female_grenadethrow_2.ogg', 'sound/voice/human_female_grenadethrow_3.ogg', 'sound/voice/human_female_grenadethrow_4.ogg', 'sound/voice/human_female_grenadethrow_5.ogg')
			if("female_warcry")
