...
/proc/get_sfx(sound)
	if(istext(sound))
		switch(sound)
			...
			if("pathogen_roar")
				sound = pick('sound/pathogen_creatures/pathogen_roar1.ogg','sound/pathogen_creatures/pathogen_roar2.ogg','sound/pathogen_creatures/pathogen_roar3.ogg')
			...
			if("pathogen_growl")
				sound = pick('sound/pathogen_creatures/pathogen_growl1.ogg','sound/pathogen_creatures/pathogen_growl2.ogg','sound/pathogen_creatures/pathogen_growl3.ogg')
			if("pathogen_pounce")
				sound = pick('sound/pathogen_creatures/pathogen_pounce1.ogg','sound/pathogen_creatures/pathogen_pounce2.ogg')
			if("pathogen_death")
				sound = pick('sound/pathogen_creatures/pathogen_death1.ogg','sound/pathogen_creatures/pathogen_death2.ogg','sound/pathogen_creatures/pathogen_death3.ogg')
			if("walker_talk")
				sound = pick('sound/pathogen_creatures/walker_talk1.ogg','sound/pathogen_creatures/walker_talk2.ogg')
			if("walker_growl")
				sound = pick('sound/pathogen_creatures/walker_growl1.ogg','sound/pathogen_creatures/walker_growl2.ogg')
			if("walker_death")
				sound = pick('sound/pathogen_creatures/walker_death1.ogg','sound/pathogen_creatures/walker_death2.ogg','sound/pathogen_creatures/walker_death3.ogg')
			if("aberration_hiss")
				sound = pick('sound/pathogen_creatures/aberration_hiss1.ogg','sound/pathogen_creatures/aberration_hiss2.ogg')
			if("aberration_death")
				sound = pick('sound/pathogen_creatures/aberration_death1.ogg','sound/pathogen_creatures/aberration_death2.ogg')
			if("matriarch_spores")
				sound = pick('sound/pathogen_creatures/matriarch_spores1.ogg','sound/pathogen_creatures/matriarch_spores2.ogg','sound/pathogen_creatures/matriarch_spores3.ogg')
			// Human
			if("male_scream")
