...
/proc/get_sfx(sound)
	if(istext(sound))
		switch(sound)
			...
			if("acid_spit")
				sound = pick('sound/voice/xeno/alien_spitacid.ogg','sound/voice/xeno/alien_spitacid2.ogg')
			if("acid_sizzle")
			...
			if("alien_talk")
				sound = pick('sound/voice/xeno/alien_talk.ogg','sound/voice/xeno/alien_talk2.ogg','sound/voice/xeno/alien_talk3.ogg')
			if("larva_talk")
				sound = pick('sound/voice/xeno/larva_talk1.ogg','sound/voice/xeno/larva_talk2.ogg','sound/voice/xeno/larva_talk3.ogg','sound/voice/xeno/larva_talk4.ogg')
			if("hiss_talk")
				sound = pick('sound/voice/xeno/hiss2.ogg','sound/voice/xeno/hiss3.ogg','sound/voice/xeno/hiss4.ogg')
			if("alien_growl")
				sound = pick('sound/voice/xeno/alien_growl1.ogg','sound/voice/xeno/alien_growl2.ogg','sound/voice/xeno/alien_growl3.ogg')
			if("alien_hiss")
				sound = pick('sound/voice/xeno/alien_hiss1.ogg','sound/voice/xeno/alien_hiss2.ogg','sound/voice/xeno/alien_hiss3.ogg')
			if("alien_tail_swipe")
				sound = pick('sound/effects/alien_tail_swipe1.ogg','sound/effects/alien_tail_swipe2.ogg','sound/effects/alien_tail_swipe3.ogg')
			if("alien_help")
				sound = pick('sound/voice/xeno/alien_help1.ogg','sound/voice/xeno/alien_help2.ogg','sound/voice/xeno/alien_help3.ogg')
			if("alien_drool")
				sound = pick('sound/voice/xeno/alien_drool1.ogg','sound/voice/xeno/alien_drool2.ogg')
			if("alien_roar")
				sound = pick('sound/voice/xeno/alien_roar1.ogg','sound/voice/xeno/alien_roar2.ogg','sound/voice/xeno/alien_roar3.ogg','sound/voice/xeno/alien_roar4.ogg','sound/voice/xeno/alien_roar5.ogg','sound/voice/xeno/alien_roar6.ogg')
			if("alien_roar_larva")
				sound = pick('sound/voice/xeno/alien_roar_larva1.ogg','sound/voice/xeno/alien_roar_larva2.ogg')
			if("queen")
				sound = pick('sound/voice/xeno/alien_queen_command.ogg','sound/voice/xeno/alien_queen_command2.ogg','sound/voice/xeno/alien_queen_command3.ogg')
			// Human
			if("male_scream")
				sound = pick('sound/voice/human/male/scream/scream_1.ogg','sound/voice/human/male/scream/scream_2.ogg','sound/voice/human/male/scream/scream_3.ogg','sound/voice/human/male/scream/scream_4.ogg',5;'sound/voice/human/male/scream/scream_5.ogg',5;'sound/voice/human/male/scream/human_jackson_scream.ogg',5;'sound/voice/human/male/scream/human_ack_scream.ogg','sound/voice/human/male/scream/scream_6.ogg')
			if("male_pain")
				sound = pick('sound/voice/human/male/pain/pain_1.ogg','sound/voice/human/male/pain/pain_2.ogg','sound/voice/human/male/pain/pain_3.ogg','sound/voice/human/male/pain/pain_4.ogg',5;'sound/voice/human/male/pain/tomscream.ogg',5;'sound/voice/human/male/pain/human_bobby_pain.ogg',5;'sound/voice/human/male/pain/human_tantrum_scream.ogg', 5;'sound/voice/human/male/pain/human_male_pain_rare_1.ogg')
			if("male_fragout")
				sound = pick('sound/voice/human/male/grenadethrow/grenadethrow_1.ogg', 'sound/voice/human/male/grenadethrow/grenadethrow_2.ogg', 'sound/voice/human/male/grenadethrow/grenadethrow_3.ogg')
			if("male_warcry")
				sound = pick('sound/voice/human/male/warcry/go.ogg', 'sound/voice/human/male/warcry/attack.ogg', 'sound/voice/human/male/warcry/charge.ogg', 'sound/voice/human/male/warcry/charge2.ogg', 'sound/voice/human/male/warcry/warcry_1.ogg', 'sound/voice/human/male/warcry/warcry_2.ogg', 'sound/voice/human/male/warcry/warcry_3.ogg', 'sound/voice/human/male/warcry/warcry_4.ogg', 'sound/voice/human/male/warcry/warcry_5.ogg', 'sound/voice/human/male/warcry/warcry_6.ogg', 'sound/voice/human/male/warcry/warcry_7.ogg', 'sound/voice/human/male/warcry/warcry_8.ogg', 'sound/voice/human/male/warcry/warcry_9.ogg', 'sound/voice/human/male/warcry/warcry_10.ogg', 'sound/voice/human/male/warcry/warcry_11.ogg', 'sound/voice/human/male/warcry/warcry_12.ogg', 'sound/voice/human/male/warcry/warcry_13.ogg', 'sound/voice/human/male/warcry/warcry_14.ogg', 'sound/voice/human/male/warcry/warcry_15.ogg', 'sound/voice/human/male/warcry/warcry_16.ogg', 'sound/voice/human/male/warcry/warcry_17.ogg', 'sound/voice/human/male/warcry/warcry_18.ogg', 'sound/voice/human/male/warcry/warcry_19.ogg', 'sound/voice/human/male/warcry/warcry_20.ogg', 'sound/voice/human/male/warcry/warcry_21.ogg', 'sound/voice/human/male/warcry/warcry_22.ogg', 'sound/voice/human/male/warcry/warcry_23.ogg', 'sound/voice/human/male/warcry/warcry_24.ogg', 'sound/voice/human/male/warcry/warcry_25.ogg', 'sound/voice/human/male/warcry/warcry_26.ogg', 'sound/voice/human/male/warcry/warcry_27.ogg', 'sound/voice/human/male/warcry/warcry_28.ogg', 'sound/voice/human/male/warcry/warcry_29.ogg', 'sound/voice/human/male/warcry/warcry_30.ogg', 'sound/voice/human/male/warcry/warcry_31.ogg', 'sound/voice/human/male/warcry/warcry_32.ogg', 'sound/voice/human/male/warcry/warcry_33.ogg', 'sound/voice/human/male/warcry/warcry_34.ogg', 'sound/voice/human/male/warcry/warcry_35.ogg', 5;'sound/voice/human/male/warcry/warcry_rare_1.ogg', 5;'sound/voice/human/male/warcry/warcry_rare_2.ogg', 5;'sound/voice/human/male/warcry/warcry_rare_3.ogg', 5;'sound/voice/human/male/warcry/warcry_rare_4.ogg', 5;'sound/voice/human/male/warcry/warcry_rare_5.ogg')
			if("male_upp_warcry")
				sound = pick('sound/voice/human/male/warcry/upp/warcry_1.ogg', 'sound/voice/human/male/warcry/upp/warcry_2.ogg')
			if("male_preburst_")
				sound = pick('sound/voice/human/male/preburst/preburst_1.ogg', 'sound/voice/human/male/preburst/preburst_2.ogg', 'sound/voice/human/male/preburst/preburst_3.ogg', 'sound/voice/human/male/preburst/preburst_4.ogg', 'sound/voice/human/male/preburst/preburst_5.ogg', 'sound/voice/human/male/preburst/preburst_6.ogg', 'sound/voice/human/male/preburst/preburst_7.ogg', 'sound/voice/human/male/preburst/preburst_8.ogg', 'sound/voice/human/male/preburst/preburst_9.ogg')
			if("male_hugged")
				sound = pick("sound/voice/human/male/facehugged/facehugged1.ogg", 'sound/voice/human/male/facehugged/facehugged2.ogg', 'sound/voice/human/male/facehugged/facehugged3.ogg')
			if("female_scream")
				sound = pick('sound/voice/human/female/scream/scream_1.ogg','sound/voice/human/female/scream/scream_2.ogg','sound/voice/human/female/scream/scream_3.ogg','sound/voice/human/female/scream/scream_4.ogg',5;'sound/voice/human/female/scream/scream_5.ogg')
			if("female_pain")
				sound = pick('sound/voice/human/female/pain/pain_1.ogg','sound/voice/human/female/pain/pain_2.ogg','sound/voice/human/female/pain/pain_3.ogg','sound/voice/human/female/pain/pain_4.ogg','sound/voice/human/female/pain/pain_5.ogg','sound/voice/human/female/pain/pain_6.ogg')
			if("female_fragout")
				sound = pick("sound/voice/human/female/grenadethrow/grenadethrow_1.ogg", 'sound/voice/human/female/grenadethrow/grenadethrow_2.ogg', 'sound/voice/human/female/grenadethrow/grenadethrow_3.ogg')
			if("female_warcry")
				sound = pick('sound/voice/human/female/warcry/female_charge.ogg', 'sound/voice/human/female/warcry/female_yell1.ogg', 'sound/voice/human/female/warcry/warcry_1.ogg', 'sound/voice/human/female/warcry/warcry_2.ogg', 'sound/voice/human/female/warcry/warcry_3.ogg', 'sound/voice/human/female/warcry/warcry_4.ogg', 'sound/voice/human/female/warcry/warcry_5.ogg', 'sound/voice/human/female/warcry/warcry_6.ogg', 'sound/voice/human/female/warcry/warcry_7.ogg', 'sound/voice/human/female/warcry/warcry_8.ogg', 'sound/voice/human/female/warcry/warcry_9.ogg', 'sound/voice/human/female/warcry/warcry_10.ogg', 'sound/voice/human/female/warcry/warcry_11.ogg', 'sound/voice/human/female/warcry/warcry_12.ogg', 'sound/voice/human/female/warcry/warcry_13.ogg', 'sound/voice/human/female/warcry/warcry_14.ogg', 'sound/voice/human/female/warcry/warcry_15.ogg', 'sound/voice/human/female/warcry/warcry_16.ogg', 'sound/voice/human/female/warcry/warcry_17.ogg', 'sound/voice/human/female/warcry/warcry_18.ogg', 'sound/voice/human/female/warcry/warcry_19.ogg', 'sound/voice/human/female/warcry/warcry_20.ogg')
			if("female_upp_warcry")
				sound = pick('sound/voice/human/female/warcry/upp/warcry_1.ogg', 'sound/voice/human/female/warcry/upp/warcry_2.ogg')
			if("female_preburst_")
				sound = pick('sound/voice/human/female/preburst/preburst_1.ogg', 'sound/voice/human/female/preburst/preburst_2.ogg', 'sound/voice/human/female/preburst/preburst_3.ogg', 'sound/voice/human/female/preburst/preburst_4.ogg', 'sound/voice/human/female/preburst/preburst_5.ogg',  'sound/voice/human/female/preburst/preburst_6.ogg',  'sound/voice/human/female/preburst/preburst_7.ogg')
			if("female_hugged")
				sound = pick("sound/voice/human/female/facehugged/facehugged1.ogg", 'sound/voice/human/female/facehugged/facehugged2.ogg')
			if("rtb_handset")
			...
			// working joe
			if("wj_death")
				sound = pick('sound/voice/synth/joe/death_normal.ogg', 'sound/voice/synth/joe/death_silence.ogg',10;'sound/voice/synth/joe/death_tomorrow.ogg',5;'sound/voice/synth/joe/death_dream.ogg')
			if("hj_death")
				sound = pick('sound/voice/synth/joe/death_hj_normal.ogg', 'sound/voice/synth/joe/death_hj_silence.ogg',10;'sound/voice/synth/joe/death_hj_tomorrow.ogg')
			if("upp_wj_death")
				sound = pick('sound/voice/synth/joe/upp_joe/smert1.ogg', 'sound/voice/synth/joe/upp_joe/smert2.ogg', 'sound/voice/synth/joe/upp_joe/smert3.ogg', 'sound/voice/synth/joe/upp_joe/smert4.ogg', 'sound/voice/synth/joe/upp_joe/smert5.ogg')
			//misc mobs
			if("cat_meow")
				sound = pick('sound/voice/misc/cat_meow_1.ogg','sound/voice/misc/cat_meow_2.ogg','sound/voice/misc/cat_meow_3.ogg','sound/voice/misc/cat_meow_4.ogg','sound/voice/misc/cat_meow_5.ogg','sound/voice/misc/cat_meow_6.ogg','sound/voice/misc/cat_meow_7.ogg')
			if("pred_pain")
				sound = pick('sound/voice/pred/pred_pain1.ogg','sound/voice/pred/pred_pain2.ogg','sound/voice/pred/pred_pain3.ogg','sound/voice/pred/pred_pain4.ogg','sound/voice/pred/pred_pain5.ogg',5;'sound/voice/pred/pred_pain_rare1.ogg')
			if("pred_preburst_")
				sound = pick('sound/voice/pred/pred_pain_rare1.ogg')
			if("pred_death")
				sound = pick('sound/voice/pred/pred_death1.ogg', 'sound/voice/pred/pred_death2.ogg')
			if("clownstep")
			...
			if("evo_screech")
				sound = pick('sound/voice/xeno/alien_echoroar_1.ogg', 'sound/voice/xeno/alien_echoroar_2.ogg', 'sound/voice/xeno/alien_echoroar_3.ogg')
			if("wy_droid_pain")
				sound = pick('sound/voice/synth/wy_droid/wy_droid_pain1.ogg', 'sound/voice/synth/wy_droid/wy_droid_pain2.ogg', 'sound/voice/synth/wy_droid/wy_droid_pain3.ogg', 'sound/voice/synth/wy_droid/wy_droid_pain4.ogg', 'sound/voice/synth/wy_droid/wy_droid_pain5.ogg')
			if("wy_droid_death")
				sound = pick('sound/voice/synth/wy_droid/wy_droid_death1.ogg', 'sound/voice/synth/wy_droid/wy_droid_death2.ogg', 'sound/voice/synth/wy_droid/wy_droid_death3.ogg', 'sound/voice/synth/wy_droid/wy_droid_death4.ogg', 'sound/voice/synth/wy_droid/wy_droid_death5.ogg', 'sound/voice/synth/wy_droid/wy_droid_death6.ogg', 'sound/voice/synth/wy_droid/wy_droid_death7.ogg')
			if("wy_droid_cloaker_death")
				sound = pick('sound/voice/synth/wy_droid/wy_stealth_droid_death1.ogg', 'sound/voice/synth/wy_droid/wy_stealth_droid_death2.ogg')
	return sound
