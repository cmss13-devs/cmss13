...
/proc/get_sfx(S)
	if(istext(S))
		switch(S)
			...
			if("male_twe_warcry")
				S = pick('sound/voice/twe_warcry/warcry_male_1.ogg', 'sound/voice/twe_warcry/warcry_male_2.ogg')
			if("female_scream")
			...
			if("female_twe_warcry")
				S = pick('sound/voice/twe_warcry/warcry_female_1.ogg', 'sound/voice/twe_warcry/warcry_female_2.ogg')
			if("rtb_handset")
