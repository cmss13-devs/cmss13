...
/proc/get_sfx(S)
	if(istext(S))
		switch(S)
			...
			if("male_panic_scream")
				S = pick('sound/voice/human_male_panic_scream_1.ogg','sound/voice/human_male_panic_scream_2.ogg')
			if("female_panic_scream")
				S = pick('sound/voice/human_female_panic_scream_1.ogg','sound/voice/human_female_panic_scream_2.ogg')
			if("male_pain")
