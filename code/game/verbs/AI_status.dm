/mob/living/silicon/ai/proc/ai_statuschange()
	...
	for (var/obj/structure/machinery/ai_status_display/AISD in world) //change status
		spawn( 0 )
		AISD.emotion = emote
	for (var/obj/structure/machinery/status_display/SD in world) //if Friend Computer, change ALL displays
