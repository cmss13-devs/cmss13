/datum/entity/admin_holder/var/static/create_object_html = null

/datum/entity/admin_holder/proc/create_object(mob/user)
...
/datum/entity/admin_holder/proc/quick_create_object(mob/user)
