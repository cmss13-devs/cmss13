...
/client/proc/handle_bomb_drop(atom/epicenter)
	...
	switch(choice)
		if(null)
			return 0
		if("Small Bomb")
			cell_explosion(epicenter, 120, 40, EXPLOSION_FALLOFF_SHAPE_LINEAR, null,cause_data)
		if("Medium Bomb")
			cell_explosion(epicenter, 220, 50, EXPLOSION_FALLOFF_SHAPE_LINEAR, null,cause_data)
		if("Big Bomb")
			cell_explosion(epicenter, 500, 60, EXPLOSION_FALLOFF_SHAPE_LINEAR, null,cause_data)
		if("Custom Bomb")
