GLOBAL_LIST_EMPTY_TYPED(admin_runtime_decorators, /datum/decorator/manual/admin_runtime)
...
/client/proc/set_autoreplacer()
	...
	log_and_message_staff("[src] activated new decorator id: [GLOB.admin_runtime_decorators.len] set for [hint_text] `[types]` for field `[field]` set value `[value]`")
