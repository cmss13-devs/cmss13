...
/client/proc/mod_list_add_ass() //haha
	...
	switch(class)
		...
		if("num")
			var_value = tgui_input_number(src, "Enter new number:","Num")
...
/client/proc/mod_list_add(var/list/L)
	...
	switch(class)
		...
		if("num")
			var_value = tgui_input_number(usr, "Enter new number:","Num")
...
/client/proc/mod_list(var/list/L)
	...
	switch(class) //Spits a runtime error if you try to modify an entry in the contents list. Dunno how to fix it, yet.
		...
		if("num")
			L[L.Find(variable)] = tgui_input_number(usr, "Enter new number:","Num")
	...
	switch(class)
		...
		if("num")
			if(variable=="luminosity")
				var/var_new = tgui_input_number(src, "Enter new number:","Num", O.vars[variable])
				if(var_new == null) return
