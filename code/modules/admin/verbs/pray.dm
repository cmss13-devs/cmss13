...
/proc/Centcomm_announce(var/text , var/mob/Sender , var/iamessage)
	...
	msg = "<b><span class='notice'><font color=orange>USCM[iamessage ?  "IA" : ""]:</span></font>[key_name(Sender, 1)] (<A HREF='?_src_=admin_holder;ccmark=\ref[Sender]'>Mark</A>) (<A HREF='?_src_=admin_holder;adminplayeropts=\ref[Sender]'>PP</A>) (<A HREF='?_src_=vars;Vars=\ref[Sender]'>VV</A>) (<A HREF='?_src_=admin_holder;subtlemessage=\ref[Sender]'>SM</A>) (<A HREF='?_src_=admin_holder;adminplayerobservejump=\ref[Sender]'>JMP</A>) (<A HREF='?_src_=admin_holder;secretsadmin=check_antagonist'>CA</A>) (<A HREF='?_src_=admin_holder;BlueSpaceArtillery=\ref[Sender]'>BSA</A>) (<A HREF='?_src_=admin_holder;CentcommReply=\ref[Sender]'>RPLY</A>):</b> [msg]"
	for(var/client/C in admins)
		log_admin(msg)
