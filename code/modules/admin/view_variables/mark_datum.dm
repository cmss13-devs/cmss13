/client/proc/mark_datum(datum/D)
	...
	admin_holder.RegisterSignal(admin_holder.marked_datum, COMSIG_PARENT_QDELETING, TYPE_PROC_REF(/datum/view_record/admin_holder, handle_marked_del))
...
/datum/view_record/admin_holder/proc/handle_marked_del(datum/source)
	SIGNAL_HANDLER
