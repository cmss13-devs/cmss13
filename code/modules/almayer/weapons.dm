...
/datum/space_weapon/rail_gun
	name = "Railgun"
	possibly_ammunition = list("Piercing Near-Lightning Railgun Projectile", "Piercing Near-Lightning Railgun Projectile of Increased Strength")
...
/datum/space_weapon/rocket_launcher
	...
	possibly_ammunition = list("Anti-Ship missile", "Swing High Pierce Shreder Rockets")
...
/datum/space_weapon_ammo/rail_gun
	...
	base_miss_chance = 35
	miss_sound = 'sound/effects/railgun_miss.ogg'
	hit_sound = 'sound/effects/railgunhit.ogg'
...
/datum/space_weapon_ammo/rocket_launcher
	...
	base_miss_chance = 15
	miss_sound = 'sound/effects/metal_shatter.ogg'
