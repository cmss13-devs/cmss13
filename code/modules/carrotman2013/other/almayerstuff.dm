...
//////SD effects////////
////////////////////////
/* Временно отключено, требуется дороботка и в обход создания бэкграунд прока, а так же требуется использовать правильный прок взрыва (explosion от старой системы, и более не используется, но вызывает новый с подстановкой одного из 3 значений)
*  Слишком часто используется sleep(), все это можно сделать в обход использования этого прока, апстрим и так много подарков спратял в коде... а еще и это.
