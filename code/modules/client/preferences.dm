...
/datum/preferences/proc/ShowChoices(mob/user)
	...
	switch(current_menu)
		...
		if(MENU_SETTINGS)
			...
			dat += "<b>Play Announcement Sounds As Observer:</b> <a href='?_src_=prefs;preference=hear_observer_announcements'><b>[(toggles_sound & SOUND_OBSERVER_ANNOUNCEMENTS) ? "Yes" : "No"]</b></a><br>"
