...
/datum/preferences
	...
	var/list/volume_preferences = list(1, 0.5, 1, 0.6) // Game, music, admin midis, lobby music, human voices, xeno voices (this is also set in sanitize_volume_preferences() call)
