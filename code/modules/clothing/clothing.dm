...
/obj/item/clothing/suit
	...
	valid_accessory_slots = list(
		...
		ACCESSORY_SLOT_RANK, ACCESSORY_SLOT_DECOR,
		ACCESSORY_SLOT_PONCHO, ACCESSORY_SLOT_MASK,
		ACCESSORY_SLOT_ARMBAND, ACCESSORY_SLOT_ARMOR_A,
		ACCESSORY_SLOT_ARMOR_L, ACCESSORY_SLOT_ARMOR_S,
		ACCESSORY_SLOT_ARMOR_M, ACCESSORY_SLOT_UTILITY,
