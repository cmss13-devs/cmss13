...
GLOBAL_LIST_INIT(allowed_helmet_items, list(
	...
	/obj/item/clothing/accessory/patch/falcon/squad/delta = NO_GARB_OVERRIDE,
	/obj/item/clothing/accessory/patch/falcon/squad/echo = NO_GARB_OVERRIDE,
	/obj/item/clothing/accessory/patch/falcon/squad/foxtrot = NO_GARB_OVERRIDE,
