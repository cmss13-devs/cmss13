...
/obj/item/clothing/suit/storage/marine/MP/WO
	...
	armor_bullet = CLOTHING_ARMOR_HIGH // Head of security should be able to survive a nurse with a pistol
	armor_laser = CLOTHING_ARMOR_LOW
	armor_energy = CLOTHING_ARMOR_LOW
	armor_bomb = CLOTHING_ARMOR_MEDIUM
	armor_bio = CLOTHING_ARMOR_MEDIUMLOW
...
/obj/item/clothing/suit/storage/marine/MP/CO
	...
	armor_melee = CLOTHING_ARMOR_MEDIUMHIGH //added because of the base MP armor nerf
	armor_bullet = CLOTHING_ARMOR_HIGH
	storage_slots = 3
