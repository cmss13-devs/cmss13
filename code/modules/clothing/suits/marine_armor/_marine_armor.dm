...
/obj/item/clothing/suit/storage/marine/MP/WO
	name = "\improper M3 pattern chief of military police armor"
	desc = "A well-crafted suit of M3 Pattern Armor typically distributed to Chief of Military Polices. Useful for letting your men know who is in charge."
	icon_state = "warrant_officer"
	uniform_restricted = list(/obj/item/clothing/under/marine/officer/warrant)
	flags_bodypart_hidden = BODY_FLAG_CHEST|BODY_FLAG_LEGS
	specialty = "M3 pattern chief of military police"
