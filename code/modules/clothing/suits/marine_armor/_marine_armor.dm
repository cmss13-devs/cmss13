...
/obj/item/clothing/suit/storage/marine/caustic
	...
	desc = "A lightweight piece of XM3-CL ANCW armor. It has incredibly soft cushioning on the inside, thanks to the gel pads. A truck could hit you and you be fine in this."
	desc_lore = "An Experimental Model of Anti-Caustic Ligth armormend, or XM-CL, developed against the Xenomporh threat by the USMC and WY. Based on the Model 3 Ligth Armor, this armor system has been modified to allow soldiers to perform unrestricted in battle. It uses CN-Gel to neutalize even the heaviest of xenomoprh acidcs, turning their PH level to 7, wich then glide rigth of the superhydrophobic surface of the armor plates. Its insides are lined with a combination of fiber and gel cushioning, serving as a storage for the CN-Gel, and to protect the user of heavy impacts. CN-Gel also serves as a great insulator, protecting the user from from the harshest of colds, to the blazing sun. Allowing the user to perform in any enviorment. The weigth of the internal systems required the XM3-CL Armor to be striped down tremendously, barley leaving room for any form of protection against projectiles. Making it unsuitable for combat against human combatance. The biological functions of XX-121 revealed to WY and USMC scientist anti caustic propertys in their bodily fluids and allowed them to creat a version of the gel to use xenomorph XX-121 biomatter, primarily their saliva, as a base for a Compound Neutralizing Gel, or CN-Gel. Resulting in a clear, thermoinsulating, thick, and overall economic gel. The Gel itself expands greatly when oxidized though the internal nozzles, allowing a XM3-CL Armor system to be fully operational for weeks before needing to be refilled."
	icon = 'icons/obj/items/clothing/cm_suits.dmi'
