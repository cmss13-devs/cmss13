...
/obj/item/clothing/suit/storage/marine/veteran/pmc/wy_droid
	name = "\improper M7X Ape Suit"
	desc = "The Latest in the line of Ape suits from Weyland Yutani, designed for use by combat droids, it's more compact and mobile then the original allowing for more mobility."
