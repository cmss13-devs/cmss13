...
/obj/item/clothing/under/marine/officer/warrant
	name = "\improper chief of military police uniform"
	desc = "A uniform typically worn by a Chief of Military Police of the USCM. It has shards of light Kevlar to help protect against stabbing weapons, bullets, and shrapnel from explosions. This uniform includes a small EMF distributor to help nullify energy-based weapon fire, along with a hazmat chemical filter woven throughout the material to ward off biological and radiation hazards."
	...
	flags_jumpsuit = FALSE
	specialty = "chief of military police"
