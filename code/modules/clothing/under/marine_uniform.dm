...
/obj/item/clothing/under/marine/officer/command/captain
	name = "captain uniform"
	desc = "The well-ironed uniform of a USCM captain. Even looking at it the wrong way could result in being court-marshalled. It has shards of light Kevlar to help protect against stabbing weapons, bullets, and shrapnel from explosions, a small EMF distributor to help null energy-based weapons, and a hazmat chemical filter weave to ward off biological and radiation hazards."
