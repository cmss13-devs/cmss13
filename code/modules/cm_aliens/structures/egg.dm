...
/obj/effect/alien/egg/proc/Burst(kill = TRUE, var/instant_trigger = FALSE, var/mob/living/carbon/Xenomorph/X = null) //drops and kills the hugger if any is remaining
...
/obj/effect/alien/egg/proc/release_hugger(instant_trigger, mob/living/carbon/Xenomorph/X)
