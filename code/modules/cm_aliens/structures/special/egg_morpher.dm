...
/obj/effect/alien/resin/special/eggmorph/get_examine_text(mob/user)
	...
	if(isobserver(user))
		...
		. += "There are currently [SPAN_NOTICE("[current_hugger_count]")] facehuggers in the hive. The hive can support a total of [SPAN_NOTICE("[linked_hive.playable_hugger_limit]")] facehuggers."
