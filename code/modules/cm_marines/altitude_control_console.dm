...
/obj/structure/machinery/computer/altitude_control_console/process()
	...
	if(GLOB.ship_temp >= OVERHEAT)
		ai_silent_announcement("Attention: orbital correction no longer sustainable, moving to geo-synchronous orbit until engine cooloff.", ";")
		...
		ai_silent_announcement("Attention performing high-G maneuverer", ";")
	...
	if(GLOB.ship_alt == SHIP_ALT_LOW)
		...
		ai_silent_announcement("Performing Attitude Control", ";")
