...
/proc/structure/dropship_equipment/electronics/landing_zone_detector/connect_cameras()
...
/proc/structure/dropship_equipment/electronics/landing_zone_detector/disconnect_cameras()
	if(!linked_cam_console)
		return
