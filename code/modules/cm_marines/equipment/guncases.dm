...
/obj/item/storage/box/guncase/pumpshotgun
	name = "\improper M37A4 Pump Shotgun case"
	desc = "A gun case containing the M37A4 Pump Shotgun."
	storage_slots = 4
	can_hold = list(/obj/item/weapon/gun/shotgun/pump/m37a4, /obj/item/ammo_magazine/shotgun/buckshot, /obj/item/ammo_magazine/shotgun/flechette, /obj/item/ammo_magazine/shotgun/slugs)
