...
/obj/item/storage/box/guncase/flamer
	...
	storage_slots = 6
	can_hold = list(/obj/item/weapon/gun/flamer, /obj/item/ammo_magazine/flamer_tank, /obj/item/attachable/attached_gun/extinguisher, /obj/item/storage/pouch/flamertank)
