...
/obj/item/storage/box/spec/mortar/fill_preset_inventory()
	...
	new /obj/item/mortar_shell/he(src)
	new /obj/item/mortar_shell/he(src)
	//random T2 shell to start off with, so players gain familiarity if req doesn't buy it for them.
	switch(rand(1,3))
		if(1)
			new /obj/item/mortar_shell/heplus(src)
		if(2)
			new /obj/item/mortar_shell/incendiary/pierce(src)
		if(3)
			new /obj/item/mortar_shell/incendiary/thermobaric(src)
