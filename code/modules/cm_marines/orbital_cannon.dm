...
/obj/structure/ob_ammo/warhead/proc/warhead_impact(turf/target)
	...
	message_admins(FONT_SIZE_XL("<A HREF='?_src_=player_data.admin_holder;[HrefToken(forceGlobal = TRUE)];admincancelob=1;cancellation=[cancellation_token]'>CLICK TO CANCEL THIS OB</a>"))
