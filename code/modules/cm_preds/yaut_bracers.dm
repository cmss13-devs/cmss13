...
/obj/item/clothing/gloves/yautja/hunter/proc/explode(mob/living/carbon/victim)
	...
	message_admins(FONT_SIZE_XL("<A HREF='?_src_=player_data?.admin_holder;[HrefToken(forceGlobal = TRUE)];admincancelpredsd=1;bracer=\ref[src];victim=\ref[victim]'>CLICK TO CANCEL THIS PRED SD</a>"))
