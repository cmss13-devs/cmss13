...
/mob/living/carbon/human/proc/pred_buy()
	...
	switch(main_weapon)
		...
		if(YAUTJA_GEAR_CLUB)
			equip_to_slot_if_possible(new /obj/item/weapon/melee/yautja/club(src.loc), WEAR_J_STORE, disable_warning = TRUE)
