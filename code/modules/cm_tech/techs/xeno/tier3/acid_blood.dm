...
/datum/tech/xeno/acidic_blood/proc/register_component(datum/source, mob/living/carbon/Xenomorph/X)
	SIGNAL_HANDLER
	if(X.hivenumber == hivenumber)
		RegisterSignal(X, COMSIG_XENO_DEAL_ACID_DAMAGE, .proc/handle_acid_blood)

/datum/tech/xeno/acidic_blood/proc/handle_acid_blood(mob/living/carbon/Xenomorph/X, mob/target, list/damage)
	SIGNAL_HANDLER
