...
/datum/event/rogue_drone/announce()
	...
	marine_announcement(msg, "Rogue drone alert")
...
/datum/event/rogue_drone/end()
	...
	if(num_recovered > drones_list.len * 0.75)
		marine_announcement("Icarus drone control reports the malfunctioning wing has been recovered safely.", "Rogue drone alert")
	else
		marine_announcement("Icarus drone control registers disappointment at the loss of the drones, but the survivors have been recovered.", "Rogue drone alert")
