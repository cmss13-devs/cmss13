...
/datum/equipment_preset/proc/spawn_random_rmc_headgear(mob/living/carbon/human/new_human)
	var/random_hat = rand(1,10)
	switch(random_hat)
		if (1, 2)
			new_human.equip_to_slot_or_del(new /obj/item/clothing/head/helmet/marine/veteran/royal_marine(new_human), WEAR_HEAD)
		if (3, 4, 5)
		...
		if (8, 9)
			new_human.equip_to_slot_or_del(new /obj/item/clothing/head/beanie/royal_marine/turban(new_human), WEAR_HEAD)
