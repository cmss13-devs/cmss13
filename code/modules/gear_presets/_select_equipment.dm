...
/datum/equipment_preset/proc/load_preset(mob/living/carbon/human/H, randomise = FALSE, var/count_participant = FALSE, var/client/mob_client)
...
/datum/equipment_preset/proc/spawn_rebel_weapon(atom/M, sidearm = 0, var/ammo_amount = 12)
	if(!M) return
...
/datum/equipment_preset/proc/spawn_merc_weapon(atom/M, sidearm = 0, var/ammo_amount = 12)
	if(!M) return
...
/datum/equipment_preset/proc/spawn_merc_elite_weapon(atom/M, ammo_amount = 12, var/shotgun_chance = 50, var/spawn_belt = 1)
	if(!M) return
...
/datum/equipment_preset/proc/spawn_weapon(gunpath, ammopath, atom/M, sidearm = 0, var/ammo_amount = 12)
...
/datum/equipment_preset/proc/add_random_synth_survivor_equipment(mob/living/carbon/human/H)
