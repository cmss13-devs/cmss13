...
/datum/equipment_preset/proc/add_random_prison_survivor_armor(var/mob/living/carbon/human/H) // Random set of armor a prisioner might repurpose in the event of a breakout
	...
	switch(random_weapon)
		...
		if(1)
			H.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/vest/security(H.back), WEAR_JACKET)
		if(2)
			H.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/bulletproof(H.back), WEAR_JACKET)
		if(3)
			H.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/bulletproof/badge(H.back), WEAR_JACKET)
		if(4)
			H.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/vest(H.back), WEAR_JACKET)
