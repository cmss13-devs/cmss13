...
/datum/equipment_preset/proc/load_upp_shotgun(mob/living/carbon/human/new_human)
	...
	switch(random_shotgun)
		if(1)
			...
			new_human.equip_to_slot_or_del(new /obj/item/storage/pouch/shotgun/large/heavybuck, WEAR_R_STORE)
		if(2)
			new_human.equip_to_slot_or_del(new /obj/item/weapon/gun/shotgun/type23/breacher/slug, WEAR_J_STORE)
			new_human.equip_to_slot_or_del(new /obj/item/storage/pouch/shotgun/large/heavyslug, WEAR_R_STORE)
		if(3)
			new_human.equip_to_slot_or_del(new /obj/item/weapon/gun/shotgun/type23/breacher/flechette, WEAR_J_STORE)
			new_human.equip_to_slot_or_del(new /obj/item/storage/pouch/shotgun/large/heavyflechette, WEAR_R_STORE)
