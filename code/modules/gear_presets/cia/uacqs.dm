...
/datum/equipment_preset/cia/uacqs
	...
	paygrades = list(PAY_SHORT_CIA_ADM = JOB_PLAYTIME_TIER_0, PAY_SHORT_CIA_SADM = JOB_PLAYTIME_TIER_2)
	...
	var/belt_path = /obj/item/storage/backpack/general_belt
	var/glasses_path = /obj/item/clothing/glasses/sunglasses/antag
...
/datum/equipment_preset/cia/uacqs/load_gear(mob/living/carbon/human/new_human, client/mob_client)
	...
	new_human.equip_to_slot_or_del(new belt_path, WEAR_WAIST)
...
/datum/equipment_preset/cia/uacqs/commissioner
	...
	glasses_path = /obj/item/clothing/glasses/hud/health/antag_sunglasses
...
/datum/equipment_preset/cia/uacqs/security
	...
	belt_path = /obj/item/storage/belt/gun/m4a3/m4a4_tactical
...
/datum/equipment_preset/cia/uacqs/security/medic
	name = "CIA Agent (UACQS Security Medic)"
	job_title = JOB_CIA_UACQS_SECM
	assignment = JOB_CIA_UACQS_SECM
	paygrades = list(PAY_SHORT_CIA_MO = JOB_PLAYTIME_TIER_0)
	minimap_icon = "uacqs_s"
	skills = /datum/skills/cia/security_officer/medic
	belt_path = /obj/item/storage/belt/medical/full/with_defib_and_analyzer
	glasses_path = /obj/item/clothing/glasses/hud/health/antag_sunglasses
...
/datum/equipment_preset/cia/uacqs/synth
	name = "CIA Synthetic (UACQS)"
	job_title = JOB_CIA_UACQS_SYN
	assignment = JOB_CIA_UACQS_SYN
	paygrades = list(PAY_SHORT_SYN = JOB_PLAYTIME_TIER_0)
	role_comm_title = "UACQS"
	minimap_icon = "uacqs"
	minimap_background = "background_ua"
	skills = /datum/skills/synthetic/antag
	headset_type = /obj/item/device/radio/headset/almayer/cia/uacqs

/datum/equipment_preset/cia/uacqs/synth/load_gear(mob/living/carbon/human/new_human, client/mob_client)
	//Give them a random piece of civvie clothing.
	var/random_outfit = pick(
		/obj/item/clothing/under/liaison_suit/black,
		/obj/item/clothing/under/liaison_suit/brown,
	...
	new_human.equip_to_slot_or_del(new /obj/item/storage/backpack/satchel/lockable/liaison(new_human), WEAR_BACK)
	new_human.equip_to_slot_or_del(new /obj/item/storage/pouch/general/large(new_human), WEAR_R_STORE)
	new_human.equip_to_slot_or_del(new /obj/item/device/binoculars(new_human), WEAR_IN_R_STORE)
