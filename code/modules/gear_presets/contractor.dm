...
/datum/equipment_preset/contractor/duty/standard
	...
	paygrades = list(PAY_SHORT_VAI_S = JOB_PLAYTIME_TIER_1)
...
/datum/equipment_preset/contractor/duty/heavy
	...
	paygrades = list(PAY_SHORT_VAI_G = JOB_PLAYTIME_TIER_1)
	role_comm_title = "MG"
	flags = EQUIPMENT_PRESET_EXTRA
...
/datum/equipment_preset/contractor/duty/engi
	...
	paygrades = list(PAY_SHORT_VAI_E = JOB_PLAYTIME_TIER_1)
...
/datum/equipment_preset/contractor/duty/medic
	...
	paygrades = list(PAY_SHORT_VAI_M = JOB_PLAYTIME_TIER_1)
	role_comm_title = "Med"
	flags = EQUIPMENT_PRESET_EXTRA
...
/datum/equipment_preset/contractor/duty/leader
	...
	paygrades = list(PAY_SHORT_VAI_L = JOB_PLAYTIME_TIER_1)
	role_comm_title = "TL"
	flags = EQUIPMENT_PRESET_EXTRA
...
/datum/equipment_preset/contractor/duty/synth
	...
	paygrades = list(PAY_SHORT_VAI_SN = JOB_PLAYTIME_TIER_1)
	role_comm_title = "Syn"
	flags = EQUIPMENT_PRESET_EXTRA
