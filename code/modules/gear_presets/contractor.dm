...
/datum/equipment_preset/contractor/covert
...
/datum/equipment_preset/contractor/covert/New()
	. = ..()
	access = get_antagonist_pmc_access()
...
/datum/equipment_preset/contractor/covert/synth
	name = "Military Covert Contractor (Synthetic)"
	paygrade = "VASC Synthetic"
	flags = EQUIPMENT_PRESET_EXTRA
...
/datum/equipment_preset/contractor/covert/leader
	name = "Military Covert Contractor (Leader)"
	uses_special_name = TRUE
	paygrade = "VASC Mercenary Leader"
	flags = EQUIPMENT_PRESET_EXTRA

	idtype = /obj/item/card/id/data
	assignment = "VASC Covert Team Leader"
	rank = "Mercenary"
	skills = /datum/skills/contractor/covert/leader
	faction = FACTION_MARINE
...
/datum/equipment_preset/contractor/covert/engi
	name = "Military Covert Contractor (Engineer)"
	paygrade = "VASC Mercenary Engineer"
	flags = EQUIPMENT_PRESET_EXTRA

	idtype = /obj/item/card/id/data
	assignment = "VASC Covert Engineering Specialist"
	rank = "Mercenary"
	skills = /datum/skills/mercenary/elite/engineer
	faction = FACTION_MARINE
...
/datum/equipment_preset/contractor/covert/heavy
	name = "Military Covert Contractor (Machinegunner)"
	uses_special_name = TRUE
	paygrade = "VASC Mercenary Machinegunner"
	flags = EQUIPMENT_PRESET_EXTRA

	idtype = /obj/item/card/id/data
	assignment = "VASC Covert Machinegunner"
	rank = "Mercenary"
	skills = /datum/skills/contractor/heavy
	faction = FACTION_MARINE
...
/datum/equipment_preset/contractor/covert/heavy/load_gear(mob/living/carbon/human/H)
	H.equip_to_slot_or_del(new /obj/item/device/radio/headset/almayer/highcom, WEAR_L_EAR)
	H.equip_to_slot_or_del(new /obj/item/clothing/under/tshirt/ua_civvies, WEAR_BODY)
	H.equip_to_slot_or_del(new /obj/item/accessory/health/ceramic_plate, WEAR_ACCESSORY)
	H.equip_to_slot_or_del(new /obj/item/accessory/holobadge_cord, WEAR_ACCESSORY)
	H.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/marine/light/vest, WEAR_JACKET)
	H.equip_to_slot_or_del(new /obj/item/device/binoculars/range, WEAR_IN_JACKET)
