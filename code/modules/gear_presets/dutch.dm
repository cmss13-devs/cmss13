...
/datum/equipment_preset/dutch
	...
	paygrades = list(PAY_SHORT_DTC = JOB_PLAYTIME_TIER_1)
...
/datum/equipment_preset/dutch/minigun
	...
	paygrades = list(PAY_SHORT_DTCMG = JOB_PLAYTIME_TIER_1)
...
/datum/equipment_preset/dutch/flamer
	...
	paygrades = list(PAY_SHORT_DTCF = JOB_PLAYTIME_TIER_1)
...
/datum/equipment_preset/dutch/medic
	...
	paygrades = list(PAY_SHORT_DTCM = JOB_PLAYTIME_TIER_1)
...
/datum/equipment_preset/dutch/arnie
	...
	paygrades = list(PAY_SHORT_DTCA = JOB_PLAYTIME_TIER_1)
