...
/datum/equipment_preset/survivor/forecon/load_gear(mob/living/carbon/human/H)
	...
	var/obj/item/clothing/accessory/patch/uscm_patch = new()
	var/obj/item/clothing/accessory/patch/forecon/forecon_patch = new()
	uniform.attach_accessory(H,pouch)
	uniform.attach_accessory(H,uscm_patch)
	uniform.attach_accessory(H,forecon_patch)
