// SOF 107/RECON, operating alongside the CEC and UPP Ministries in the sector in developing and garrisoning colonies, mining centres and research facilities.

/datum/equipment_preset/survivor/upp/SOF_survivor_atlan
	name = "Survivor - Atlan UPP SOF"
...
/datum/equipment_preset/survivor/upp/SOF_survivor_atlan/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/survivor/upp/SOF_survivor_atlan/soldier
	name = "Survivor - Atlan UPP SOF Soldier"
...
/datum/equipment_preset/survivor/upp/SOF_survivor_atlan/soldier/load_gear(mob/living/carbon/human/new_human)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/under/marine/veteran/UPP/SOF_uniform(new_human), WEAR_BODY)
	new_human.equip_to_slot_or_del(new /obj/item/storage/pouch/flare/full(new_human), WEAR_R_STORE)
	..()
...
/datum/equipment_preset/survivor/upp/SOF_survivor_atlan/sapper
	name = "Survivor - Atlan UPP SOF Sapper"
...
/datum/equipment_preset/survivor/upp/SOF_survivor_atlan/sapper/load_gear(mob/living/carbon/human/new_human)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/under/marine/veteran/UPP/SOF_uniform(new_human), WEAR_BODY)
...
/datum/equipment_preset/survivor/upp/SOF_survivor_atlan/medic
	name = "Survivor - Atlan UPP SOF Medic"
	paygrades = list(PAY_SHORT_UE3 = JOB_PLAYTIME_TIER_0)
...
/datum/equipment_preset/survivor/upp/SOF_survivor_atlan/medic/load_gear(mob/living/carbon/human/new_human)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/under/marine/veteran/UPP/SOF_uniform(new_human), WEAR_BODY)
...
/datum/equipment_preset/survivor/upp/SOF_survivor_atlan/specialist
	name = "Survivor - Atlan UPP SOF Specialist"
...
/datum/equipment_preset/survivor/upp/SOF_survivor_atlan/specialist/load_gear(mob/living/carbon/human/new_human)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/under/marine/veteran/UPP/SOF_uniform(new_human), WEAR_BODY)
...
/datum/equipment_preset/survivor/upp/SOF_survivor_atlan/squad_leader
	name = "Survivor - Atlan UPP SOF Squad Leader"
...
/datum/equipment_preset/survivor/upp/SOF_survivor_atlan/squad_leader/load_gear(mob/living/carbon/human/new_human)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/under/marine/veteran/UPP/SOF_uniform(new_human), WEAR_BODY)
...
/datum/equipment_preset/synth/survivor/upp/SOF_synth_atlan
	name = "Survivor - Synthetic - Atlan UPP SOF Synth"
...
/datum/equipment_preset/synth/survivor/upp/SOF_synth_atlan/load_gear(mob/living/carbon/human/new_human)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/under/marine/veteran/UPP/SOF_uniform(new_human), WEAR_BODY)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/head/beret/SOF_beret(new_human), WEAR_HEAD)
