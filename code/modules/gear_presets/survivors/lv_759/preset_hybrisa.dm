...
/datum/equipment_preset/survivor/hybrisa/kelland_miner/load_gear(mob/living/carbon/human/new_human)
	...
	switch(random_gear)
		...
		if(80 to 85)
			...
			new_human.equip_to_slot_or_del(new /obj/item/weapon/gun/smg/p90_twe, WEAR_L_HAND)
			new_human.equip_to_slot_or_del(new /obj/item/storage/pouch/magazine, WEAR_R_STORE)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/p90_twe, WEAR_IN_R_STORE)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/p90_twe, WEAR_IN_R_STORE)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/p90_twe, WEAR_IN_R_STORE)
	add_survivor_weapon_civilian(new_human)
	..()
