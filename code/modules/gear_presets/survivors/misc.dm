...
/datum/equipment_preset/survivor/civilian_unique/load_gear(mob/living/carbon/human/new_human)
	...
	switch(random_gear)
		...
		if(5) // Butcher
			...
			new_human.equip_to_slot_or_del(new /obj/item/tool/kitchen/knife/butcher(new_human), WEAR_IN_BACK)
		...
		if(9) // Private Detective
			...
			new_human.equip_to_slot_or_del(new /obj/item/clothing/under/suit_jacket/tan, WEAR_BODY)
			...
			new_human.equip_to_slot_or_del(new /obj/item/clothing/shoes/leather, WEAR_FEET)
		...
		if(11) // High roller
			...
			new_human.equip_to_slot_or_del(new /obj/item/clothing/under/suit_jacket/checkered, WEAR_BODY)
			new_human.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/jacket/marine/lawyer/brown, WEAR_JACKET)
			...
			new_human.equip_to_slot_or_del(new /obj/item/toy/deck, WEAR_IN_R_STORE)
			new_human.equip_to_slot_or_del(new /obj/item/toy/dice, WEAR_IN_R_STORE)
			new_human.equip_to_slot_or_del(new /obj/item/storage/fancy/cigar/tarbacktube, WEAR_IN_R_STORE)
		if(12) // Prepper
		...
		if(13) // Mad Scientist
			...
			new_human.equip_to_slot_or_del(new /obj/item/reagent_container/hypospray/autoinjector/emergency(new_human), WEAR_IN_R_STORE)
			new_human.equip_to_slot_or_del(new /obj/item/reagent_container/hypospray/autoinjector/emergency(new_human), WEAR_IN_R_STORE)
			new_human.equip_to_slot_or_del(new /obj/item/pamphlet/skill/science, WEAR_IN_BACK)
		if(14) // Cameraman
