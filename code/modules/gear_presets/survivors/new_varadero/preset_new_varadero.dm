...
/datum/equipment_preset/survivor/new_varadero/firefighter
	name = "Survivor - Airport Firefighter (med)"
...
/datum/equipment_preset/survivor/new_varadero/firefighter/load_gear(mob/living/carbon/human/new_human)
	...
	new_human.equip_to_slot_or_del(new /obj/item/clothing/mask/surgical(new_human), WEAR_FACE)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/suit/fire(new_human), WEAR_JACKET)
	...
	switch(choice)
		if(1 to 20)
			...
			new_human.equip_to_slot_or_del(new /obj/item/clothing/head/hardhat/red(new_human), WEAR_HEAD)
