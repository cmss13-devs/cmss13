...
/datum/equipment_preset/survivor/army/proc/spawn_pouch(mob/living/carbon/human/new_human)
	...
	switch(i)
		if (1)
			...
			new_human.equip_to_slot_or_del(new /obj/item/reagent_container/hypospray/autoinjector/standard/tricordrazine/random_amount(new_human), WEAR_IN_R_STORE)
			...
			new_human.equip_to_slot_or_del(new /obj/item/reagent_container/hypospray/autoinjector/standard/kelotane/random_amount(new_human), WEAR_IN_L_STORE)
