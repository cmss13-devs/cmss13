...
/datum/equipment_preset/uscm_event/dress/nco/snco
	...
	paygrades = list(PAY_SHORT_ME6 = JOB_PLAYTIME_TIER_1)
...
/datum/equipment_preset/uscm_event/dress/officer/firstlt
	...
	paygrades = list(PAY_SHORT_MO2 = JOB_PLAYTIME_TIER_1)
