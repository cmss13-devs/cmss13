...
/datum/equipment_preset/uscm_ship/uscm_medical/doctor
	...
	utility_under = list(/obj/item/clothing/under/rank/medical)
...
/datum/equipment_preset/uscm_ship/uscm_medical/surgeon
	name = "USCM Surgeon"
	flags = EQUIPMENT_PRESET_START_OF_ROUND|EQUIPMENT_PRESET_MARINE
...
/datum/equipment_preset/uscm_ship/uscm_medical/surgeon/load_gear(mob/living/carbon/human/H)
	var/backItem = /obj/item/storage/backpack/marine/satchel
	if (H.client && H.client.prefs && (H.client.prefs.backbag == 1))
		backItem = /obj/item/storage/backpack/marine
