...
/datum/equipment_preset/uscm_ship/so
	...
	idtype = /obj/item/card/id/silver
	access = list(ACCESS_MARINE_COMMANDER, ACCESS_MARINE_BRIDGE, ACCESS_MARINE_BRIG, ACCESS_MARINE_DROPSHIP, ACCESS_MARINE_LOGISTICS, ACCESS_MARINE_CARGO, ACCESS_MARINE_PREP, ACCESS_MARINE_MEDBAY)
	assignment = JOB_SO
	rank = JOB_SO
	paygrade = "MO1"
	role_comm_title = "SO"
