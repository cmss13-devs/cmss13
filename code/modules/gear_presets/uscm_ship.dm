...
/datum/equipment_preset/uscm_ship/chief_engineer
	...
	idtype = /obj/item/card/id/silver
	access = list(ACCESS_IFF_MARINE, ACCESS_MARINE_CE, ACCESS_MARINE_ENGINEERING, ACCESS_MARINE_BRIDGE, ACCESS_CIVILIAN_ENGINEERING, ACCESS_MARINE_COMMANDER)
...
/datum/equipment_preset/uscm_ship/ro
	...
	idtype = /obj/item/card/id/silver
	access = list(ACCESS_IFF_MARINE, ACCESS_MARINE_CARGO, ACCESS_MARINE_RO, ACCESS_MARINE_BRIDGE, ACCESS_MARINE_TANK, ACCESS_MARINE_BRIDGE, ACCESS_MARINE_LOGISTICS, ACCESS_MARINE_COMMANDER)
...
/datum/equipment_preset/uscm_ship/mp
	...
	access = list(ACCESS_IFF_MARINE, ACCESS_MARINE_BRIG, ACCESS_MARINE_BRIDGE, ACCESS_MARINE_DROPSHIP, ACCESS_MARINE_LOGISTICS, ACCESS_MARINE_PREP, ACCESS_MARINE_MEDBAY, ACCESS_MARINE_TANK)
...
/datum/equipment_preset/uscm_ship/cmp
	...
	access = list(ACCESS_IFF_MARINE, ACCESS_MARINE_BRIG, ACCESS_MARINE_BRIDGE, ACCESS_MARINE_DROPSHIP, ACCESS_MARINE_LOGISTICS, ACCESS_MARINE_PREP, ACCESS_MARINE_WO, ACCESS_MARINE_MEDBAY, ACCESS_MARINE_TANK, ACCESS_MARINE_COMMANDER)
	assignment = "Chief MP"
	rank = "Chief MP"
	paygrade = "O3"
	role_comm_title = "CMP"
...
/datum/equipment_preset/uscm_ship/officer
	...
	access = list(ACCESS_IFF_MARINE, ACCESS_MARINE_MEDBAY, ACCESS_MARINE_CHEMISTRY, ACCESS_MARINE_TANK)
