...
/datum/equipment_preset/uscm_ship/ro
	...
	idtype = /obj/item/card/id/silver
	access = list(ACCESS_IFF_MARINE, ACCESS_MARINE_CARGO, ACCESS_MARINE_RO, ACCESS_MARINE_BRIDGE, ACCESS_MARINE_TANK, ACCESS_MARINE_BRIDGE, ACCESS_MARINE_LOGISTICS, ACCESS_MARINE_COMMANDER, ACCESS_MARINE_ALPHA, ACCESS_MARINE_BRAVO, ACCESS_MARINE_CHARLIE, ACCESS_MARINE_DELTA, ACCESS_MARINE_PREP)
...
/datum/equipment_preset/uscm_ship/officer
	...
	access = list(ACCESS_IFF_MARINE, ACCESS_MARINE_MEDBAY, ACCESS_MARINE_CHEMISTRY, ACCESS_MARINE_TANK, ACCESS_MARINE_MORGUE)
