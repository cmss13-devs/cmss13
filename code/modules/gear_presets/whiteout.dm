...
/datum/equipment_preset/pmc/w_y_whiteout/medic
	name = "Whiteout Team Supporting Unit (!DEATHSQUAD!)"
	flags = EQUIPMENT_PRESET_EXTRA
	assignment = "Whiteout Team Supporting Unit"
...
/datum/equipment_preset/pmc/w_y_whiteout/cloaker/load_gear(mob/living/carbon/human/new_human)
	...
	//pockets
	new_human.equip_to_slot_or_del(new /obj/item/storage/pouch/magazine/large/pmc_sniper, WEAR_R_STORE)
...
/datum/equipment_preset/pmc/w_y_whiteout/low_threat/medic
	name = "Whiteout Team Supporting Unit"
	minimap_background = "background_ua"
	role_comm_title = "WO-SUP"
	assignment = JOB_DS_SUP
	rank = JOB_DS_SUP
