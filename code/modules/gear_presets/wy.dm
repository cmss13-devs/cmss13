/datum/equipment_preset/wy
	name = "WY"
	paygrades = list(PAY_SHORT_WYC1 = JOB_PLAYTIME_TIER_1)
...
/datum/equipment_preset/wy/junior_exec
	...
	paygrades = list(PAY_SHORT_WYC2 = JOB_PLAYTIME_TIER_1)
...
/datum/equipment_preset/wy/exec
	...
	rank = JOB_EXECUTIVE
	paygrades = list(PAY_SHORT_WYC3 = JOB_PLAYTIME_TIER_1)
...
/datum/equipment_preset/wy/senior_exec
	...
	paygrades = list(PAY_SHORT_WYC4 = JOB_PLAYTIME_TIER_1)
...
/datum/equipment_preset/wy/manager/assistant_manager
	...
	paygrades = list(PAY_SHORT_WYC7 = JOB_PLAYTIME_TIER_1)
...
/datum/equipment_preset/wy/manager/division_manager
	...
	paygrades = list(PAY_SHORT_WYC8 = JOB_PLAYTIME_TIER_1)
...
/datum/equipment_preset/wy/manager/chief_executive
	...
	paygrades = list(PAY_SHORT_WYC9 = JOB_PLAYTIME_TIER_1)
...
/datum/equipment_preset/wy/manager/director
	...
	rank = JOB_DIRECTOR
	paygrades = list(PAY_SHORT_WYC10 = JOB_PLAYTIME_TIER_1)
