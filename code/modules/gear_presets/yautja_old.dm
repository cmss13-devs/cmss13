...
/datum/equipment_preset/yautja/blooded/load_gear(mob/living/carbon/human/H)
	...
	H.equip_to_slot_or_del(new /obj/item/clothing/shoes/yautja/knife(H, boot_number), WEAR_FEET)
...
/datum/equipment_preset/yautja/warrior/load_gear(mob/living/carbon/human/H)
	...
	verbs += /obj/item/clothing/gloves/yautja/proc/translate
	bracer.upgrades = 1
	...
	H.equip_to_slot_or_del(new /obj/item/clothing/shoes/yautja/knife(H), WEAR_FEET)
	H.equip_to_slot_or_del(new /obj/item/device/radio/headset/yautja(H), WEAR_L_EAR)
