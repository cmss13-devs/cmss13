...
/proc/draw_tacmap_units(icon/tacmap, tacmap_type = TACMAP_DEFAULT, var/additional_parameter = null)
	switch(tacmap_type)
		if(TACMAP_DEFAULT)
			draw_marines(tacmap)
...
/proc/draw_xenos(icon/tacmap, human_pov = TRUE, var/use_vehicle = TRUE, var/hivenumber = null)
...
/proc/overlay_tacmap(map_string = TACMAP_DEFAULT, var/map_type = TACMAP_BASE_OCCLUDED, var/additional_parameter = null)
