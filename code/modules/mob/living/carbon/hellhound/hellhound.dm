...
/mob/living/carbon/hellhound/proc/bite_human(var/mob/living/carbon/human/H)
	...
	if(a_intent == INTENT_HELP)
		...
		var/dmg = rand(10,25)
		H.apply_damage(dmg,BRUTE, int_dmg_multiplier = INT_DMG_MULTIPLIER_SHARP) //Does NOT check armor.
...
/mob/living/carbon/hellhound/proc/bite_xeno(var/mob/living/carbon/Xenomorph/X)
	...
	if(a_intent == INTENT_HELP)
		...
		var/dmg = rand(20,32)
		X.apply_damage(dmg,BRUTE, INT_DMG_MULTIPLIER_SHARP) //Does NOT check armor.
