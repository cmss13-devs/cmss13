/mob/living/carbon/human/emote(var/act,var/m_type=1,var/message = null, player_caused)
	...
	switch(act)
		...
		if("scream")
			...
			var/datum/language/L = get_default_language()
			if(istype(L))
				langchat_say(L.name, pick("FUCK!!!", "AGH!!!", "ARGH!!!", "AAAA!!!", "HGH!!!"), list("langchat_yell"), LANGCHAT_FAST_POP)
		...
		if("warcry")
			...
			var/datum/language/L = get_default_language()
			if(istype(L))
				langchat_say(L.name, pick("CHARGE!!!", "ATTACK!!!", "GO!!!", "MOVE!!!", "NO QUARTER!!!"), list("langchat_yell"), LANGCHAT_FAST_POP)
