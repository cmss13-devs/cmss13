/datum/emote/living/carbon/human/synthetic/engi_joe/quip
	category = ENGI_JOE_EMOTE_CATEGORY_QUIP

/datum/emote/living/carbon/human/synthetic/engi_joe/quip/temperatures
	key = "temperatures"
	sound = 'sound/voice/hazjoe/temperatures.ogg'
	say_message = "I am built to withstand temperatures of up to 1210 degrees."
	emote_type = EMOTE_AUDIBLE|EMOTE_VISIBLE

/datum/emote/living/carbon/human/synthetic/engi_joe/quip/weapon_permit
	key = "weaponpermit"
	sound = 'sound/voice/hazjoe/weapon_permit.ogg'
	say_message = "I assume you have a permit for that weapon."
	emote_type = EMOTE_AUDIBLE|EMOTE_VISIBLE

/datum/emote/living/carbon/human/synthetic/engi_joe/quip/awful_mess
	key = "awful"
...
/datum/emote/living/carbon/human/synthetic/engi_joe/quip/alwaysknow
	key = "alwaysknow"
...
/datum/emote/living/carbon/human/synthetic/engi_joe/quip/tomorrow_together
