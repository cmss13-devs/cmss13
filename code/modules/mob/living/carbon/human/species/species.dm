...
/datum/species/proc/handle_blood_splatter(mob/living/carbon/human/human, splatter_dir, splatter_angle)
	var/color_override
	...
	var/obj/effect/temp_visual/dir_setting/bloodsplatter/bloodsplatter = new bloodsplatter_type(human.loc, splatter_dir, splatter_angle, 5, color_override)
