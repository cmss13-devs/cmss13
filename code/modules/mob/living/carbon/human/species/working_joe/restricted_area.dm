...
/datum/emote/living/carbon/human/synthetic/working_joe/restricted_area/presence_logged
	key = "presencelogged"
	sound = 'sound/voice/synth/joe/presence_logged.ogg'
	haz_sound = 'sound/voice/synth/joe/presence_logged_haz.ogg'
...
/datum/emote/living/carbon/human/synthetic/working_joe/restricted_area/trespassing
	key = "trespassing"
	sound = 'sound/voice/synth/joe/trespassing.ogg'
	say_message = "You are trespassing."
	emote_type = EMOTE_AUDIBLE|EMOTE_VISIBLE

/datum/emote/living/carbon/human/synthetic/working_joe/restricted_area/not_allowed_there
	key = "notallowedthere"
	sound = 'sound/voice/synth/joe/not_allowed_there.ogg'
	haz_sound = 'sound/voice/synth/joe/not_allowed_there_haz.ogg'
	upp_joe_sound = 'sound/voice/synth/joe/upp_joe/vamsyduanelza.ogg'
...
/datum/emote/living/carbon/human/synthetic/working_joe/restricted_area/shouldnt_be_here
	key = "shouldntbehere"
	sound = 'sound/voice/synth/joe/shouldnt_be_here.ogg'
...
/datum/emote/living/carbon/human/synthetic/working_joe/restricted_area/really_shouldnt_be_here
	...
	sound = 'sound/voice/synth/joe/really_shouldnt_be_here.ogg'
	haz_sound = 'sound/voice/synth/joe/really_shouldnt_be_here_haz.ogg'
...
/datum/emote/living/carbon/human/synthetic/working_joe/restricted_area/this_shouldnt_be_here
	key = "thishouldbehere"
	sound = 'sound/voice/synth/joe/this_shouldnt_be_here.ogg'
	haz_sound = 'sound/voice/synth/joe/this_shouldnt_be_here_haz.ogg'
...
/datum/emote/living/carbon/human/synthetic/working_joe/restricted_area/interloper
	key = "interloper"
	sound = 'sound/voice/synth/joe/interloper.ogg'
	haz_sound = 'sound/voice/synth/joe/interloper_haz.ogg'
...
/datum/emote/living/carbon/human/synthetic/working_joe/restricted_area/area_restricted
	key = "arearestrict"
	haz_sound = 'sound/voice/synth/joe/area_restricted_haz.ogg'
...
/datum/emote/living/carbon/human/synthetic/working_joe/restricted_area/protected_area_compromised
	key = "areacompromised"
	sound = 'sound/voice/synth/joe/protected_area_compromised.ogg'
	haz_sound = 'sound/voice/synth/joe/protected_area_compromised_haz.ogg'
...
/datum/emote/living/carbon/human/synthetic/working_joe/restricted_area/breach
	key = "breach"
	sound = 'sound/voice/synth/joe/breach.ogg'
	haz_sound = 'sound/voice/synth/joe/breach_haz.ogg'
	upp_joe_sound = 'sound/voice/synth/joe/upp_joe/narusheniekarantina.ogg'
...
/datum/emote/living/carbon/human/synthetic/working_joe/restricted_area/no_laughing_matter
	...
	sound = 'sound/voice/synth/joe/no_laughing_matter.ogg'
...
/datum/emote/living/carbon/human/synthetic/working_joe/restricted_area/come_out_vent
	key = "comeoutvent"
	sound = 'sound/voice/synth/joe/come_out_vent.ogg'
	haz_sound = 'sound/voice/synth/joe/come_out_vent_haz.ogg'
	upp_joe_sound = 'sound/voice/synth/joe/upp_joe/ventilyacii.ogg'
