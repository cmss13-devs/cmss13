...
/mob/living/carbon/xenomorph/proc/handle_xeno_leader_pheromones()
	...
	if(!Q || !Q.ovipositor || hive_pos == NORMAL_XENO || !Q.current_aura) //We are no longer a leader, or the Queen attached to us has dropped from her ovi, disabled her pheromones or even died
