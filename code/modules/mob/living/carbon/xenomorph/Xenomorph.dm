...
/mob/living/carbon/xenomorph
	...
	hud_possible = list(HEALTH_HUD_XENO, PLASMA_HUD, PHEROMONE_HUD, QUEEN_OVERWATCH_HUD, ARMOR_HUD_XENO, XENO_STATUS_HUD, XENO_BANISHED_HUD, XENO_HOSTILE_ACID, XENO_HOSTILE_SLOW, XENO_HOSTILE_TAG, XENO_HOSTILE_TAG_SPREAD, XENO_HOSTILE_TAG_PREVENT, XENO_HOSTILE_FREEZE, HUNTER_HUD, NEW_PLAYER_HUD)
	unacidable = TRUE
	rebounds = TRUE
