...
/datum/action/xeno_action/onclick/set_hugger_reserve/use_ability(atom/Atom)
	...
	carrier.huggers_reserved = tgui_input_number(usr, "How many facehuggers would you like to keep safe from Observers wanting to join as facehuggers?", "How many to reserve?", 0, carrier.huggers_max, 0)
