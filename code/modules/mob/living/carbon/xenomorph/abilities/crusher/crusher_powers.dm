...
/datum/action/xeno_action/activable/pounce/crusher_charge/pounce_additional_effects_always()
...
/datum/action/xeno_action/activable/pounce/crusher_charge/post_pounce_additional_effects(mob/living/L)
	if (!isXenoOrHuman(L))
		return
