/datum/action/xeno_action/activable/roar
	...
	var/curr_effect_type = GUARDIAN_SCREECH_BUFF
...
/datum/action/xeno_action/onclick/guardian_switch_roar_type
	...
	macro_path = /datum/action/xeno_action/verb/verb_guardian_switch_roar_type
	action_type = XENO_ACTION_ACTIVATE
	ability_primacy = XENO_PRIMARY_ACTION_5

/datum/action/xeno_action/onclick/guardian_switch_roar_type/can_use_action()
	var/mob/living/carbon/Xenomorph/X = owner
	if(X && !X.buckled && !X.is_mob_incapacitated())
		return TRUE

/datum/action/xeno_action/onclick/guardian_switch_roar_type/use_ability(atom/A)
	...
	if (WH.curr_effect_type == GUARDIAN_SCREECH_BUFF)
		action_icon_result = "roar_intimidate"
		WH.curr_effect_type = GUARDIAN_SCREECH_DEBUFF
		...
		WH.curr_effect_type = GUARDIAN_SCREECH_BUFF
...
/datum/action/xeno_action/activable/pounce/guardian
	macro_path = /datum/action/xeno_action/verb/verb_pounce_guardian
	name = "Dash"
