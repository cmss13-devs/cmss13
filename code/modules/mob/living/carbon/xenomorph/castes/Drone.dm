/datum/caste_datum/drone
	...
	caste_desc = "A builder of hives. Only drones may evolve into Kings."
	evolves_to = list(XENO_CASTE_KING, XENO_CASTE_BURROWER, XENO_CASTE_CARRIER, XENO_CASTE_HIVELORD) //Add more here seperated by commas
