...
/datum/action/xeno_action/activable/slowing_spit/use_ability(atom/target_atom)
	...
	slowspit_user.visible_message(SPAN_XENOWARNING("[slowspit_user] spits at [target_atom]!"),
	...
	projectile.fire_at(target_atom, slowspit_user, slowspit_user, slowspit_user.ammo.max_range, slowspit_user.ammo.shell_speed)
...
/datum/action/xeno_action/activable/scattered_spit/use_ability(atom/target_atom)
	...
	XENO_ACTION_CHECK_USE_PLASMA(scatterspit_user)

	scatterspit_user.visible_message(SPAN_XENOWARNING("[scatterspit_user] spits at [target_atom]!"),
	SPAN_XENOWARNING("You spit at [target_atom]!") )
	var/sound_to_play = pick(1, 2) == 1 ? 'sound/voice/alien_spitacid.ogg' : 'sound/voice/alien_spitacid2.ogg'
	...
	projectile.fire_at(target_atom, scatterspit_user, scatterspit_user, scatterspit_user.ammo.max_range, scatterspit_user.ammo.shell_speed)
...
/datum/action/xeno_action/onclick/paralyzing_slash/use_ability(atom/target_atom)
	...
	XENO_ACTION_CHECK_USE_PLASMA(paraslash_user)
