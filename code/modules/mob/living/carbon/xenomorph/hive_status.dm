...
/datum/hive_status/proc/get_xeno_counts()
	...
	var/list/xeno_counts = list(
		...
		list(XENO_CASTE_HIVELORD = 0, XENO_CASTE_BURROWER = 0, XENO_CASTE_CARRIER = 0, XENO_CASTE_LURKER = 0, XENO_CASTE_SPITTER = 0, XENO_CASTE_BRUISER = 0, XENO_CASTE_WARRIOR = 0),
...
/datum/hive_status/proc/get_xeno_icons()
	...
	var/list/xeno_icons = list(
		...
		list(XENO_CASTE_HIVELORD = "", XENO_CASTE_BURROWER = "", XENO_CASTE_CARRIER = "", XENO_CASTE_LURKER = "", XENO_CASTE_SPITTER = "", XENO_CASTE_BRUISER = "", XENO_CASTE_WARRIOR = ""),
