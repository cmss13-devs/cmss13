...
/datum/xeno_mutator/charger
	...
	description = "In exchange for your shield, losing your slowdown resist from autospitters, and losing your ability to sense frenzy pheromones, your charge can now be manually controlled and is now momentum based; the further you go, the more damage and speed you will ach until you achieve max momentum when you roar. Also, your armor is now directional, being the toughest on the front, weaker on the sides and weakest at the back. In return you gain more health, an ability to tumble to avoid enemies, and an ability to forcefully move enemies via ramming."
