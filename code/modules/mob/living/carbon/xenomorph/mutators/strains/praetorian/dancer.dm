/datum/xeno_mutator/praetorian_dancer
	...
	description = "You are now a paragon of agility. You lose the ability to spit and lose some armor. You gain an ability that lets you dodge through tallhosts (cancelled on slash) and two powerful tail abilities each enhanced by a target_tag placed on your opponents via slashing."
