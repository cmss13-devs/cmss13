...
/datum/behavior_delegate/oppressor_praetorian/melee_attack_additional_effects_target(mob/living/carbon/H)
	...
	H.apply_armoured_damage(get_xeno_damage_slash(H, tearing_damage), ARMOR_MELEE, BRUTE, bound_xeno.zone_selected ? bound_xeno.zone_selected : "chest", int_dmg_multiplier = INT_DMG_MULTIPLIER_SHARP)
