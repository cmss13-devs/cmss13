...
/obj/effect/pathogen/spore_sac
	...
	var/on_fire = FALSE
	/// How many spore clouds have been generated by this sac.
	var/spore_batch = 1
	/// The maximum, if any, amount of spore clouds this sac can produce before decaying.
	var/max_batches = 0
	/// Whether or not the spores released will give giant warning text on inhale.
...
/obj/effect/pathogen/spore_sac/proc/reset_spores()
	...
	if(max_batches && spore_batch >= max_batches)
		qdel(src)
		return
...
/obj/effect/pathogen/spore_cloud/silent
	silent_inhale = TRUE
...
/obj/effect/landmark/spore_sac_rng
	name = "pathogen spore sac spawner (30)"
	var/chance = 30
	var/silent_sac = TRUE

/obj/effect/landmark/spore_sac_rng/fifty
	name = "pathogen spore sac spawner (50)"
	chance = 50

/obj/effect/landmark/spore_sac_rng/seventy_five
	name = "pathogen spore sac spawner (75)"
	chance = 75

/obj/effect/landmark/spore_sac_rng/twenty
	name = "pathogen spore sac spawner (20)"
	chance = 20

/obj/effect/landmark/spore_sac_rng/ten
	name = "pathogen spore sac spawner (10)"
	chance = 10

/obj/effect/landmark/spore_sac_rng/Initialize(mapload, ...)
	. = ..()
	if(!prob(chance))
		qdel(src)
		return
