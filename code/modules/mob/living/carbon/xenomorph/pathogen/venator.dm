...
/datum/behavior_delegate/venator_base
...
/datum/behavior_delegate/venator_base/melee_attack_modify_damage(original_damage, mob/living/carbon/carbon_target)
...
/datum/behavior_delegate/venator_base/override_intent(mob/living/carbon/target_carbon)
	. = ..()
...
/datum/behavior_delegate/venator_base/proc/blight_slash(mob/living/carbon/human/human_target)
...
/datum/action/xeno_action/onclick/blight_slash/use_ability(atom/target)
	...
	var/datum/behavior_delegate/venator_base/behavior = paraslash_user.behavior_delegate
	if (istype(behavior))
...
/datum/action/xeno_action/onclick/blight_slash/proc/unbuff_slash()
	...
	if (!istype(unbuffslash_user))
		return
	var/datum/behavior_delegate/venator_base/behavior = unbuffslash_user.behavior_delegate
	if (istype(behavior))
