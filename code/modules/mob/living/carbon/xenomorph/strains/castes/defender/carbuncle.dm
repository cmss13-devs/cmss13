/datum/xeno_strain/carbuncle
	...
	description = "Trade some of your armor, some of your speed, and most of your normal abilities to gain fire immunity and new abilities related to fire. Being on fire adds a bit of extra damage to your slashes and tail slams as well as letting both ignite targets covered in flammable substances. Vomit Bile can be used to immediately extinguish allies and turfs for a faster cooldown, or to cover enemies in a flammable substance; if you are on fire, you can no longer extinguish allies or turfs but will instead set enemies on fire! Thermoregulation only works when you are on fire and provides a short-lived buff to speed and slash speed before extinguishing you."
