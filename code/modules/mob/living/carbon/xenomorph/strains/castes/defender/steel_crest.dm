/datum/xeno_strain/steel_crest
	...
	description = "We trade our tail sweep and a small amount of our slash damage for slightly increased headbutt knockback and damage and the ability to slowly move and headbutt while fortified. Along with this, we gain a unique ability called Soak to accumulate damage and use it to recover a slight amount of health and refresh our tail slam."
