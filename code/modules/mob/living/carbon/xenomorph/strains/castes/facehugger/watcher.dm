/datum/xeno_strain/watcher
	...
	description = "We lose our ability to hide in exchange to see further. This enables you to stalk our host from a distance and wait for the perfect opportunity to strike."
