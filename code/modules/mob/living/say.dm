var/list/department_radio_keys = list(
	  ":i" = RADIO_CHANNEL_INTERCOM,	".i" = RADIO_CHANNEL_INTERCOM,
	  ":h" = RADIO_CHANNEL_DEPARTMENT,	".h" = RADIO_CHANNEL_DEPARTMENT,
	  ":+" = RADIO_CHANNEL_SPECIAL,		".+" = RADIO_CHANNEL_SPECIAL, //activate radio-specific special functions
	  ":w" = RADIO_MODE_WHISPER,		".w" = RADIO_MODE_WHISPER,

	  ":m" = RADIO_CHANNEL_MEDSCI,		".m" = RADIO_CHANNEL_UPP_MED,
	  ":n" = RADIO_CHANNEL_ENGI, 		".n" = RADIO_CHANNEL_UPP_ENGI,
	  ":g" = RADIO_CHANNEL_ALMAYER,		".g" = RADIO_CHANNEL_CLF_GEN,
	  ":v" = RADIO_CHANNEL_COMMAND ,	".v" = RADIO_CHANNEL_UPP_CMD,
	  ":a" = SQUAD_MARINE_1,			".a" = RADIO_CHANNEL_CLF_MED,
	  ":b" = SQUAD_MARINE_2,			".b" = RADIO_CHANNEL_CLF_ENGI,
	  ":c" = SQUAD_MARINE_3,			".c" = RADIO_CHANNEL_CLF_CMD,
	  ":d" = SQUAD_MARINE_4,			".d" = RADIO_CHANNEL_CLF_CCT,
	  ":e" = SQUAD_MARINE_5,			".e" = RADIO_CHANNEL_PMC_ENGI,
	  ":f" = SQUAD_MARINE_CRYO,			".f" = RADIO_CHANNEL_PMC_MED,
	  ":p" = RADIO_CHANNEL_MP ,			".p" = RADIO_CHANNEL_PMC_GEN,
	  ":u" = RADIO_CHANNEL_REQ,			".u" = RADIO_CHANNEL_UPP_GEN,
	  ":j" = RADIO_CHANNEL_JTAC,		".j" = RADIO_CHANNEL_UPP_CCT,
	  ":t" = RADIO_CHANNEL_INTEL,		".t" = RADIO_CHANNEL_UPP_KDO,
	  ":y" = RADIO_CHANNEL_WY,			".y" = RADIO_CHANNEL_WY,
	  ":o" = RADIO_CHANNEL_COLONY,		".o" = RADIO_CHANNEL_PMC_CCT,
	  ":z" = RADIO_CHANNEL_HIGHCOM,		".z" = RADIO_CHANNEL_PMC_CMD,
	  ":k" = SQUAD_MARSOC,				".k" = RADIO_CHANNEL_WY_WO,

	  ":R" = RADIO_EAR_RIGHT,			".R" = RADIO_EAR_RIGHT,
	  ":L" = RADIO_EAR_LEFT ,			".L" = RADIO_EAR_LEFT ,
	  ":I" = RADIO_CHANNEL_INTERCOM,	".I" = RADIO_CHANNEL_INTERCOM,
	  ":H" = RADIO_CHANNEL_DEPARTMENT,	".H" = RADIO_CHANNEL_DEPARTMENT,
	  ":W" = RADIO_MODE_WHISPER,		".W" = RADIO_MODE_WHISPER,
