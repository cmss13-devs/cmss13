...
/mob/living/simple_animal/parrot
	...
	desc = "The parrot squawks, \"I'm a Parrot! RAAAWWK!\""
	...
	emote_hear = list("squawks","calls loudly", "screeches")
	emote_see = list("flutters its wings", "bobs its head", "grinds its beak", "pins its eyes")
				...
				if("ears")
					if(ears)
						if(length(available_channels))
							src.say("[pick(available_channels)] BAWWWWWK! GIMME MY HEADSET BACK! BAWKKKKK!")
						else
							src.say("BAWWWWWK! GIMME MY HEADSET BACK! BAWKKKKK!")
