...
mob/proc/yank_out_object()
	...
	if(self)
		visible_message("<span class='danger'>[src] rips [selection] out of their body.</span>","<span class='danger'>You rip [selection] out of your body.</span>", null, 5)
	else
		visible_message("<span class='danger'>[usr] rips [selection] out of [src]'s body.</span>","<span class='danger'>[usr] rips [selection] out of your body.</span>", null, 5)
	valid_objects = get_visible_implants(0)
