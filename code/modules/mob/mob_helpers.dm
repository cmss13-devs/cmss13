...
/proc/shake_camera(mob/M, steps = 1, var/strength = 1, var/time_per_step = 1)
...
/mob/proc/clear_chat_spam_mute(warn_level = 1, var/message = FALSE, var/increase_warn = FALSE)
