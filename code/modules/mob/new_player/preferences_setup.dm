...
datum/preferences/proc/update_preview_icon()		//seriously. This is horrendous.
	...
	if(!preference_overlay_cache[pref_name])
		...
		body_icon.debugBlend(new /icon(icobase, get_limb_icon_name(current_species, b_icon, gender, "groin", e_icon)), ICON_OVERLAY)
		body_icon.debugBlend(new /icon(icobase, get_limb_icon_name(current_species, b_icon, gender, "head", e_icon)), ICON_OVERLAY)

		for(var/name in list("r_arm","r_hand","r_leg","r_foot","l_leg","l_foot","l_arm","l_hand"))
			var/icon/temp = new /icon(icobase, get_limb_icon_name(current_species, b_icon, gender, "[name]", e_icon))
			body_icon.debugBlend(temp, ICON_OVERLAY)
		preference_overlay_cache[pref_name] = body_icon
		preview_icon.debugBlend(body_icon, ICON_OVERLAY)
	else
		preview_icon.debugBlend(preference_overlay_cache[pref_name], ICON_OVERLAY)
	...
	if(!preference_overlay_cache[eyes_name])
		...
		eyes_s.debugBlend(rgb(r_eyes, g_eyes, b_eyes), ICON_ADD)
		...
		preview_icon.debugBlend(preference_overlay_cache[eyes_name], ICON_OVERLAY)
	...
	if(job_marines_low & ROLE_MARINE_STANDARD)
		if(preference_overlay_cache["ROLE_MARINE_STANDARD"])
			...
			clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/feet.dmi', "jackboots"), ICON_UNDERLAY)
			clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/hands.dmi', "bgloves"), ICON_UNDERLAY)
			clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/suit_1.dmi', "lamp-off"), ICON_UNDERLAY)
			clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/suit_1.dmi', "2"), ICON_OVERLAY)
			clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/head_1.dmi', "helmet"), ICON_OVERLAY)
			clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/belt.dmi', "marinebelt"), ICON_OVERLAY)
		...
		switch(job_marines_high)
			...
			if(ROLE_MARINE_ENGINEER)
				if(preference_overlay_cache["ROLE_MARINE_ENGINEER"])
					...
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/feet.dmi', "jackboots"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/hands.dmi', "lightbrowngloves"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/suit_1.dmi', "lamp-off"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/suit_1.dmi', "6"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/head_1.dmi', "helmet"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/eyes.dmi', "meson"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/belt.dmi', "utility"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/back.dmi', "marinepack_techi"), ICON_OVERLAY)
			...
			if(ROLE_MARINE_LEADER)
				if(preference_overlay_cache["ROLE_MARINE_LEADER"])
					...
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/hands.dmi', "bgloves"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/suit_1.dmi', "lamp-off"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/suit_1.dmi', "7"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/head_1.dmi', "helmet"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/back.dmi', "marinesatch"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/belt.dmi', "marinebelt"), ICON_OVERLAY)
			...
			if(ROLE_MARINE_MEDIC)
				if(preference_overlay_cache["ROLE_MARINE_MEDIC"])
					...
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/hands.dmi', "bgloves"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/suit_1.dmi', "lamp-off"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/suit_1.dmi', "1"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/eyes.dmi', "healthhud"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/head_1.dmi', "helmet"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/back.dmi', "marinepack_medic"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/belt.dmi', "medicbag"), ICON_OVERLAY)
			...
			if(ROLE_MARINE_SPECIALIST)
				if(preference_overlay_cache["ROLE_MARINE_SPECIALIST"])
					...
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/suit_1.dmi', "lamp-off"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/suit_1.dmi', "2"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/head_1.dmi', "spec"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/back.dmi', "marinepack"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/belt.dmi', "marinebelt"), ICON_OVERLAY)
			...
			if(ROLE_MARINE_SMARTGUN)
				if(preference_overlay_cache["ROLE_MARINE_SMARTGUN"])
					...
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/hands.dmi', "bgloves"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/suit_1.dmi', "lamp-off"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/suit_1.dmi', "8"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/eyes.dmi', "m56_goggles"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/head_1.dmi', "helmet"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/back.dmi', "powerpack"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/belt.dmi', "marinebelt"), ICON_OVERLAY)
		...
		switch(job_command_high)
			if(ROLE_COMMANDING_OFFICER)
				if(preference_overlay_cache["ROLE_COMMANDING_OFFICER"])
					...
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/feet.dmi', "laceups"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/hands.dmi', "egloves"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/ears.dmi', "headset"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/head_0.dmi', "centcomcaptain"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/back.dmi', "marinesatch"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/belt.dmi', "m4a3_holster_g"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/mob.dmi', "card-id"), ICON_OVERLAY)
			...
			if(ROLE_BRIDGE_OFFICER)
				if(preference_overlay_cache["ROLE_BRIDGE_OFFICER"])
					...
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/feet.dmi', "jackboots"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/ears.dmi', "headset"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/head_1.dmi', "rocap"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/back.dmi', "marinesatch"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/belt.dmi', "m4a3_holster_g"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/mob.dmi', "card-id"), ICON_OVERLAY)
			...
			if(ROLE_EXECUTIVE_OFFICER)
				if(preference_overlay_cache["ROLE_EXECUTIVE_OFFICER"])
					...
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/feet.dmi', "jackboots"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/ears.dmi', "headset"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/head_1.dmi', "cap"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/back.dmi', "marinesatch"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/belt.dmi', "m44_holster_g"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/mob.dmi', "card-id"), ICON_OVERLAY)
			...
			if(ROLE_PILOT_OFFICER)
				if(preference_overlay_cache["ROLE_PILOT_OFFICER"])
					...
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/feet.dmi', "jackboots"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/hands.dmi', "lightbrowngloves"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/ears.dmi', "headset"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/suit_1.dmi', "pilot"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/eyes.dmi', "sun"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/head_1.dmi', "helmetp"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/back.dmi', "marinesatch"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/belt.dmi', "m4a3_holster"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/mob.dmi', "card-id"), ICON_OVERLAY)
			...
			if(ROLE_CORPORATE_LIAISON)
				if(preference_overlay_cache["ROLE_CORPORATE_LIAISON"])
					...
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/feet.dmi', "laceups"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/ears.dmi', "headset"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/back.dmi', "satchel"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/mob.dmi', "card-id"), ICON_OVERLAY)
			...
			if(ROLE_MILITARY_POLICE)
				if(preference_overlay_cache["ROLE_MILITARY_POLICE"])
					...
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/feet.dmi', "jackboots"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/hands.dmi', "bgloves"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/suit_1.dmi', "mp"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/ears.dmi', "headset"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/head_1.dmi', "beretred"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/eyes.dmi', "sunhud"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/back.dmi', "securitypack"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/belt.dmi', "security"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/mob.dmi', "card-id"), ICON_OVERLAY)
			...
			if(ROLE_CHIEF_MP)
				if(preference_overlay_cache["ROLE_CHIEF_MP"])
					...
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/feet.dmi', "jackboots"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/hands.dmi', "bgloves"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/suit_1.dmi', "warrant_officer"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/ears.dmi', "headset"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/head_1.dmi', "beretwo"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/eyes.dmi', "sunhud"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/back.dmi', "securitypack"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/belt.dmi', "security"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/mob.dmi', "card-id"), ICON_OVERLAY)
			...
			if(ROLE_TANK_OFFICER)
				if(preference_overlay_cache["ROLE_TANK_OFFICER"])
					...
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/feet.dmi', "jackboots"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/hands.dmi', "lightbrowngloves"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/suit_1.dmi', "tanker"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/ears.dmi', "headset"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/head_1.dmi', "tanker_helmet"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/back.dmi', "marinesatch"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/belt.dmi', "m4a3_holster"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/mob.dmi', "card-id"), ICON_OVERLAY)
			...
			if(ROLE_INTEL_OFFICER)
				if(preference_overlay_cache["ROLE_INTEL_OFFICER"])
					...
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/belt.dmi', "m4a3_holster_g"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/mob.dmi', "card-id"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/suit_1.dmi', "officer"), ICON_OVERLAY)
		...
		switch(job_engi_high)
			...
			if(ROLE_REQUISITION_OFFICER)
				if(preference_overlay_cache["ROLE_REQUISITION_OFFICER"])
					...
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/hands.dmi', "lightbrowngloves"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/ears.dmi', "headset"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/head_1.dmi', "cargocap"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/back.dmi', "marinesatch"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/belt.dmi', "m44_holster_g"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/mob.dmi', "card-id"), ICON_OVERLAY)
			...
			if(ROLE_REQUISITION_TECH)
				if(preference_overlay_cache["ROLE_REQUISITION_TECH"])
					...
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/hands.dmi', "lightbrowngloves"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/ears.dmi', "headset"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/head_1.dmi', "band2"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/back.dmi', "marinesatch"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/belt.dmi', "utility"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/mob.dmi', "card-id"), ICON_OVERLAY)
		...
		switch(job_medsci_high)
			if(ROLE_CHIEF_MEDICAL_OFFICER)
				if(preference_overlay_cache["ROLE_CHIEF_MEDICAL_OFFICER"])
					...
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/feet.dmi', "laceups"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/hands.dmi', "lgloves"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/suit_0.dmi', "labcoatg"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/ears.dmi', "headset"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/eyes.dmi', "healthhud"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/back.dmi', "marinesatch"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/belt.dmi', "electronic"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/mob.dmi', "card-id"), ICON_OVERLAY)
			...
			if(ROLE_CIVILIAN_DOCTOR)
				if(preference_overlay_cache["ROLE_CIVILIAN_DOCTOR"])
					...
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/feet.dmi', "white"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/hands.dmi', "lgloves"), ICON_UNDERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/suit_0.dmi', "labcoat_open"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/ears.dmi', "headset"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/eyes.dmi', "healthhud"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/head_0.dmi', "surgcap_green"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/back.dmi', "marinesatch"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/humans/onmob/belt.dmi', "electronic"), ICON_OVERLAY)
					clothes_s.debugBlend(new /icon('icons/mob/mob.dmi', "card-id"), ICON_OVERLAY)
	...
	if(underwear_s && !clothes_s)
		preview_icon.debugBlend(underwear_s, ICON_OVERLAY)
	if(undershirt_s && !clothes_s)
		preview_icon.debugBlend(undershirt_s, ICON_OVERLAY)
	if(clothes_s)
