...
/obj/item/organ/mouth/Initialize(mapload, mob/living/carbon/human/human_owner)
	. = ..()
...
/obj/item/organ/mouth/proc/hide_for(client/prospective_hiddener)
	if(prospective_hiddener == null)
		return
	prospective_hiddener.images += hiding_image

/obj/item/organ/mouth/proc/show_to(client/prospective_seeinger)
