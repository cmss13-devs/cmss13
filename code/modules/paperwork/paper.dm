...
/obj/item/paper/wy_recruit_immediate
	name = "WY PMC immediate recruitment form"

/obj/item/paper/wy_recruit_immediate/Initialize(mapload, list/prints)
	. = ..()
	var/template = {"\[center\]\[wy\]
		\[b\]\[large\]Building Better Worlds.\[/large\]\[/b\]\[/br\]
		\[small\]Copyright Weyland-Yutani Corporation, 2182. All Rights Reserved.\[/center\]\[/small\]
		\[hr\]\[hr\]
		\[center\]\[b\]\[u\]Form 8303
		Weyland-Yutani Private Military Enlistment Transfer, "Whiteguard Solutions"\[/u\]\[/b\]\[br\]
		\[b\]Date:\[/b\] \[date\]\[/center\]
		\[hr\]\[hr\]
		\[br\]
		...
		\[*\]The signatory understands that they will not be eligible for any and all company-provided health and other benefits until they have served under this contract for at least one (1) year.\[br\]
		\[*\]The signatory agrees and comprehends that this contract may be terminated at any given time, without advance notice, by the corporation if the signed is found to be lacking or otherwise failing in their duties and overall performance as a military contractor.\[br\]
		\[*\]The signatory has provided evidence and has submitted to a sufficient background check to verify their previous work history and combat experience; as well as provided previously-recorded medical history pretaining to any performance-affecting injuries they may have received while assuming their duties while under previous employment.\[br\]
		\[*\]The signatory agrees that, while they are binded under the terms and conditions of this contract, they will \[b\]not\[/b\] work or otherwise perform acts of duty for other companies or military organizations, and will only employ their services as required by Weyland-Yutani executive staff or their assigned squad commander (if they have one). The signed agrees that they will not deploy to respond to mission directives not provided by Weyland-Yutani corporation, and as such, will not work to actively assist members of the United States Colonial Marines or members of any other outstanding factions, including but not limited to: United Progressive Peoples, Colonial Liberation Front; unless otherwise permitted by Weyland-Yutani executive staff of rank Division Manager or above.\[br\]
		\[*\]Company-provided equipment is a privilege that can be revoked at any time.\[br\]
		\[*\]The signatory agrees that written documentation and word of mouth with relation to their work performed while contracted under Weyland-Yutani will not be disclosed or otherwise revealed to those not affiliated with the corporation. A breach of privacy will result in immediate contract termination without advance notice or pay.\[/list\]\[br\]\[hr\]\[hr\]\[br\]
		\[list\]Signature: | \[field\]\[br\]
		Corporate Liaison Signature: |\[field\]\[/list\]\[hr\]\[hr\]
		\[center\]\[small\]Weyland-Yutani Corporation does not take financial or legal responsibility for any loss of life or limb that may occur as a result of employment under this contract.\[br\]
		\[b\]Weyland-Yutani Corporate Employment Records Forms 268-C, section 1.3.\[/b\]\[/small\]"}

	info = parsepencode(template, null, null, FALSE)
	update_icon()


/obj/item/paper/wy_recruit_future
	name = "WY PMC future recruitment form"

/obj/item/paper/wy_recruit_future/Initialize(mapload, list/prints)
	. = ..()
	var/template = {"\[center\]\[wy\]
		\[b\]\[large\]Building Better Worlds.\[/large\]\[/b\]
		\[small\]Copyright Weyland-Yutani Corporation, 2182. All Rights Reserved.\[/center\]\[/small\]
		\[hr\]\[hr\]
		\[center\]\[b\]\[u\]Form 8302
		Weyland-Yutani Private Military Enlistment Transfer, "Whiteguard Solutions"\[/u\]\[/b\]\[br\]
		\[b\]Date:\[/b\] \[date\]\[/center\]
		\[hr\]\[hr\]
		\[list\]\[b\]Current Facility:\[/b\] USS Almayer\[br\]
		\[list\]\[i\]I, \[field\], willingly enter into this contract and agree to all written terms and conditions. I understand that once signed, I will be bound to such as is written until the term agreed upon expires or is deemed void by the appropriate Weyland-Yutani personnel. I understand that this contract is to take effect once my term with my present employer has concluded and I am free of any possible conflict of interest.\[/i\]\[/list\]\[/list\]
		\[hr\]\[hr\]\[list\]\[*\]The signatory herein agrees to act as a Private Military Contractor for the company of Weyland-Yutani for at least four (4) years before they are eligible to opt out of the position and pursue different employment.\[br\]
		\[*\]The signatory understands that they will not be eligible for any and all company-provided health and other benefits until they have served under this contract for at least one (1) year.\[br\]
		\[*\]The signatory agrees and comprehends that this contract may be terminated at any given time, without advance notice, by the corporation if the signed is found to be lacking or otherwise failing in their duties and overall performance as a military contractor.\[br\]
		...
		\[*\]Company-provided equipment is a privilege that can be revoked at any time.\[br\]
		\[*\]The signatory agrees that written documentation and word of mouth with relation to their work performed while contracted under Weyland-Yutani will not be disclosed or otherwise revealed to those not affiliated with the corporation. A breach of privacy will result in immediate contract termination without advance notice or pay.\[/list\]\[hr\]\[hr\]\[list\]\[b\]Signature:\[/b\] \[field\]\[br\]
		\[b\]Corporate Liaison Signature:\[/b\] \[field\]\[/list\]\[hr\]\[hr\]\[center\]\[small\]Weyland-Yutani Corporation does not take financial or legal responsibility for any loss of life or limb that may occur as a result of employment under this contract.\[br\]
		\[b\]Weyland-Yutani Corporate Employment Records Forms 268-C, section 1.3.\[/b\]\[/small\]"}
