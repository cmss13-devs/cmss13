...
/obj/item/paper/almayer_brig_storage
	name = "Strange Note"
	info = "<i>Sorry about your spare signs, CMP.<br><br>High command had them requisitioned off to the Second Fleet. I fought like hell to keep them here but, what the hell, they're just signs. Figure we could spraypaint a new piece of metal if we really needed it.</i><hr>The signature at the bottom is illegible."
