/datum/prefab_document/provost/highcom/standard/New()
	...
	dat += "<p>"
	dat += "This message and any files transmitted with it are confidential and intended solely for the use of the individual or entity to whom they are addressed.<br>"
	dat += "If you are not the aforementioned addressee you should not disseminate, distribute or copy this missive.<br>"
