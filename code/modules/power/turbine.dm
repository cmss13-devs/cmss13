...
/obj/machinery/compressor/process()
	...
	if(rpm>50000)
		overlays += image('icons/obj/pipes/pipes3.dmi', "comp-o4", FLY_LAYER)
	else if(rpm>10000)
		overlays += image('icons/obj/pipes/pipes3.dmi', "comp-o3", FLY_LAYER)
	else if(rpm>2000)
		overlays += image('icons/obj/pipes/pipes3.dmi', "comp-o2", FLY_LAYER)
	else if(rpm>500)
		overlays += image('icons/obj/pipes/pipes3.dmi', "comp-o1", FLY_LAYER)
	 //TODO: DEFERRED
...
/obj/machinery/power/turbine/process()
	...
	if(lastgen > 100)
		overlays += image('icons/obj/pipes/pipes3.dmi', "turb-o", FLY_LAYER)
