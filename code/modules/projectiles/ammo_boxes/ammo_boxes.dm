...
/obj/item/ammo_box/rounds
	...
	desc = "A 10x24mm ammunition box. Used to refill M41A MK1, MK2, M4RA and M41AE2 HPR magazines. It comes with a leather strap that allows you to wear it on your back."
	icon_state = "base_m41"
	item_state = "base_m41"
