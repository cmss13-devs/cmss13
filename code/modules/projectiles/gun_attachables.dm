...
/obj/item/attachable/stock/shotty/collapsible/New()
	...
	select_gamemode_skin(/obj/item/attachable/stock/shotty)
...
/obj/item/attachable/stock/shotty/collapsible/select_gamemode_skin(expected_type, list/override_icon_state, list/override_protection)
	. = ..() // We are forcing attach_icon skin
	var/new_attach_icon
	var/new_icon_state
	if(stock_activated)
