...
/obj/item/attachable/scope/mini_iff
	...
	desc = "An experimental B8 Smart-Scope. Based on the technologies used in the Smart Gun by ARMAT, this sight has integrated IFF systems. It can only attach to the M4RA Battle Rifle, L42A Battle Rifle, M44 Combat Revolver, and M46C Pulse Rifle."
	slot = "rail"
	zoom_offset = 6
	zoom_viewsize = 7
	pixel_shift_y = 15
