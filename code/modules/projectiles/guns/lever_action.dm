...
/obj/item/weapon/gun/lever_action
	...
	desc = "Welcome to the Wild West!\nThis gun is levered via Unique-Action, but it has a bonus feature: Hitting a target directly will grant you a firerate and damage buff for your next shot during a short interval. Combo precision hits for massive damage."
...
/obj/item/weapon/gun/lever_action/xm88
	...
	default_caliber = ".458"
	hit_buff_reset_cooldown = 1.5 SECONDS //how much time after a direct hit until streaks reset
...
/obj/item/weapon/gun/lever_action/xm88/apply_hit_buff()
	...
	last_fired = world.time - buff_fire_reduc //to shoot the next round faster
	fire_delay = FIRE_DELAY_TIER_1 + FIRE_DELAY_TIER_8
