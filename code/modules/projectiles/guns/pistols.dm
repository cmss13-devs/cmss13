...
/obj/item/weapon/gun/pistol/m1911
	...
	desc = "A timeless classic since the first World War, produced in limited amount by Armat Battlefield Systems after their acquisition of Colt's Manufacturing Company. Once standard issue for the USCM, now back order only. Chambered in .45 ACP."
	icon = 'icons/obj/items/weapons/guns/guns_by_faction/USCM/pistols.dmi'
	icon_state = "m4a345"
	item_state = "m4a3"
...
/obj/item/weapon/gun/pistol/b92fs/Initialize(mapload, spawn_empty)
	...
	if(prob(10))
		...
		desc += " This specific pistol is a burst-fire, limited availability, police-issue 93FR type Beretta. Not too accurate, aftermarket modifications are recommended."
...
/obj/item/weapon/gun/pistol/holdout/custom
	...
	desc = "A small plinker in .22LR made by Spearhead. Designed for target shooting or quietly dealing with interplanetary vermin. This one is custom fitted with ivory grip plates and a blue-steel finish."
	icon_state = "whisperc"
	item_state = "whisperc"
...
/obj/item/weapon/gun/pistol/clfpistol
	...
	desc = "The D18 Hummingbird Pistol was produced in the mid-2170s as a cheap and concealable firearm for CLF Sleeper Cell agents for assassinations and ambushes, and is able to be concealed in shoes and work boots."
	icon = 'icons/obj/items/weapons/guns/guns_by_faction/colony/pistols.dmi'
	icon_state = "m43"
	item_state = "m43"
