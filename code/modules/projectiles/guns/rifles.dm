...
/obj/item/weapon/gun/rifle/xm51/set_bullet_traits()
	LAZYADD(traits_to_give, list(
		...
		BULLET_TRAIT_ENTRY_ID("xeno turfs", /datum/element/bullet_trait_damage_boost, 0.2, GLOB.damage_boost_turfs_xeno), //2550*0.25 = 637, 2 taps resin walls, 3 taps thick resin
