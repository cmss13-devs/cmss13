...
/obj/item/ammo_magazine/smg/pps43
	name = "\improper Type-19 stick magazine (10mm)"
	desc = "A stick magazine for the Type-19 submachinegun. Chambed in 10mm cased."
	caliber = "10mm"
	icon = 'icons/obj/items/weapons/guns/ammo_by_faction/UPP/smgs.dmi'
...
/obj/item/ammo_magazine/smg/pps43/extended
	name = "\improper Type-19 drum magazine (10mm)"
	desc = "A 10mm cased drum magazine for the Type-19 submachinegun."
	...
	bonus_mag_wield_delay = WEAPON_DELAY_VERY_FAST
//-------------------------------------------------------
//MSP-64 SMG, based on the PP Bizon.

/obj/item/ammo_magazine/smg/bizon
	name = "\improper MSP-64 Helical Magazine (8.6x20mm)"
	desc = "A 8.6x20mm caseless 64-round helical magazine for the MSP-64 submachinegun, the standard SMG of the UPP armed collective."
	caliber = "8.6x20mm"
	icon = 'icons/obj/items/weapons/guns/ammo_by_faction/UPP/smgs.dmi'
