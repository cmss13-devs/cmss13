...
/obj/item/ammo_magazine/smartgun/heap
	...
	desc = "An M56 smartgun drum magazine, loaded with high-explosive armor-piercing rounds -- or HEAP for short, -- providing a massive 'oomph' to its bullets. Only compatible with the M56T model smartgun. Has unique yellow markings to distinguish it from regular munitions."
