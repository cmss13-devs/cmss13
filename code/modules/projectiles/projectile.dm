...
/obj/projectile/proc/fire_at(atom/target, atom/F, atom/S, range = 30, speed = 1, atom/original_override, randomize_speed = TRUE, gun_damage_mult = 1)
	...
	if(ammo.bonus_projectiles_amount && ammo.bonus_projectiles_type)
		...
		ammo.fire_bonus_projectiles(src, gun_damage_mult)
