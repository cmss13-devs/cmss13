...
/datum/chemical_reaction/proc/generate_recipe(list/complexity, list/required_reagents_to_add)
	...
	var/picked_flag = indicator_list[pick_weight(list("CHEM_REACTION_BUBBLING" = 1,"CHEM_REACTION_FIRE" = 1, "CHEM_REACTION_ENDOTHERMIC" = 1, "CHEM_REACTION_GLOWING" = 1, "CHEM_REACTION_SMOKING" = 1, "CHEM_REACTION_CALM" = 1))]
