...
/obj/structure/machinery/chem_simulator
	...
	var/list/property_codings = list(
		...
		PROPERTY_RAVENING = "RAV",			PROPERTY_ADDICTIVE = "ADT",\
		//Neutral
		...
		PROPERTY_HYPERMETABOLIC = "EBM",	PROPERTY_SEDATIVE = "SDT",			PROPERTY_THANATOMETABOL = "TMB", 	PROPERTY_HYPERTHROTTLING = "HTR",\
		//Positive
