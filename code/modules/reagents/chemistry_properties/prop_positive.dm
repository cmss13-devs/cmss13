...
/datum/chem_property/positive/antibiotic
	...
	code = "ABT"
	description = "Blocks certain biological processes from occuring in all living tissue, while it helps with infections, it also harms the body itself. overdosis can cause extreme lethality"
	rarity = PROPERTY_COMMON
	category = PROPERTY_TYPE_MEDICINE
	value = 1
	max_level = 3
