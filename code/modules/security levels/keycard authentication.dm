...
/proc/make_maint_all_access()
	...
	to_chat(world, "<span class='caution'>The maintenance access requirement has been revoked on all airlocks.</span>")

/proc/revoke_maint_all_access()
	maint_all_access = 0
	to_chat(world, "<font size=4 color='red'>Attention!</font>")
	to_chat(world, "<span class='caution'>The maintenance access requirement has been readded on all maintenance airlocks.</span>")
