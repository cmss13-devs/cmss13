...
/datum/dropship_hijack/almayer/proc/get_crashsite_turf(ship_section)
	...
	switch(ship_section)
		if("Upper deck Foreship")
			turfs += get_area_turfs(/area/ship/almayer/shipboard/brig/armory)
			turfs += get_area_turfs(/area/ship/almayer/shipboard/brig/cells)
			turfs += get_area_turfs(/area/ship/almayer/shipboard/brig/cic_hallway)
			turfs += get_area_turfs(/area/ship/almayer/shipboard/brig/cryo)
			turfs += get_area_turfs(/area/ship/almayer/shipboard/brig/evidence_storage)
			turfs += get_area_turfs(/area/ship/almayer/shipboard/brig/general_equipment)
			turfs += get_area_turfs(/area/ship/almayer/shipboard/brig/lobby)
			turfs += get_area_turfs(/area/ship/almayer/shipboard/brig/starboard_hallway)
			turfs += get_area_turfs(/area/ship/almayer/shipboard/brig/perma)
			turfs += get_area_turfs(/area/ship/almayer/shipboard/brig/processing)
			turfs += get_area_turfs(/area/ship/almayer/shipboard/brig/medical)
			turfs += get_area_turfs(/area/ship/almayer/shipboard/brig/mp_bunks)
			turfs += get_area_turfs(/area/ship/almayer/shipboard/brig/chief_mp_office)
			turfs += get_area_turfs(/area/ship/almayer/command/cichallway)
			turfs += get_area_turfs(/area/ship/almayer/command/cic)
			turfs += get_area_turfs(/area/ship/sulaco/hallway/central_hall2)
			turfs += get_area_turfs(/area/ship/sulaco/hallway/central_hall)
			turfs += get_area_turfs(/area/ship/sulaco/bridge/quarters)
		if("Upper deck Midship")
			turfs += get_area_turfs(/area/ship/almayer/medical/morgue)
			turfs += get_area_turfs(/area/ship/almayer/medical/upper_medical)
			turfs += get_area_turfs(/area/ship/almayer/medical/containment)
			turfs += get_area_turfs(/area/ship/almayer/medical/containment/cell)
			turfs += get_area_turfs(/area/ship/almayer/medical/medical_science)
			turfs += get_area_turfs(/area/ship/almayer/medical/hydroponics)
			turfs += get_area_turfs(/area/ship/sulaco/briefing)
			turfs += get_area_turfs(/area/ship/sulaco/cafeteria)
			turfs += get_area_turfs(/area/ship/sulaco/marine)
			turfs += get_area_turfs(/area/ship/sulaco/showers)
		if("Upper deck Aftship")
			turfs += get_area_turfs(/area/ship/almayer/engineering/upper_engineering)
			turfs += get_area_turfs(/area/ship/almayer/engineering/laundry)
			turfs += get_area_turfs(/area/ship/sulaco/cargo/office)
			turfs += get_area_turfs(/area/ship/sulaco/hallway/central_hall3)
			turfs += get_area_turfs(/area/ship/sulaco/engineering/storage)
			turfs += get_area_turfs(/area/ship/sulaco/engineering)
		if("Lower deck Foreship")
			turfs += get_area_turfs(/area/ship/almayer/hallways/hangar)
			turfs += get_area_turfs(/area/ship/almayer/hallways/lower/vehiclehangar)
			turfs += get_area_turfs(/area/ship/sulaco/hallway/lower_main_hall)
			turfs += get_area_turfs(/area/ship/sulaco/morgue)
			turfs += get_area_turfs(/area/ship/sulaco/medbay/chemistry)
			turfs += get_area_turfs(/area/ship/sulaco/liaison)
		if("Lower deck Midship")
			turfs += get_area_turfs(/area/ship/almayer/medical/chemistry)
			turfs += get_area_turfs(/area/ship/almayer/medical/lower_medical_lobby)
			turfs += get_area_turfs(/area/ship/almayer/medical/lockerroom)
			turfs += get_area_turfs(/area/ship/almayer/medical/lower_medical_medbay)
			turfs += get_area_turfs(/area/ship/almayer/medical/operating_room_one)
			turfs += get_area_turfs(/area/ship/almayer/medical/operating_room_two)
			turfs += get_area_turfs(/area/ship/almayer/medical/operating_room_three)
			turfs += get_area_turfs(/area/ship/almayer/medical/operating_room_four)
			turfs += get_area_turfs(/area/ship/almayer/living/briefing)
			turfs += get_area_turfs(/area/ship/almayer/squads/req)
			turfs += get_area_turfs(/area/ship/sulaco/hallway/lower_main_hall)
			turfs += get_area_turfs(/area/ship/sulaco/hangar)
		if("Lower deck Aftship")
			turfs += get_area_turfs(/area/ship/almayer/living/cryo_cells)
			turfs += get_area_turfs(/area/ship/almayer/engineering/lower/workshop)
			turfs += get_area_turfs(/area/ship/sulaco/hangar/atmos)
			turfs += get_area_turfs(/area/ship/sulaco/hangar/range)
		else
