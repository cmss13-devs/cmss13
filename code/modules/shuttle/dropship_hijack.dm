...
/datum/dropship_hijack/almayer/proc/get_crashsite_turf(ship_section)
	...
	switch(ship_section)
		if("Upper deck Foreship")
			...
			turfs += get_area_turfs(/area/sulaco/hallway/central_hall2)
			turfs += get_area_turfs(/area/sulaco/hallway/central_hall)
			turfs += get_area_turfs(/area/sulaco/bridge/quarters)
		if("Upper deck Midship")
			...
			turfs += get_area_turfs(/area/sulaco/briefing)
			turfs += get_area_turfs(/area/sulaco/cafeteria)
			turfs += get_area_turfs(/area/sulaco/marine)
			turfs += get_area_turfs(/area/sulaco/showers)
		if("Upper deck Aftship")
			...
			turfs += get_area_turfs(/area/sulaco/cargo/office)
			turfs += get_area_turfs(/area/sulaco/hallway/central_hall3)
			turfs += get_area_turfs(/area/sulaco/engineering/storage)
			turfs += get_area_turfs(/area/sulaco/engineering)
		if("Lower deck Foreship")
			...
			turfs += get_area_turfs(/area/sulaco/hallway/lower_main_hall)
			turfs += get_area_turfs(/area/sulaco/morgue)
			turfs += get_area_turfs(/area/sulaco/medbay/chemistry)
			turfs += get_area_turfs(/area/sulaco/liaison)
		if("Lower deck Midship")
			...
			turfs += get_area_turfs(/area/sulaco/hallway/lower_main_hall)
			turfs += get_area_turfs(/area/sulaco/hangar)
		if("Lower deck Aftship")
			...
			turfs += get_area_turfs(/area/sulaco/hangar/atmos)
			turfs += get_area_turfs(/area/sulaco/hangar/range)
		else
