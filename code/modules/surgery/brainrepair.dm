...
/datum/surgery_step/remove_bone_chips/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, tool_type, datum/surgery/surgery)
	user.affected_message(target,
		...
		SPAN_NOTICE("[capitalize(user.declent_ru(NOMINATIVE))] begins picking chips of bone out of your brain with \the [tool]."),
		SPAN_NOTICE("[capitalize(user.declent_ru(NOMINATIVE))] begins picking chips of bone out of [target]'s brain with \the [tool]."))
...
/datum/surgery_step/remove_bone_chips/success(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool, tool_type, datum/surgery/surgery)
	user.affected_message(target,
		...
		SPAN_NOTICE("[capitalize(user.declent_ru(NOMINATIVE))] finishes extracting fragments of bone from your brain."),
		SPAN_NOTICE("[capitalize(user.declent_ru(NOMINATIVE))] finishes extracting fragments of bone from [target]'s brain."))
...
/datum/surgery_step/treat_hematoma/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, tool_type, datum/surgery/surgery)
	user.affected_message(target,
		...
		SPAN_NOTICE("[capitalize(user.declent_ru(NOMINATIVE))] begins to mend the hematoma in your brain with \the [tool]."),
		SPAN_NOTICE("[capitalize(user.declent_ru(NOMINATIVE))] begins to mend the hematoma in [target]'s brain with \the [tool]."))
