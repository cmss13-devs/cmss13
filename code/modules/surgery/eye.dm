...
/datum/surgery_step/separate_corneas/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, tool_type, datum/surgery/surgery)
	user.affected_message(target,
		SPAN_NOTICE("You start to separate the corneas of [target]'s eyes and reshape them with \the [tool]."),
		SPAN_NOTICE("[user] starts to separate the corneas of your eyes and reshape them with \the [tool]."),
		SPAN_NOTICE("[user] starts to separate the corneas of [target]'s eyes and reshape them with \the [tool]."))

	target.custom_pain("You feel your corneas being sliced open! It hurts!",1)
	log_interact(user, target, "[key_name(user)] started to separate the corneas on [key_name(target)]'s eyes and reshape them with \the [tool].")
...
/datum/surgery_step/separate_corneas/success(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, tool_type, datum/surgery/surgery)
	...
	log_interact(user, target, "[key_name(user)] separated and reshaped the corneas on [key_name(target)]'s eyes with \the [tool], starting [surgery].")
...
/datum/surgery_step/separate_corneas/failure(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, tool_type, datum/surgery/eye_repair/surgery)
	...
	log_interact(user, target, "[key_name(user)] failed to separate and reshape the corneas on [key_name(target)]'s eyes with \the [tool], aborting [surgery].")
...
/datum/surgery_step/lift_corneas/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, tool_type, datum/surgery/surgery)
	user.affected_message(target,
		SPAN_NOTICE("You begin lifting the corneas and moving the lenses out of the way from [target]'s eyes with \the [tool]."),
		SPAN_NOTICE("[user] begins lifting the corneas and moving the lenses out of the way from your eyes with \the [tool]."),
		SPAN_NOTICE("[user] begins lifting the corneas and moving the lenses out of the way from [target]'s eyes with \the [tool]."))

	target.custom_pain("You feel pressure in your eyes!",1)
	log_interact(user, target, "[key_name(user)] started lifting the corneas and moving the lenses out of the way from  [key_name(target)]'s eyes with \the [tool].")
...
/datum/surgery_step/open_eyes/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, tool_type, datum/surgery/surgery)
	user.affected_message(target,
		SPAN_NOTICE("You begin to gently and carefully open [target]'s eyeballs with \the [tool] to expose the retinas, optic nerves, and blood vessels."),
		SPAN_NOTICE("[user] begins to gently and carefully open your eyeballs with \the [tool] to expose the retinas, optic nerves, and blood vessels."),
		SPAN_NOTICE("[user] begins to gently and carefully open [target]'s eyeballs with \the [tool] to retinas, optic nerves, and blood vessels."))

	target.custom_pain("The pressure in your eyes is immense as [user] holds them open!",1)
	log_interact(user, target, "[key_name(user)] began to open [key_name(target)]'s eyeballs with \the [tool].")
...
/datum/surgery_step/open_eyes/success(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, tool_type, datum/surgery/surgery)
	...
	log_interact(user, target, "[key_name(user)] opened [key_name(target)]'s eyeballs with \the [tool].")
...
/datum/surgery_step/open_eyes/failure(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, tool_type, datum/surgery/eye_repair/surgery)
	...
	log_interact(user, target, "[key_name(user)] failed to open [key_name(target)]'s eyes with \the [tool].")
...
/datum/surgery_step/mend_eyes/success(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, tool_type, datum/surgery/surgery)
	...
	log_interact(user, target, "[key_name(user)] mended the damage inside [key_name(target)]'s eyes with \the [tool].")
...
/datum/surgery_step/mend_eyes/failure(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, tool_type, datum/surgery/eye_repair/surgery)
	user.affected_message(target,
		SPAN_WARNING("Your hand slips, damaging [target]'s eyeballs with \the [tool]!"),
		SPAN_WARNING("[user]'s hand slips, damaging your eyeballs with \the [tool]!"),
		SPAN_WARNING("[user]'s hand slips, damaging [target]'s eyeballs with \the [tool]!"))

	log_interact(user, target, "[key_name(user)] failed to mend the damage inside [key_name(target)]'s eyes with \the [tool].")
...
/datum/surgery_step/cauterize/eyes/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, tool_type, datum/surgery/surgery)
	user.affected_message(target,
		SPAN_NOTICE("You begin to reattach [target]'s corneas and lenses and close the eyeballs with \the [tool]."),
		SPAN_NOTICE("[user] begins to reattach your corneas and lenses and close the eyeballs with \the [tool]."),
		SPAN_NOTICE("[user] begins to reattach [target]'s corneas and lenses and close the eyeballs with \the [tool]."))
