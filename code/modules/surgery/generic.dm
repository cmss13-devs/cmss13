...
/datum/surgery_step/incision/success(mob/user, mob/living/carbon/target, mob/living/carbon/human/target_limbs, target_zone, obj/item/tool, tool_type, datum/surgery/surgery)
	...
	target_limbs.update_surgery_overlays()
