...
/datum/surgery_step/incision/success(mob/user, mob/living/carbon/human/limbs, mob/living/carbon/target, target_zone, obj/item/tool, tool_type, datum/surgery/surgery)
