...
/datum/test_case/proc/fail(fail_message=null)
	if(!fail_message)
...
/datum/test_case/proc/assertTrue(statement, fail_msg=null)
	if(!statement)
		if(!fail_msg)
...
/datum/test_case/proc/assertFalse(statement, fail_msg=null)
	assertTrue(!statement, (fail_msg ? fail_msg : "expected [statement] to be falsy (0)"))

// Assert that a equals b
/datum/test_case/proc/assertEquals(a, b, fail_msg=null)
	assertTrue(a == b, (fail_msg ? fail_msg : "expected [a] == [b]"))

// Assert that a > b
/datum/test_case/proc/assertGt(a, b, fail_msg=null)
	assertTrue(a > b, (fail_msg ? fail_msg : "expected [a] > [b]"))

// Assert that a >= b
/datum/test_case/proc/assertGtEq(a, b, fail_msg=null)
	assertTrue(a >= b, (fail_msg ? fail_msg : "expected [a] >= [b]"))

// Assert that a < b
/datum/test_case/proc/assertLt(a, b, fail_msg=null)
	assertTrue(a < b, (fail_msg ? fail_msg : "expected [a] < [b]"))

// Assert that a <= b
/datum/test_case/proc/assertLtEq(a, b, fail_msg=null)
	assertTrue(a <= b, (fail_msg ? fail_msg : "expected [a] <= [b]"))

// Assert that a is in the list L
/datum/test_case/proc/assertInList(a, list/L, fail_msg=null)
