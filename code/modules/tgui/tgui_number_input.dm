...
/proc/tgui_input_real_number(mob/user, message, title = "Number Input", default = 0, max_value = 16777216, min_value = -16777216, timeout = 0)
	return tgui_input_number(user, message, title, default, max_value, min_value, timeout)
/**
