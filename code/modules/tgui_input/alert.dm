// THIS IS THE UPSTREAM TGUI VERSION OF TGUI_ALERT
//  We are currently using ../tgui_alert.dm instead due to divergences
//  feel free to normalize missing bits (mostly preferences and theming)
