...
#include "xenomorph\abilities\pheromones\transmit_hive.dm"
#include "xenomorph\abilities\pheromones\transmit_permutation.dm"
#include "xenomorph\abilities\pheromones\pheromone_helpers.dm"
