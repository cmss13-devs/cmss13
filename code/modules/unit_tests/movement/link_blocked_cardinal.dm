...
/datum/unit_test/non_directional_collision_blocker_in_target_turf__link_blocked_test/Run()
	movement_test(
...
/datum/unit_test/directional_collision_blocker_in_target_turf__link_blocked_test/Run()
	movement_test(
		target_direction = SOUTH,
		blocker_positions = list(movement_helper_constants::TARGET_TURF),
		blocker_parameters_entries = list(
...
/datum/unit_test/directional_collision_blocker_in_mover_turf__link_blocked_test/Run()
	movement_test(
		target_direction = SOUTH,
...
/datum/unit_test/non_directional_collision_blocker_in_mover_turf__not_link_blocked_test/Run()
	movement_test(
		target_direction = SOUTH,
		blocker_positions = list(movement_helper_constants::MOVER_TURF),
		blocker_parameters_entries = list(
...
/datum/unit_test/directional_collision_blockers_in_target_turf__not_link_blocked_test/Run()
	movement_test(
		target_direction = SOUTH,
...
/datum/unit_test/directional_collision_blockers_in_mover_turf__not_link_blocked_test/Run()
	movement_test(
		target_direction = SOUTH,
