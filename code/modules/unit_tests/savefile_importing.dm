...
/datum/unit_test/json_savefiles/Run()
	...
	var/tree_basic_list = json_encode(json_savefile.get_entry("basic_list"))
	...
	var/tree_assoc_list = json_encode(json_savefile.get_entry("assoc_list"))
