...
/obj/item/ammo_magazine/hardpoint/turret_flare/apc
	name = "Flare Launcher Shell Holders"
	desc = "The flare launcher's internal star shell holders. Loaded directly with individual M74 AGM-S star shells or star shell packets, not swapped as a whole magazine."
