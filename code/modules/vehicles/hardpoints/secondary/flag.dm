...
/obj/item/hardpoint/secondary/united_americas_flag
	...
	// Own dedicated wound-family pool instead of sharing HDPT_SECONDARY's generic weapon wounds.
	wound_family_slot   = HDPT_UA_FLAG
...
/obj/item/hardpoint/secondary/united_americas_flag/proc/apply_area_effect()
	...
	for(var/mob/living/carbon/human/H in targets)
		...
		apply_buff_to_player(H, effective_strength)

/obj/item/hardpoint/secondary/united_americas_flag/proc/apply_buff_to_player(mob/living/carbon/human/H, strength)
	H.activate_order_buff(COMMAND_ORDER_HOLD, strength, 5 SECONDS)
	H.activate_order_buff(COMMAND_ORDER_FOCUS, strength, 5 SECONDS)
	H.activate_order_buff(COMMAND_ORDER_MOVE, strength, 5 SECONDS)
