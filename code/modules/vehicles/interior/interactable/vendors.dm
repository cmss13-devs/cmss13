...
/obj/structure/machinery/cm_vending/sorted/vehicle_supply/populate_product_list(var/scale)
	listed_products = list(
		...
		list("SHARP 9X-T Sticky Tracking Dart magazine (darts)", 0, /obj/item/ammo_magazine/rifle/sharp/flechette, VENDOR_ITEM_REGULAR),
		list("SHARP 9X-F Flechette Dart Magazine (darts)", 0, /obj/item/ammo_magazine/rifle/sharp/track, VENDOR_ITEM_REGULAR),
