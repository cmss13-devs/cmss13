...
/obj/structure/machinery/cm_vending/sorted/vehicle_supply/tent/populate_product_list(scale)
	listed_products = list(
		list("BUILDING MATERIALS", -1, null, null),
		list("Cardboard x10", 3, /obj/item/stack/sheet/cardboard/small_stack, VENDOR_ITEM_REGULAR),
		list("Barbed Wire x10", 0, /obj/item/stack/barbed_wire/small_stack, VENDOR_ITEM_REGULAR),
		list("Metal x10", 0, /obj/item/stack/sheet/metal/small_stack, VENDOR_ITEM_REGULAR),
		list("Plasteel x10", 0, /obj/item/stack/sheet/plasteel/small_stack, VENDOR_ITEM_REGULAR),
		...
		list("ORGINISATION", -1, null, null),
		list("Table", 4, /obj/item/frame/table, VENDOR_ITEM_REGULAR),
		list("Rack", 4, /obj/item/frame/rack, VENDOR_ITEM_REGULAR),
		...
		list("M10 Pattern Technician Helmet", 0, /obj/item/clothing/head/helmet/marine/tech, VENDOR_ITEM_REGULAR),
		list("M10 Pattern Corpsman Helmet", 0, /obj/item/clothing/head/helmet/marine/medic, VENDOR_ITEM_REGULAR),
		...
		list("Marine Combat Boots", 0, /obj/item/clothing/shoes/marine, VENDOR_ITEM_REGULAR),
		list("Marine Combat Gloves", 0, /obj/item/clothing/gloves/marine, VENDOR_ITEM_REGULAR),
		...
		list("Binoculars", 0, /obj/item/device/binoculars, VENDOR_ITEM_REGULAR),
		list("M5 Bayonet", 0, /obj/item/attachable/bayonet, VENDOR_ITEM_REGULAR),

		list("Roller Bed", 0, /obj/item/roller, VENDOR_ITEM_REGULAR),
		list("Fire Extinguisher (Portable)", 0, /obj/item/tool/extinguisher/mini, VENDOR_ITEM_REGULAR),
		list("Spare PDT/L Battle Buddy Kit", 2, /obj/item/storage/box/pdt_kit, VENDOR_ITEM_REGULAR),
		...
		list("M10 HV Magazine (10x20mm-APC)", 0, /obj/item/ammo_magazine/pistol/m10, VENDOR_ITEM_REGULAR),
		...
		list("M56D Drum Magazine", 0, /obj/item/ammo_magazine/m56d, VENDOR_ITEM_REGULAR),
		list("M2C Box Magazine", 0, /obj/item/ammo_magazine/m2c, VENDOR_ITEM_REGULAR),
		list("M240 Incinerator Tank", 0, /obj/item/ammo_magazine/flamer_tank, VENDOR_ITEM_REGULAR),
