...
/obj/structure/machinery/cm_vending/sorted/vehicle_supply/populate_product_list(scale)
	listed_products = list(
		...
		list("M37A1 Pump Shotgun", floor(scale * 3), /obj/item/weapon/gun/shotgun/pump/m37a, VENDOR_ITEM_REGULAR),
		...
		list("M4A4 Service Pistol", floor(scale * 2.5), /obj/item/weapon/gun/pistol/m4a3/m4a4, VENDOR_ITEM_REGULAR),
