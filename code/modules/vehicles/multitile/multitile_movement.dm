...
/obj/vehicle/multitile/proc/rotate_hardpoints(deg, update_icons = TRUE, var/list/specific_hardpoints = null)
...
/obj/vehicle/multitile/proc/at_munition_interior_explosion_effect(explosion_strength = 75, var/explosion_falloff = 50, var/shrapnel = TRUE, var/shrapnel_count = 48, var/datum/cause_data/cause_data)
	if(!interior)
		return
