...
/obj/effect/vehicle_spawner/miltruck/decrepit/load_hardpoints(var/obj/vehicle/multitile/miltruck/V)
...
/obj/effect/vehicle_spawner/miltruck/fixed/load_hardpoints(var/obj/vehicle/multitile/miltruck/V)
	var/H = random_hardpoint()
	V.add_hardpoint(new H)
...
/obj/effect/vehicle_spawner/miltruck/random/load_hardpoints(var/obj/vehicle/multitile/miltruck/V)
	var/H = random_hardpoint()
	V.add_hardpoint(new H)
