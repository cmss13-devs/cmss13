...
/obj/vehicle/multitile/pizza_van
...
/obj/vehicle/multitile/pizza_van/Initialize()
	. = ..()
...
/obj/vehicle/multitile/pizza_van/BlockedPassDirs(atom/movable/mover, target_dir)
...
** PRESETS
*/
/obj/vehicle/multitile/pizza_van/pre_movement()
	. = ..()
...
/obj/vehicle/multitile/pizza_van/proc/add_under_van(mob/living/living)
...
/obj/vehicle/multitile/pizza_van/proc/remove_under_van(mob/living/living)
	SIGNAL_HANDLER
	mobs_under -= living
...
/obj/vehicle/multitile/pizza_van/proc/check_under_van(mob/mob, turf/oldloc, direction)
	SIGNAL_HANDLER
	if(!(mob.loc in locs))
		remove_under_van(mob)

/obj/vehicle/multitile/pizza_van/proc/add_client(mob/living/living)
	SIGNAL_HANDLER
	living.client.images += under_image
	living.client.images -= normal_image

/obj/vehicle/multitile/pizza_van/proc/add_default_image(subsystem, mob/mob)
	SIGNAL_HANDLER
	mob.client.images += normal_image

/obj/vehicle/multitile/pizza_van/Destroy()
	for(var/icon in mobs_under)
...
/obj/vehicle/multitile/pizza_van/attackby(obj/item/O, mob/user)
	if(user.z != z)
		return ..()
...
/obj/vehicle/multitile/pizza_van/handle_click(mob/living/user, atom/A, list/mods)
...
/obj/vehicle/multitile/pizza_van/proc/reset_overdrive()
	misc_multipliers["move"] += overdrive_speed_mult

/obj/vehicle/multitile/pizza_van/get_projectile_hit_boolean(obj/projectile/P)
...
/obj/vehicle/multitile/pizza_van/Collide(atom/A)
...
/obj/effect/vehicle_spawner/pizza_van
	name = "Pizza-Galaxy Van Spawner"
	icon = 'icons/obj/vehicles/pizza_van.dmi'
	icon_state = "van_base"

/obj/effect/vehicle_spawner/pizza_van/Initialize()
	. = ..()
	spawn_vehicle()
	qdel(src)

//PRESET: no hardpoints
/obj/effect/vehicle_spawner/pizza_van/spawn_vehicle()
	var/obj/vehicle/multitile/pizza_van/VAN = new (loc)
...
/obj/effect/vehicle_spawner/pizza_van/decrepit/spawn_vehicle()
	var/obj/vehicle/multitile/pizza_van/VAN = new (loc)
...
/obj/effect/vehicle_spawner/pizza_van/decrepit/load_hardpoints(obj/vehicle/multitile/pizza_van/V)
	V.add_hardpoint(new /obj/item/hardpoint/locomotion/van_wheels)

//PRESET: wheels installed
/obj/effect/vehicle_spawner/pizza_van/fixed/spawn_vehicle()
	var/obj/vehicle/multitile/pizza_van/VAN = new (loc)
...
/obj/effect/vehicle_spawner/pizza_van/fixed/load_hardpoints(obj/vehicle/multitile/pizza_van/V)
	V.add_hardpoint(new /obj/item/hardpoint/locomotion/van_wheels)
