...
/obj/vehicle/multitile/pizza_van/proc/add_under_van(mob/living/L)
	if(L in mobs_under)
		return
...
/obj/vehicle/multitile/pizza_van/proc/remove_under_van(mob/living/L)
	SIGNAL_HANDLER
	mobs_under -= L
...
/obj/vehicle/multitile/pizza_van/proc/check_under_van(mob/M, turf/oldloc, direction)
	SIGNAL_HANDLER
	if(!(M.loc in locs))
		remove_under_van(M)

/obj/vehicle/multitile/pizza_van/proc/add_client(mob/living/L)
	SIGNAL_HANDLER
	L.client.images += under_image
	L.client.images -= normal_image

/obj/vehicle/multitile/pizza_van/proc/add_default_image(subsystem, mob/M)
	SIGNAL_HANDLER
