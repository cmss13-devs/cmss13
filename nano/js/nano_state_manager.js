...
{
	// _isInitialized is set to true when all of this ui's templates have been processed/rendered
	...
	var receiveUpdateData = function (jsonString)
	{
		...
		if (_isInitialized) // all templates have been registered, so render them
		{
			doUpdate(updateData);
		}
		else
