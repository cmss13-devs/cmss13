      ...
      <Window.Content scrollable>
        <Section title="Pod controls">
          <Flex direction="column">
            ...
            <Flex.Item>
              <Button
                content={data.input_source ? "Input : Turing Dispenser" : "Input : Container"}
                icon="flask"
                fluid
            ...
            <Flex.Item>
              <NoticeBox info>
                {data.turing ? "Turing Dispenser connected!" : "No Turing Dispenser connected!"}
              </NoticeBox>
            </Flex.Item>
          </Flex>
        </Section>
