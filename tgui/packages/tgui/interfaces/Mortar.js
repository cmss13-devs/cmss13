...
export const Mortar = (props, context) => {
  ...
  const [dial_x, setDialX]
    = useLocalState(context, "dial_x", data_dial_x);

  const [dial_y, setDialY]
    = useLocalState(context, "dial_y", data_dial_y);
